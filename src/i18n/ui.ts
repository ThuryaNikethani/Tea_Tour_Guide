...
export interface UIStrings {
  ...
  nextSection: string;
  sectionOf: string; // e.g. "Part {current} of {total}"
  startTour: string;
  allStations: string;
...
const APP_UI: Record<LanguageCode, AppUiStrings> = {
  en: {
    ...
    nextSection: "Next",
    sectionOf: "Part {current} of {total}",
  ...
  zh: {
    ...
    previousSection: "上一部分",
    nextSection: "下一部分",
    sectionOf: "第 {current} 部分，共 {total} 部分",
    startTour: "开始参观",
    allStations: "参观站点",
  ...
  es: {
    ...
    sectionOf: "Parte {current} de {total}",
  ...
  fr: {
    ...
    nextSection: "Suivant",
    sectionOf: "Partie {current} sur {total}",
  ...
  ru: {
    ...
    previousSection: "Назад",
    nextSection: "Далее",
    sectionOf: "Часть {current} из {total}",
  ...
  si: {
    ...
    previousSection: "පෙර",
    nextSection: "ඊළඟ",
    sectionOf: "කොටස {current} න් {total}",
  ...
  ar: {
    ...
    previousSection: "السابق",
    nextSection: "التالي",
    sectionOf: "الجزء {current} من {total}",
  ...
  it: {
    ...
    previousSection: "Precedente",
    nextSection: "Successivo",
    sectionOf: "Parte {current} di {total}",
  ...
  de: {
    ...
    nextSection: "Weiter",
    sectionOf: "Teil {current} von {total}",
  ...
  ta: {
    ...
    previousSection: "முந்தையது",
    nextSection: "அடுத்தது",
    sectionOf: "பகுதி {current} / {total}",
