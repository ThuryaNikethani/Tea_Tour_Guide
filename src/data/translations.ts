...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        ...
        "මෙම කුටිය ඔයිස්ටර් බිම්මල් වර්ග කිහිපයක් වගා කිරීම සඳහා සකසා ඇත — ඇමරිකානු ඔයිස්ටර් (Pleurotus pulmonarius), භූතාන් ඔයිස්ටර්, කළු ඔයිස්ටර්, සහ රෝස ඔයිස්ටර් (Pleurotus djamor) — ඇබලෝන් බිම්මල් (Pleurotus cystidiosus) සමඟින්, සියල්ලම පසට වඩා පිදුරු හෝ මට්ටි කුඩු මාධ්‍යයක් මත වගා කරනු ලැබේ. මේ සියල්ලම Pleurotus ගණයට අයත් වේ. ඒවා හඳුනාගත හැක්කේ මාධ්‍යයෙන්ම කෙලින්ම වැඩෙන, තදින් එකිනෙක උඩින් තට්ටු වශයෙන් පිහිටි පංකා හැඩැති හෝ බෙල හැඩැති තොප්පි මගිනි. වර්ග අතර ප්‍රධාන වෙනස වර්ණයයි — සුදු හා අළු සිට රෝස, රන්වන්, හෝ කළුවට ආසන්න පැහැ දක්වා විහිදෙන — එහෙත් මෘදු, තරමක් රසවත් රසය සියල්ලෙහිම එක හා සමානය.",
        "වගාව ආරම්භ වන්නේ මාධ්‍යයෙන් මය — පිදුරු හෝ මට්ටි කුඩු, එනම් වතුයායේ අඩු වියදම්, අපද්‍රව්‍ය පදනම් වූ ප්‍රවේශයට පදනම් වන එම ද්‍රව්‍යයම. එය තරඟකාරී දිලීර හා බැක්ටීරියා විනාශ කිරීම සඳහා තෙත් කර තාපයෙන් පැස්ටරීකරණය කරනු ලබන අතර, ඉන් පසුව බිම්මල් මයිසීලියම් මගින් සම්පූර්ණයෙන් ව්‍යාප්ත වූ ධාන්‍ය වන 'බීජ' සමඟ මිශ්‍ර කර සිදුරු සහිත බෑග් හෝ බ්ලොක් තුළට පුරවනු ලැබේ. ඉන්පසු එම බ්ලොක් සති දෙක තුනක 'බීජ ව්‍යාප්ති' කාලයක් සඳහා අඳුරේ තබනු ලබන අතර, එම කාලය තුළ සුදු මයිසීලියම් මුළු මාධ්‍යය පුරාම ව්‍යාප්ත වේ; ඉන් අනතුරුව කුටියේ අඳුරු, සිසිල්, තෙත් තත්ත්වයන් ක්‍රියාත්මක වී අස්වැන්න හට ගැනීම උත්තේජනය කරයි.",
        "මෙලෙස බිම්මල් වගා කිරීම ගොවිපලකට එහි ප්‍රධාන බෝගයෙන් ඔබ්බට විවිධාංගීකරණය වීමට අඩු වියදම්, තිරසාර ක්‍රමයකි, බොහෝ විට පිදුරු වැනි කෘෂිකාර්මික අපද්‍රව්‍ය වගා මාධ්‍යයක් ලෙස යොදාගනිමින්, එක් මාධ්‍ය කාණ්ඩයකින් සති කිහිපයක් තුළ අස්වනු කිහිපයක් ලබා ගනිමින්. සාමාන්‍යයෙන් එක් බ්ලොක් එකකින් සති එකක් හෝ දෙකක පමණ පරතරයෙන් අස්වනු හතරක් තෙක් ලබා ගත හැකි අතර, පළමු අස්වැන්න වඩාත් විශාල වන අතර ඉන් පසු අස්වනු ප්‍රමාණය ක්‍රමයෙන් අඩු වේ; බිම්මල් කැපීමට වඩා මුළු පොකුරම ඇඹරී ගලවා ගනු ලබන්නේ, ඉතිරි වන කඳ කොටස් දිරාපත් වී ඊළඟ අස්වැන්නට හානි කළ හැකි දූෂණයකට තුඩු දිය හැකි බැවිනි.",
  ...
  it: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        "Accanto alle sue colture di tè, spezie e frutta, la tenuta mantiene una capanna dedicata ai funghi — una piccola struttura ombreggiata costruita per mantenere le condizioni buie, fresche e umide di cui i funghi hanno bisogno per fruttificare, anziché il sole e la circolazione d'aria per cui vengono coltivati il resto dei giardini.",
        "La capanna è allestita per coltivare diverse varietà di funghi ostrica — l'Ostrica Americana (Pleurotus pulmonarius), l'Ostrica del Bhutan, l'Ostrica Nera e l'Ostrica Rosa (Pleurotus djamor) — insieme al Fungo Abalone (Pleurotus cystidiosus), tutti coltivati su un substrato di paglia o segatura anziché sul terreno. Tutti questi appartengono al genere Pleurotus, riconoscibili dai loro cappelli a forma di ventaglio o di ostrica che crescono in mensole fitte e sovrapposte direttamente dal substrato anziché su steli singoli, con il colore come principale elemento che distingue una varietà dall'altra — dal bianco e grigio al rosa, all'oro, o quasi al nero — mentre il sapore delicato e leggermente sapido resta pressoché lo stesso in tutte.",
        "La coltivazione parte dal substrato stesso — paglia o segatura, lo stesso materiale alla base dell'approccio economico e basato sugli scarti della tenuta — che viene inzuppato e pastorizzato con il calore per eliminare muffe e batteri concorrenti, prima di essere mescolato con il micelio innesto, grano completamente colonizzato dal micelio del fungo, e confezionato in sacchi o blocchi forati. Quei blocchi vengono poi lasciati al buio per un 'periodo di colonizzazione' di due o tre settimane, durante il quale il micelio bianco si diffonde in tutto il substrato, prima che le condizioni buie, fresche e umide della capanna subentrino per innescare la fruttificazione.",
  ...
  ar: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        ...
        "أُعد الكوخ لزراعة عدة أصناف من فطر المحار — المحار الأمريكي (Pleurotus pulmonarius)، ومحار بوتان، والمحار الأسود، والمحار الوردي (Pleurotus djamor) — إلى جانب فطر الأذن البحرية (Pleurotus cystidiosus)، وتُزرع جميعها على وسط من القش أو نشارة الخشب بدلاً من التربة. تنتمي هذه الأصناف جميعها إلى جنس Pleurotus، ويمكن التعرف عليها من خلال قبعاتها ذات الشكل المروحي أو الشبيه بالمحار، والتي تنمو في طبقات كثيفة ومتراكبة تخرج مباشرة من الوسط الزراعي بدلاً من سيقان منفردة. ويُعد اللون هو العامل الرئيسي الذي يميز صنفًا عن آخر — إذ يتراوح بين الأبيض والرمادي إلى الوردي والذهبي أو الأسود تقريبًا — في حين يبقى الطعم الخفيف الذي يميل قليلاً إلى الملوحة متشابهًا إلى حد كبير بين جميع الأصناف.",
        "تبدأ الزراعة بالوسط نفسه — القش أو نشارة الخشب، وهي نفس المادة التي يقوم عليها نهج المزرعة منخفض التكلفة القائم على المخلفات — حيث يُنقع ويُبستر بالحرارة للقضاء على العفن والبكتيريا المنافسة، قبل خلطه بـ'البذار' وهو حبوب استعمرها بالكامل ميسيليوم الفطر، ثم يُعبأ في أكياس أو كتل مثقوبة. تُترك هذه الكتل بعد ذلك في الظلام لمدة تتراوح بين أسبوعين وثلاثة أسابيع فيما يُعرف بـ'فترة انتشار البذار'، حيث ينتشر الميسيليوم الأبيض في الوسط بأكمله، قبل أن تتولى ظروف الكوخ المظلمة والباردة والرطبة مهمة تحفيز نمو الثمار.",
        "تُعد زراعة الفطر بهذه الطريقة وسيلة منخفضة التكلفة ومستدامة للمزرعة لتنويع إنتاجها إلى جانب محصولها الرئيسي، وغالبًا ما تستخدم مخلفات زراعية مثل القش كوسط للزراعة، حيث تنتج دفعة واحدة من الوسط عدة حصادات على مدى عدة أسابيع. وعادة ما تنتج الكتلة الواحدة ما بين دفعتين إلى أربع دفعات من هذا النوع، تفصل بينها أسبوع إلى أسبوعين تقريبًا، حيث تكون الدفعة الأولى هي الأكبر ثم يتناقص الإنتاج تدريجيًا بعدها؛ ويُلوى الفطر بلطف لفصله في مجموعات كاملة بدلاً من قطعه، إذ يمكن أن تتعفن بقايا السيقان وتتسبب في تلوث يفسد الدفعة التالية.",
  ...
  ru: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        "Наряду с чаем, специями и фруктами поместье содержит отдельный грибной домик — небольшое затенённое строение, построенное для поддержания тёмных, прохладных и влажных условий, необходимых грибам для плодоношения, в отличие от солнца и циркуляции воздуха, для которых выращивается остальная часть садов.",
        "В домике выращивают несколько сортов вёшенки — американскую вёшенку (Pleurotus pulmonarius), бутанскую, чёрную и розовую вёшенку (Pleurotus djamor), — а также гриб абалон (Pleurotus cystidiosus), и все они растут на субстрате из соломы или опилок, а не в почве. Все они относятся к роду Pleurotus и узнаются по веерообразным или похожим на раковину устрицы шляпкам, растущим плотными, налегающими друг на друга гроздьями прямо из субстрата, а не на отдельных ножках. Главное, что отличает один сорт от другого, — это цвет: от белого и серого до розового, золотистого или почти чёрного, — тогда как мягкий, слегка пикантный вкус остаётся практически одинаковым у всех сортов.",
        "Выращивание начинается с самого субстрата — соломы или опилок, того же материала, на котором основан недорогой подход поместья, использующий отходы. Его замачивают и пастеризуют горячим паром, чтобы уничтожить конкурирующие плесени и бактерии, а затем смешивают с посевным мицелием — зерном, полностью заселённым грибным мицелием, — и упаковывают в перфорированные пакеты или блоки. Затем эти блоки на две-три недели оставляют в темноте для «периода обрастания», в течение которого белый мицелий распространяется по всему субстрату, прежде чем тёмные, прохладные и влажные условия домика запускают плодоношение.",
        "Выращивание грибов таким образом — недорогой и устойчивый способ для хозяйства диверсифицироваться за пределы основной культуры, часто с использованием сельскохозяйственных отходов, таких как солома, в качестве субстрата для выращивания, при этом одна партия субстрата даёт несколько урожаев в течение нескольких недель. Обычно один блок даёт от двух до четырёх таких волн плодоношения с интервалом примерно в одну-две недели, при этом первая волна оказывается самой обильной, а последующие постепенно становятся меньше; грибы не срезают, а аккуратно откручивают целыми гроздьями, поскольку оставшиеся пеньки могут загнить и вызвать заражение, которое испортит следующую волну.",
  ...
  es: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        "Junto con sus cultivos de té, especias y frutas, la finca mantiene una cabaña dedicada a las setas — una pequeña estructura sombreada construida para mantener las condiciones oscuras, frescas y húmedas que las setas necesitan para fructificar, en lugar del sol y la circulación de aire para los que se cultiva el resto de los jardines.",
        "La cabaña está preparada para cultivar varias variedades de setas ostra — Ostra Americana (Pleurotus pulmonarius), Ostra de Bután, Ostra Negra y Ostra Rosa (Pleurotus djamor) — junto con la Seta Abalón (Pleurotus cystidiosus), todas cultivadas en un sustrato de paja o serrín en lugar de tierra. Todas ellas pertenecen al género Pleurotus, reconocibles por sus sombreros en forma de abanico u ostra que crecen en racimos densos y superpuestos directamente del sustrato en lugar de sobre tallos individuales, siendo el color lo que principalmente distingue una variedad de otra — desde blanco y gris hasta rosa, dorado o casi negro —, mientras que el sabor suave y ligeramente sabroso se mantiene bastante similar en todas ellas.",
        "El cultivo comienza con el propio sustrato — paja o serrín, el mismo material detrás del enfoque económico y basado en residuos de la finca —, que se remoja y pasteuriza con calor para eliminar mohos y bacterias competidoras antes de mezclarlo con micelio semilla, grano completamente colonizado por el micelio del hongo, y empaquetarlo en bolsas o bloques perforados. Esos bloques se dejan luego en la oscuridad durante dos o tres semanas para la 'carrera del micelio', durante la cual el micelio blanco se extiende por todo el sustrato, antes de que las condiciones oscuras, frescas y húmedas de la cabaña entren en acción para desencadenar la fructificación.",
        "Cultivar setas de esta manera es una forma económica y sostenible de que una finca se diversifique más allá de su cultivo principal, a menudo usando residuos agrícolas como la paja como medio de cultivo, con un solo lote de sustrato que produce varias cosechas a lo largo de varias semanas. Cada bloque produce normalmente entre dos y cuatro de estas oleadas, espaciadas aproximadamente una o dos semanas entre sí, siendo la primera oleada la más abundante y disminuyendo el rendimiento después; las setas se retuercen y se sacan en racimos enteros en lugar de cortarse, ya que los tocones que quedan pueden pudrirse y provocar una contaminación que echaría a perder la siguiente oleada.",
  ...
  fr: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        ...
        "La cabane est aménagée pour cultiver plusieurs variétés de pleurotes — le Pleurote Américain (Pleurotus pulmonarius), le Pleurote du Bhoutan, le Pleurote Noir et le Pleurote Rose (Pleurotus djamor) — ainsi que le Champignon Abalone (Pleurotus cystidiosus), tous cultivés sur un substrat de paille ou de sciure plutôt que dans la terre. Tous appartiennent au genre Pleurotus, reconnaissables à leurs chapeaux en forme d'éventail ou d'huître qui poussent en étagères denses et superposées directement à partir du substrat plutôt que sur des tiges individuelles, la couleur étant le principal élément distinguant une variété d'une autre — du blanc et gris au rose, à l'or ou au presque noir —, tandis que la saveur douce et légèrement savoureuse reste globalement la même pour toutes.",
        "La culture commence par le substrat lui-même — paille ou sciure, le même matériau à la base de l'approche économique et fondée sur les déchets du domaine —, qui est trempé et pasteurisé à la chaleur pour éliminer les moisissures et bactéries concurrentes, avant d'être mélangé avec du mycélium semence, du grain entièrement colonisé par le mycélium du champignon, puis emballé dans des sacs ou des blocs perforés. Ces blocs sont ensuite laissés dans le noir pendant deux à trois semaines pour la 'course du mycélium', durant laquelle le mycélium blanc se propage dans tout le substrat, avant que les conditions sombres, fraîches et humides de la cabane ne prennent le relais pour déclencher la fructification.",
        "Cultiver des champignons de cette manière est un moyen économique et durable pour une exploitation de se diversifier au-delà de sa culture principale, utilisant souvent des déchets agricoles comme la paille comme milieu de culture, un seul lot de substrat produisant plusieurs récoltes sur plusieurs semaines. Chaque bloc produit généralement deux à quatre de ces vagues de récolte, espacées d'environ une à deux semaines, la première vague étant la plus abondante et les rendements diminuant ensuite ; les champignons sont détachés en grappes entières par torsion plutôt que coupés, car les moignons restants peuvent pourrir et favoriser une contamination qui gâcherait la vague suivante.",
  ...
  zh: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        ...
        "这间蘑菇棚专门种植多个平菇品种——美国平菇（Pleurotus pulmonarius）、不丹平菇、黑平菇和粉红平菇（Pleurotus djamor）——以及鲍鱼菇（Pleurotus cystidiosus），全部种植在稻草或木屑基质上，而非土壤中。这些品种都属于平菇属（Pleurotus），其特征是呈扇形或蚝形的菌盖，密集地重叠成层，直接从基质中长出，而非依附于单独的菌柄。区分各品种的主要因素是颜色——从白色、灰色到粉红色、金色，乃至近乎黑色不等——而它们温和、略带鲜味的口感则大体相近。",
        "栽培从基质本身开始——稻草或木屑，正是庄园低成本、变废为宝理念背后所依赖的材料——先经过浸泡并用高温灭菌，以杀灭竞争性的霉菌和细菌，再与菌种（即已被蘑菇菌丝完全定植的谷粒）混合，装入带孔的袋子或菌包中。随后这些菌包会在黑暗中放置两到三周，进行所谓的“发菌”，白色菌丝会在这段时间里布满整个基质，之后蘑菇棚阴暗、凉爽、潮湿的环境才会接管，促使菌菇出菇。",
  ...
  ja: {
    ...
    "mushroom-hut": {
      ...
      sectionBodies: [
        ...
        "この小屋では、アメリカンヒラタケ（Pleurotus pulmonarius）、ブータンヒラタケ、ブラックヒラタケ、ピンクヒラタケ（Pleurotus djamor）といった複数のヒラタケ品種に加えて、アワビタケ（Pleurotus cystidiosus）が栽培されており、いずれも土ではなく藁やおがくずを基質として育てられています。これらはすべてヒラタケ属（Pleurotus）に属しており、個々の茎ではなく基質から直接、扇形または貝殻状の傘が密集して重なり合うように育つのが特徴です。品種を分ける主な違いは色で、白や灰色からピンク、金色、ほぼ黒に近いものまで幅がありますが、いずれも穏やかでかすかにうま味のある風味はほとんど変わりません。",
        "栽培は基質そのものから始まります——藁やおがくずは、農園の低コストで廃棄物を活用する方針を支える同じ素材です。これを水に浸して熱で殺菌し、競合するカビや細菌を除去したうえで、きのこの菌糸が完全に行き渡った穀粒である種菌と混ぜ合わせ、通気穴のある袋やブロックに詰めます。そのブロックは2〜3週間ほど「菌糸の伸長期間」として暗所に置かれ、その間に白い菌糸が基質全体に広がり、その後小屋の暗く涼しく湿った環境が引き継いで、きのこの発生を促します。",
        "このようにきのこを育てることは、農園が主要作物以外に多角化するための低コストで持続可能な方法であり、藁のような農業廃棄物を栽培基質として利用することが多く、一つの基質のバッチから数週間かけて何度も収穫できます。1つのブロックからは通常、1〜2週間ほどの間隔をあけて2〜4回ほどこうした収穫の波が得られ、最初の収穫が最も多く、その後は徐々に減っていきます。きのこは切り取るのではなく、株ごとひねって収穫します。残った切り株が腐ると、次の収穫を台無しにしかねない汚染を招くおそれがあるためです。",
