...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  ...
  zh: {
    ...
    "tea-center": {
      ...
      sectionHeadings: ["茶叶中心"],
      sectionBodies: ["行程的终点是茶叶中心，一支品茶小组会检查每一批茶——不仅在这里，此前也是如此，每当茶叶离开主厂运往本地市场，或送来包装时都会检查——查找过度发酵、发酵不足或烘焦等缺陷。任何在出售前未通过检验的茶叶都会被剔除，即使是细微的问题也会被记录下来，以指导未来的生产。这里还展出了手工茶厂的另外两款小批量特色产品——花朵茶轮和茶币。这类手工茶可以用约80°C的热水（而非沸水）冲泡多达三次——每次用新鲜热水，分别约2、5、8分钟——不同于标准红茶只用滚沸的水冲泡一次。品茶遵循一种与品酒类似的方法——先闻香，再吸气啜饮，让茶汤掠过舌头两侧的味蕾。品茶小组一天最多品鉴50款茶，会吐出而不是咽下，不过访客倒是可以真正喝下自己品尝的茶。正确冲泡的红茶需要加盖浸泡约2.5到3分钟，而不只是快速一蘸。BOPF和BOPF Special是大多数斯里兰卡人日常饮用的等级。而最低等级的Dust和Dust 1从不出口，它们通常会加入色素，最终出现在廉价的超市茶包里——这也是为什么茶包一浸入水中颜色就立刻显现，而不是等到充分浸泡之后。超市里出售的许多茶叶还会与从别处购入的更便宜茶叶混合，不同于庄园自家未经混合的单一原产地茶叶。最上乘的等级——FF Extra Special、FF Special、FBOP——仅取自约1%的收成，是嫩芽中最不成熟的部分，每100克售价约25美元；而OPA、OP等更粗大的等级每200克售价约5到6美元。最上乘等级中可见的白色芽尖颗粒增添了额外的甜味，大多销往欧洲买家，而阿拉伯市场则更偏好口感更浓的茶。除了茶叶，庄园还将自家的绿茶和红茶（约90%）与本地草本——积雪草、灰莉叶和辣木叶（约10%）——混合，并用自家香料制作马萨拉、肉桂和姜味香料茶。马萨拉配方使用七种斯里兰卡香料，其中包括豆蔻、肉桂、姜和黑胡椒（其余成分保密）。奶茶推荐使用马萨拉茶或BOP茶。"],
      duration: "10-15分钟",
    },
    "coconut-field": {
      name: "椰园",
