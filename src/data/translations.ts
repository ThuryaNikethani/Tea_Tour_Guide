...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    "handmade-factory": {
      ...
      sectionHeadings: [
        ...
        "ෆ්ලවර් චක්‍ර සහ ටී කොයින්",
      ],
      sectionBodies: [
        "යාන්ත්‍රික නිෂ්පාදනයට අමතරව, සමහර තේ සෑම අදියරකදීම යන්ත්‍රයක් නොව සම්පූර්ණයෙන් අතින් සකසනු ලැබේ. වතුයායේ අත්කම් විශේෂ ශ්‍රේණි බොහොමයක් — Golden Tip, Silver Tip, සුදු තේ, දම් තේ, රෝස තේ, විටා ග්ලෝ, අතින් බැඳි බ්ලූමින් තේ, සහ නෙළුම් තේ වැනි මල් එකතු කළ මිශ්‍රණ — ප්‍රධාන කළු තේ කර්මාන්තශාලාව වෙනුවට මෙහිදී නිම කරනු ලැබේ. (විටා ග්ලෝ සාදනු ලබන්නේ Golden Tip සහ Silver Tip හි දම් පැහැති අංකුරයට වඩා වෙනස්ව, කොළ පැහැති අංකුරයේ තුඩුවෙනි.)",
        ...
        "මෙම නැවතුම අත්කම් තේ, කර්මාන්තශාලා රේඛා නිෂ්පාදනයෙන් වෙනස් වන්නේ කෙසේද යන්න ගැන කියා දෙයි. අතින් රෝල් කිරීම සහ අතින් සැකසීම කුඩා තොග නිපදවන අතර, කොළ අතර වැඩි විචලනයක් ඇති බැවින් ඒවායේ සුවිශේෂී ලක්ෂණය නිසා බොහෝ විට අගය කරනු ලැබේ. අත්කම් තේ පුළුල් කාණ්ඩ දෙකකට වැටේ: කළු තේ ආකාරයේ පැසුණු ඒවා — කළු වර්ණය මගින් හඳුනාගත හැක — එයට දම් තේද (Purple Tea) ඇතුළත් වේ, එහි සුවිශේෂී මූලික අංකුරය තිබියදීත්; සහ සුදු තේ වැනි, පැසවීම සම්පූර්ණයෙන් මඟහැර කෙලින්ම වියලීමට යන නොපැසුණු ඒවා.",
  ...
  ta: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        ...
        "இங்கு தயாரிக்கப்படும் மிகவும் உழைப்பு மிக்க பொருட்கள் இரண்டு சிறு-தொகுதி சிறப்பு பொருட்களே: ஃப்ளவர் சக்ரா (Flower Chakra) — சுமார் இரண்டு தளிர்களைப் பயன்படுத்தும் கையால் உருட்டப்பட்ட கருப்பு தேயிலை வளையம் — மற்றும் டீ காயின் (Tea Coin). ஒரு நபர் ஒரு நாளைக்கு இவற்றில் ஒன்றை மட்டுமே சுமார் 25 கிராம் கையால் உருட்ட முடியும், அதனால்தான் இவை மிகவும் விலை உயர்ந்தவை. இவை அன்றாட குடிப்பதற்கு பதிலாக, செல்வந்த தேயிலை ஆர்வலர்களால் ஒரு நினைவுப் பொருளாக பெரும்பாலும் வாங்கப்படுகின்றன. ஊதா தேயிலை உட்பட, பெரும்பாலான கைவினை உற்பத்தி தொடர்ச்சியாக மொத்தமாக உற்பத்தி செய்யப்படுவதற்கு பதிலாக ஆர்டர் அடிப்படையில் சிறிய தொகுதிகளாக தயாரிக்கப்படுகிறது.",
      ],
  ...
  ar: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        ...
        "توضح هذه المحطة ما يميز الشاي المصنوع يدويًا عن الإنتاج بخط المصنع. ينتج اللف والتجهيز اليدويان دفعات أصغر بتفاوت أكبر بين الأوراق، وغالبًا ما تُقدَّر لطابعها المميز. تنقسم أنواع الشاي اليدوي إلى فئتين واسعتين: الأنواع المخمرة على طريقة الشاي الأسود (يمكن التعرف عليها من لونها الأسود)، والتي تشمل الشاي الأرجواني رغم برعمه الأصلي غير المعتاد؛ والأنواع غير المخمرة مثل الشاي الأبيض، التي تتخطى التخمير تمامًا وتنتقل مباشرة إلى التجفيف.",
  ...
  es: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        ...
        "Esta parada explica qué distingue al té hecho a mano de la producción en línea de fábrica. El enrollado y el procesamiento manuales producen lotes más pequeños con más variación entre hojas, a menudo apreciados por su carácter distintivo. Los tés hechos a mano se dividen en dos categorías amplias: los fermentados, al estilo del té negro (identificables por su color negro), que incluyen al té púrpura pese a su inusual brote de origen; y los no fermentados como el White Tea, que se saltan la fermentación por completo y van directo al secado.",
        "Los artículos que más trabajo requieren aquí son dos especialidades de lote pequeño: el Flower Chakra, un anillo de té negro enrollado a mano que usa unos dos brotes cada uno, y el Tea Coin. Una sola persona puede enrollar a mano solo unos 25 gramos de cualquiera de los dos al día, por lo que son tan caros, y se compran sobre todo como recuerdo por parte de entusiastas del té adinerados, más que para el consumo diario. La mayor parte de la producción hecha a mano, incluido el té púrpura, se elabora por encargo en lotes pequeños en lugar de producirse continuamente en grandes cantidades.",
      ],
      duration: "10 minutos",
    },
    "tea-center": {
  ...
  fr: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        ...
        "Cette étape explique ce qui distingue le thé fait main de la production en ligne de fabrique. Le roulage et la transformation à la main produisent des lots plus petits avec plus de variation entre les feuilles, souvent appréciés pour leur caractère distinctif. Les thés faits main se répartissent en deux grandes catégories : les fermentés, façon thé noir (reconnaissables à leur couleur noire), qui incluent le thé violet malgré son bourgeon d'origine inhabituel ; et les non fermentés comme le White Tea, qui sautent entièrement la fermentation et passent directement au séchage.",
  ...
  zh: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "除了机械化生产之外，部分茶叶在每个环节都完全依靠人工处理，不使用机器。庄园大多数手工特色茶品——Golden Tip、Silver Tip、白茶、紫茶、粉茶、多元活力茶、手工绑扎的绽放茶，以及莲花茶等花香混合茶——都是在这里而非主要红茶厂完成的。（多元活力茶取自绿色嫩芽的芽头，与Golden Tip、Silver Tip所用的紫色嫩芽不同。）",
        ...
        "这一站介绍了手工茶与流水线生产茶的区别所在。手工揉捻和手工处理产出的批次更小，叶片之间差异更大，也因这种独特个性而常受青睐。手工茶大致分为两大类：一类是像红茶一样经过发酵的（可通过其黑色辨认），紫茶尽管原料嫩芽特殊，也属于这一类；另一类是不发酵的，例如白茶，完全跳过发酵直接进入烘干。",
        "这里制作最费工的两款产品是小批量特色茶——花朵茶轮（Flower Chakra），一种手工卷制的红茶环，每个约用两根嫩芽制成，以及茶币（Tea Coin）。一个人一天只能手工卷制约25克其中一种，这也是它们如此昂贵的原因，它们大多被富裕的茶叶爱好者当作纪念品购买，而非日常饮用。包括紫茶在内，大部分手工产品都是按订单小批量制作，而非持续大批量生产。",
      ],
      duration: "10分钟",
    },
    "tea-center": {
      ...
      sectionBodies: [
        "行程的终点是茶叶中心，一支品茶小组会检查每一批茶——不仅在这里，此前也是如此，每当茶叶离开主厂运往本地市场，或送来包装时都会检查——查找过度发酵、发酵不足或烘焦等缺陷。任何在出售前未通过检验的茶叶都会被剔除，即使是细微的问题也会被记录下来，以指导未来的生产。这里还展出了手工茶厂的另外两款小批量特色产品——花朵茶轮和茶币。",
        ...
        "除了茶叶，庄园还将自家的绿茶和红茶（约90%）与本地草本——积雪草、灰莉叶和辣木叶（约10%）——混合，并用自家香料制作马萨拉、肉桂和姜味香料茶。马萨拉配方使用七种斯里兰卡香料，其中包括豆蔻、肉桂、姜和黑胡椒（其余成分保密）。奶茶推荐使用马萨拉茶或BOP茶。",
      ],
      duration: "10-15分钟",
    },
    "coconut-field": {
  ...
  ja: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "機械化された生産に加えて、一部の茶はすべての工程を機械を使わず完全に手作業で加工します。農園の職人技による特選等級の多くは——Golden Tip、Silver Tip、ホワイトティー、パープルティー、ピンクティー、ビタグロウ、手で結んだブルーミングティー、そして蓮茶のような花をブレンドした茶——主力の紅茶工場ではなく、ここで仕上げられます。（ビタグロウは、Golden TipやSilver Tipの紫色の新芽とは異なり、緑色の新芽の芽から作られます。）",
        ...
        "このストップでは、手作り茶が工場のライン生産とどう違うかを紹介しています。手揉みと手作業による加工は、葉ごとのばらつきが大きい、より小さなロットを生み出し、その独特な個性がしばしば高く評価されます。手作り茶は大きく二つのカテゴリーに分かれます——紅茶タイプの発酵茶（黒い色で見分けられます）で、これには珍しい元となる新芽を持つパープルティーも含まれます。もう一つは、ホワイトティーのように発酵を完全に省いて直接乾燥に進む非発酵茶です。",
        "ここで作られる最も手間のかかる品は二つの少量生産の特産品です——フラワーチャクラ（Flower Chakra）は、それぞれ約二本の新芽を使う手巻きの紅茶リングで、もう一つはティーコイン（Tea Coin）です。一人が一日に手で巻けるのはどちらか一方につきわずか約25グラムほどで、これが高価な理由であり、日常的に飲むためというより、裕福な茶愛好家によって記念品として購入されることがほとんどです。パープルティーを含め、手作り生産の多くは継続的に大量生産されるのではなく、注文に応じて少量ずつ作られます。",
      ],
      duration: "10分",
    },
    "tea-center": {
      ...
      sectionBodies: [
        "見学の最後は茶センターです。ここでは試飲チームがすべてのバッチを検査します——ここだけでなく、茶が主力工場から地元市場に向かう時や、包装のために届いた時にも、それ以前から検査されています——過発酵、発酵不足、焦げといった欠陥がないかを確認し、販売前に不合格となったものはすべて取り除き、些細な問題でも記録して今後の生産に活かします。ここには手作り工場のさらに二つの少量生産の特産品、フラワーチャクラとティーコインも展示されています。",
        ...
        "BOPFとBOPF Specialは、ほとんどのスリランカ人が日常的に飲んでいる等級です。ダストとダスト1という最も低い等級は輸出市場に送られることは決してなく、通常は着色料を加えられて安価なスーパーの茶葉パックに使われます——だからこそ、正しく抽出した後ではなく、浸した瞬間に色が出るのです。スーパーで売られているものの多くも、農園自体の未ブレンド・単一産地の茶とは異なり、他所から仕入れた安価な茶とブレンドされています。",
        "最高級の等級——FFエクストラスペシャル、FFスペシャル、FBOP——は収穫のわずか約1%、新芽の最も未熟な部分からしか得られず、100グラムあたり約25ドルで販売されます。OPAやOPのようなよりかさばる等級は200グラムあたり約5〜6ドルです。最高級の等級に見られる白いチップの粒は追加の甘みを加え、その多くはヨーロッパの買い手に渡り、一方でアラブ市場はより濃い味わいを好む傾向があります。",
        "茶以外にも、農園は自家製の緑茶と紅茶（約90%）を地元のハーブ（約10%）——ゴツコラ、ヒーンボビティヤ、モリンガ——とブレンドし、自家製のスパイスからマサラ、シナモン、ジンジャーのスパイスティーを作っています。マサラのレシピにはカルダモン、シナモン、ジンジャー、黒胡椒を含む七種類のスリランカのスパイスが使われており（残りは秘密にされています）、ミルクティーにはマサラかBOPが推奨されています。",
      ],
      duration: "10〜15分",
    },
    "coconut-field": {
