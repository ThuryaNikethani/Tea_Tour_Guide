 ...
 * confirmed by the user as real on-site signage). No new facts this
 * time — existing description/keyPoints merged unchanged into
 * sectionBodies[0], with a new translated heroTagline only.
 */
