 ...
 * does Y" chains). A handful of single, idiomatic copula dashes in
 * Russian ("X — Y" meaning "X is Y", grammatically normal Russian
 * punctuation rather than a machine-translation artifact) were
 * deliberately left as-is, consistent with how such dashes were
 * handled in earlier passes. This completes the "naturalize the whole
 * system" request in full: every station in the file has now had its
 * machine-translated-feeling dash/semicolon chains split into natural
 * sentences, in every language, with no facts, numbers, or meanings
 * changed anywhere.
 */
...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    fermentation: {
      ...
      sectionBodies: [
        "රෝල් කරන ලද කොළ — පළමු හා දෙවන ඩූල් යන දෙකම — අංශක සෙල්සියස් 25ත් 30ත් අතර උෂ්ණත්වයක් පවත්වන සිසිල්, තෙත් කාමරයක පතුරුවනු ලැබේ. එහිදී පැය 2.5ක් ඔක්සිකරණය වීමට තබන අතර, ප්‍රතික්‍රියාව සිදුවීමට ප්‍රමාණවත් ආර්ද්‍රතාවයක් හියුමිඩියෆයර් එකක් මගින් පවත්වා ගනී.",
    ...
    sorting: {
      ...
      sectionBodies: [
        ...
        "එම ශ්‍රේණිගත කිරීමේ යන්ත්‍රයේ, කොළ සහ මල් වැනි අංශු වෙන් හඳුනාගත හැකි කැමරා පද්ධතියක් සහිත වර්ණ වෙන්කරණයක් ඇතුළත් වන අතර, එයට අයත් නොවන ඕනෑම දෙයක් පෙරා දමයි — ශ්‍රී ලාංකික නිෂ්පාදනය කළු තේ කේන්ද්‍ර කරගෙන ඇති බැවින්, මෙම පියවර මගින් ඉතිරිව ඇති දුඹුරු, පූර්ණ ලෙස පැසවී නොමැති අංශු සහ නටු කැබලි ඉවත් කරනු ලැබේ. විවිධ දැල් ප්‍රමාණයේ පෙරහන් — අඟලකට හතරැස් සිදුරු ගණන අනුව මනිනු ලබන, අඟලකට සිදුරු 3ක් තරම් රළු සිට 60ක් තරම් සියුම් දක්වා පරාසයක — කිහිප වතාවක්ම කොටස් ප්‍රමාණය අනුව කොළ ශ්‍රේණි 21ක් පමණ දක්වා තවදුරටත් වෙන් කරයි. විද්‍යුත් ස්ථිති වෙන්කරණයක් ඉතිරි වන දුඹුරු පැහැති නටු කැබලිවලට රෝලර් මත ආරෝපණයක් ලබා දී ඒවා වෙන් කර ගැනීමට ඉඩ සලසන අතර, විශේෂිත යන්ත්‍ර මගින් Refuse තේ කණ්ඩායමෙන් සම්පූර්ණයෙන්ම ඉවත් කරනු ලැබේ — මෙහි කිසිදු පාටක් හෝ ලක්ෂණයක් තීන්ත හෝ එකතු කළ ද්‍රව්‍ය වලින් නොව, ස්වාභාවික සැකසුමෙන් පමණි.",
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "බොහෝ දුරට, කර්මාන්තශාලාව සිය නිමකළ තේ කොළඹ තේ බ්‍රෝකර් සමාගම්වලට භාර දෙයි — Forbes & Walker, Akbar Brothers, සහ Finlays වැනි නම් සඳහන් විය — ඔවුන් එය කොළඹ තේ වෙන්දේසියට ගෙන යයි. එහිදී මිලදී ගන්නන් එය මිලදී ගෙන, බොහෝ විට වැඩිදුර අගය එකතු කිරීමෙන් පසු තමන්ගේම වෙළඳ නාමවලින් අපනයනය කරයි. ඇතුකෝරළ නාමයෙන්ම සෘජු අපනයනයද සිදු වේ, නමුත් එය බොහෝ දුරට විදේශීය ගැනුම්කරුවන්ගේ විශේෂ ඇණවුම් සඳහා පමණි.",
    ...
    "artisanal-tea-grades": {
      ...
      sectionBodies: [
        ...
        "මෙහි නිපදවන වඩාත්ම ශ්‍රම-දැඩි අයිතම වන්නේ කුඩා-තොග විශේෂ භාණ්ඩ දෙකකි: Flower Chakra — අංකුර දෙකක් පමණ භාවිතා කරන අතින් රෝල් කළ කළු තේ මුදුවකි — සහ Tea Coin. එක් පුද්ගලයෙකුට දිනකට එකකින් ග්‍රෑම් 25ක් පමණක් අතින් රෝල් කළ හැක, එබැවින් ඒවා මෙතරම් මිල අධික වේ. සාමාන්‍ය පානය සඳහා වඩා, පොහොසත් තේ රසිකයන් විසින් සමරු භාණ්ඩයක් ලෙසය ඒවා බොහෝ විට මිලදී ගන්නේ. Purple Tea ඇතුළුව, බොහෝ අත්කම් නිෂ්පාදන අඛණ්ඩ තොග නිෂ්පාදනයක් වෙනුවට කුඩා තොග වශයෙන් ඇණවුම් අනුව සාදනු ලැබේ.",
      ],
      duration: "මිනිත්තු 5",
    },
    "pahatharata-manufacturing": {
      ...
      sectionBodies: [
        ...
        "CTC (Crush-Tear-Curl) කොළ යාන්ත්‍රිකව කුඩා, ඝන කැටිති බවට සකසන අතර, එමගින් පහත රට සිලෝන් තේවලට ලක්ෂණවත් ශක්තිමත් හා තියුණු රසය ලැබේ — මෙම චාරිකාවේ මීට පෙර රෝල් කිරීම හා ශ්‍රේණිගත කිරීමේ නැවතුම්වල දුටු එම කොළ අංශුමය.",
      ],
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "යාන්ත්‍රික නිෂ්පාදනයට අමතරව, සමහර තේ සෑම අදියරකදීම යන්ත්‍රයක් නොව සම්පූර්ණයෙන් අතින් සකසනු ලැබේ. වතුයායේ අත්කම් විශේෂ ශ්‍රේණි බොහොමයක් — Golden Tip, Silver Tip, White Tea, Purple Tea, Pink Tea, Vita Glow, අතින් බැඳි Blooming Tea, සහ නෙළුම් තේ වැනි මල් එකතු කළ මිශ්‍රණ — ප්‍රධාන කළු තේ කර්මාන්තශාලාව වෙනුවට මෙහිදී නිම කරනු ලැබේ. (Vita Glow සාදනු ලබන්නේ Golden Tip සහ Silver Tip හි දම් පැහැති අංකුරයට වඩා වෙනස්ව, කොළ පැහැති අංකුරයේ තුඩුවෙනි.)",
    ...
    "tea-center": {
      ...
      sectionBodies: [
        ...
        "හොඳම ශ්‍රේණි — FF Extra Special, FF Special, FBOP — ලැබෙන්නේ අස්වැන්නෙන් 1%ක් පමණින්, අංකුරයේ වඩාත්ම නොමුහුකුරා කොටසෙන්, සහ ග්‍රෑම් 100කට ඩොලර් 25ක් පමණට විකුණනු ලැබේ. OPA සහ OP වැනි විශාල ශ්‍රේණි ග්‍රෑම් 200කට ඩොලර් 5-6ක් පමණට විකිණේ. හොඳම ශ්‍රේණිවල දක්නට ලැබෙන සුදු තුඩු අංශු අමතර මිහිරි රසයක් එකතු කරන අතර බොහෝ දුරට යුරෝපීය ගැනුම්කරුවන් වෙත යයි, අරාබි වෙළඳපොළවල් වඩාත් ශක්තිමත් තේ රසයකට කැමති වෙයි.",
        "තේ හැරුණු විට, වතුයාය තමන්ගේම කොළ හා කළු තේ (ආසන්න වශයෙන් 90%) දේශීය ඖෂධ පැළෑටි (ආසන්න වශයෙන් 10%) — ගොටුකොළ, හීන්බෝවිටිය, සහ මොරින්ගා — සමඟ මිශ්‍ර කර, තමන්ගේම කුළුබඩුවලින් Masala, කුරුඳු, සහ ඉඟුරු කුළුබඩු තේ සාදයි. Masala වට්ටෝරුවේ ශ්‍රී ලාංකික කුළුබඩු හතක් භාවිතා වේ — කරදමුංගු, කුරුඳු, ඉඟුරු, සහ ගම්මිරිස් ඒවායින් නම් කර ඇති අතර ඉතිරිය රහසිගතව තබා ඇත. කිරි තේ සඳහා නිර්දේශ කරනු ලබන්නේ Masala හෝ BOP තේයි.",
      ],
      duration: "මිනිත්තු 10-15",
    },
    "coconut-field": {
  ...
  ta: {
    ...
    fermentation: {
      ...
      sectionBodies: [
        "உருட்டப்பட்ட இலை — முதல் மற்றும் இரண்டாம் டூல் இரண்டும் — 25 முதல் 30°C வரை வெப்பநிலையில் வைக்கப்பட்ட குளிர்ந்த, ஈரப்பதமான அறையில் பரப்பப்படுகிறது. அங்கு 2.5 மணி நேரம் ஆக்சிஜனேற்றமடைய விடப்படும், வினை நடைபெற போதுமான ஈரப்பதத்தை பராமரிக்க ஈரப்பதமூட்டி பயன்படுத்தப்படுகிறது.",
    ...
    "artisanal-tea-grades": {
      ...
      sectionBodies: [
        ...
        "Golden Tip அந்த தளிரின் முழுமையாக முதிர்ந்த மொட்டிலிருந்து தயாரிக்கப்படுகிறது, அதே நேரம் Silver Tip அதே தளிரின் இன்னும் முதிராத, வெளிர் நிற மொட்டிலிருந்து தயாரிக்கப்படுகிறது. அதன் மெல்லிய வெள்ளி நிற முடிகளே இந்த தரத்திற்கு அதன் பெயரையும் ஒரு மெல்லிய பொலிவையும் தருகின்றன. மொட்டு மட்டும் எடைபோடப்பட்டு, சில மணி நேரம் வாடவைக்கப்பட்டு, உலர்த்தப்படுகிறது — முழுமையாக நொதிக்கப்படும் தரங்களை விட எளிமையான செயல்முறை — இதன் விளைவாக மென்மையான இனிப்பு, மலர் மணம், மென்மையான அமைப்புடைய ஒரு கோப்பை கிடைக்கிறது.",
        ...
        "தோட்டம் மதிப்புக்கூட்டப்பட்ட கலவைகளையும் — தாமரை மலர்களுடன் கலந்த தேயிலை போன்றவை — அதே தளிர்களிலிருந்து கையால் கட்டப்பட்ட Blooming Teaவையும் தயாரிக்கிறது. இந்த கைவினைத் தரங்கள் நிலையான கருப்பு தேயிலையை விட மிகக் குறைந்த அளவில் பறிக்கப்பட்டு செயலாக்கப்படுகின்றன, இதுவே அவற்றை அரிதானதாகவும் மதிப்புமிக்கதாகவும் ஆக்குகிறது — சுவை பார்க்கும் கவுண்டரில் இவற்றை சுவைக்க கேளுங்கள். இந்த தரங்களில் பெரும்பாலானவற்றிற்கு ஊதா நிற தளிர் அல்லது சாதாரண பச்சை தளிர் இரண்டையும் பயன்படுத்தலாம் என்றாலும், தோட்டம் பெரும்பாலும் ஊதா நிற தளிரையே பயன்படுத்துகிறது.",
        "இங்கு தயாரிக்கப்படும் மிகவும் உழைப்பு மிக்க பொருட்கள் இரண்டு சிறு-தொகுதி சிறப்பு பொருட்களே: Flower Chakra — சுமார் இரண்டு தளிர்களைப் பயன்படுத்தும் கையால் உருட்டப்பட்ட கருப்பு தேயிலை வளையம் — மற்றும் Tea Coin. ஒரு நபர் ஒரு நாளைக்கு இவற்றில் ஒன்றை மட்டுமே சுமார் 25 கிராம் கையால் உருட்ட முடியும், அதனால்தான் இவை மிகவும் விலை உயர்ந்தவை. இவை அன்றாட குடிப்பதற்கு பதிலாக, செல்வந்த தேயிலை ஆர்வலர்களால் ஒரு நினைவுப் பொருளாக பெரும்பாலும் வாங்கப்படுகின்றன. Purple Tea உட்பட, பெரும்பாலான கைவினை உற்பத்தி தொடர்ச்சியாக மொத்தமாக உற்பத்தி செய்யப்படுவதற்கு பதிலாக ஆர்டர் அடிப்படையில் சிறிய தொகுதிகளாக தயாரிக்கப்படுகிறது.",
      ],
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "இயந்திரமயமாக்கப்பட்ட உற்பத்திக்கு கூடுதலாக, சில தேயிலைகள் ஒவ்வொரு கட்டத்திலும் இயந்திரமின்றி முழுவதுமாக கையால் செயலாக்கப்படுகின்றன. தோட்டத்தின் பெரும்பாலான கைவினை சிறப்பு தரங்கள் — Golden Tip, Silver Tip, White Tea, Purple Tea, Pink Tea, Vita Glow, கையால் கட்டப்பட்ட Blooming Tea, மற்றும் தாமரை தேநீர் போன்ற மலர் கலந்த கலவைகள் — முதன்மை கருப்பு தேயிலை தொழிற்சாலைக்கு பதிலாக இங்கேயே நிறைவு செய்யப்படுகின்றன. (Vita Glow, Golden Tip மற்றும் Silver Tip இன் ஊதா நிற தளிரிலிருந்து அல்லாமல், பச்சை நிற தளிரின் மொட்டிலிருந்து தயாரிக்கப்படுகிறது.)",
    ...
    "tea-center": {
      ...
      sectionBodies: [
        "சுற்றுலா தேயிலை மையத்தில் முடிவடைகிறது. இங்கு ஒரு சுவை பரிசோதனை குழு ஒவ்வொரு தொகுதியையும் சோதிக்கிறது — இங்கு மட்டும் அல்ல, தேயிலை முதன்மை தொழிற்சாலையிலிருந்து உள்ளூர் சந்தைக்கு செல்லும் போதும் அல்லது பேக்கிங்கிற்கு வரும் போதும் — அதிக நொதித்தல், குறைந்த நொதித்தல், அல்லது கருகுதல் போன்ற குறைபாடுகளுக்காக. விற்பனைக்கு முன் தோல்வியடையும் எதையும் நிராகரித்து, எதிர்கால உற்பத்திக்கு உதவும் வகையில் சிறிய பிரச்சினைகளை கூட குறிப்பிடுகிறது. கைவினை தொழிற்சாலையின் மேலும் இரண்டு சிறு-தொகுதி சிறப்பு பொருட்கள் — Flower Chakra மற்றும் Tea Coin — இங்கு காட்சிக்கு வைக்கப்பட்டுள்ளன.",
        "இதுபோன்ற கைவினை தேயிலைகளை கொதிநிலைக்கு பதிலாக சுமார் 80°C சூடான நீரைப் பயன்படுத்தி மூன்று முறை வரை மீண்டும் ஊற வைக்கலாம் — ஒவ்வொரு முறையும் புதிய சூடான நீருடன் சுமார் 2, 5, மற்றும் 8 நிமிடங்கள் — சாதாரண கருப்பு தேயிலை கொதிநிலையில் ஒரே முறை மட்டும் தயாரிக்கப்படுவதற்கு மாறாக. சுவை பரிசோதனை மது சுவை பரிசோதனையை ஒத்த ஒரு முறையை பின்பற்றுகிறது — முதலில் முகர்ந்து பார்த்தல், பின்னர் நாக்கின் பக்கவாட்டு சுவை மொட்டுகள் வழியாக தேயிலையை இழுக்க காற்றை உறிஞ்சி சுருட்டுதல். குழு ஒரு நாளைக்கு 50 தேயிலைகள் வரை சுவைக்கும் போது விழுங்குவதற்கு பதிலாக துப்புகிறது, எனினும் பார்வையாளர்கள் தாங்கள் சுவைப்பதை உண்மையில் குடிக்க வரவேற்கப்படுகிறார்கள். சரியாக தயாரிக்கப்பட்ட கருப்பு தேயிலைக்கு மூடப்பட்ட நிலையில் சுமார் 2.5 முதல் 3 நிமிடங்கள் ஊற வைக்க வேண்டும், விரைவான ஒரு தோய்த்தல் போதாது.",
        ...
        "தேயிலை தவிர, தோட்டம் தனது சொந்த பச்சை மற்றும் கருப்பு தேயிலையை (சுமார் 90%) உள்ளூர் மூலிகைகளுடன் (சுமார் 10%) — கோதுகொலா, ஹீன்போவிட்டியா, மொரிங்கா — கலந்து, தனது சொந்த மசாலாக்களிலிருந்து Masala, இலவங்கப்பட்டை, மற்றும் இஞ்சி மசாலா தேநீர்களை தயாரிக்கிறது. Masala செய்முறையில் ஏழு இலங்கை மசாலாப் பொருட்கள் பயன்படுத்தப்படுகின்றன — ஏலக்காய், இலவங்கப்பட்டை, இஞ்சி, மிளகு ஆகியவை பெயரிடப்பட்டுள்ளன, மீதமுள்ளவை ரகசியமாக வைக்கப்பட்டுள்ளன. பால் தேநீருக்கு Masala அல்லது BOP தேநீர் பரிந்துரைக்கப்படுகிறது.",
      ],
      duration: "10-15 நிமிடங்கள்",
    },
    "coconut-field": {
  ...
  it: {
    ...
    "pahatharata-manufacturing": {
      ...
      sectionBodies: [
        ...
        "Il CTC (Crush-Tear-Curl) lavora meccanicamente la foglia in granuli piccoli e densi, producendo il carattere forte e vivace per cui è noto il tè di Ceylon delle pianure — le stesse particelle di foglia viste prima alle tappe di arrotolamento e selezione di questo tour.",
      ],
    ...
    "tea-center": {
      ...
      sectionBodies: [
        ...
        "Questi tè artigianali possono essere re-infusi fino a tre volte usando acqua riscaldata a circa 80°C anziché bollente — circa 2, 5 e 8 minuti per infusione con acqua calda fresca ogni volta — a differenza del tè nero standard, che si prepara una sola volta a piena ebollizione. La degustazione segue un metodo simile a quello del vino: prima si annusa, poi si sorseggia rumorosamente per far passare il tè sulle papille gustative ai lati della lingua con un sorso d'aria. Il panel sputa anziché deglutire mentre assaggia fino a 50 tè al giorno, anche se i visitatori sono invitati a bere davvero ciò che assaggiano. Il tè nero preparato correttamente richiede circa 2,5-3 minuti di infusione coperta, non una semplice immersione veloce.",
  ...
  ar: {
    ...
    drying: {
      ...
      sectionBodies: [
        ...
        "ومع ذلك، فإن الوزن والجودة النهائيين للشاي لا يعتمدان على المجفف وحده — بل على سلسلة من الشروط: أوراق خضراء عالية الجودة، ذبول صحيح، عملية تصنيع صحيحة، تخمير ناجح (وهو الخطوة الأكثر أهمية من بينها جميعًا)، وأخيرًا معالجة صحيحة في المجفف.",
      ],
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "تسلّم المصنع في الغالب شايه الجاهز لسماسرة الشاي في كولومبو — وردت أسماء مثل Forbes & Walker وAkbar Brothers وFinlays — الذين ينقلونه إلى مزاد شاي كولومبو، حيث يشتريه المشترون وغالبًا ما يصدّرونه تحت علامتهم التجارية الخاصة بعد إضافة قيمة أخرى. يحدث أيضًا تصدير مباشر تحت اسم أثوكورالا نفسه، لكن ذلك يكون بشكل رئيسي لطلبات خاصة عرضية من مشترين في الخارج.",
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        ...
        "توضح هذه المحطة ما يميز الشاي المصنوع يدويًا عن الإنتاج بخط المصنع. ينتج اللف والتجهيز اليدويان دفعات أصغر بتفاوت أكبر بين الأوراق، وغالبًا ما تُقدَّر لطابعها المميز. تنقسم أنواع الشاي اليدوي إلى فئتين واسعتين: الأنواع المخمرة على طريقة الشاي الأسود (يمكن التعرف عليها من لونها الأسود)، والتي تشمل Purple Tea رغم برعمه الأصلي غير المعتاد؛ والأنواع غير المخمرة مثل White Tea، التي تتخطى التخمير تمامًا وتنتقل مباشرة إلى التجفيف.",
      ],
      duration: "10 دقائق",
    },
    "tea-center": {
  ...
  ru: {
    ...
    fermentation: {
      ...
      sectionBodies: [
        ...
        "Это самый важный этап для формирования вкуса. Время нужно определять точно: если недостаточно, чай получится слабым, если слишком долго — плоским и невыразительным.",
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "В основном фабрика передаёт готовый чай брокерам в Коломбо — упоминались такие имена, как Forbes & Walker, Akbar Brothers и Finlays, — которые доставляют его на чайный аукцион в Коломбо, где покупатели его приобретают и часто экспортируют под собственным брендом после дополнительной обработки. Прямой экспорт под именем Athukorala тоже случается, но в основном для отдельных специальных заказов от зарубежных покупателей.",
    ...
    "artisanal-tea-grades": {
      ...
      sectionBodies: [
        ...
        "White Tea берёт с побега два с половиной листа и полностью пропускает вяление. Его пропаривают и сушат, а не ферментируют и скручивают, как чёрный чай. В итоге получается очень легко обработанный, естественно сладкий вкус со светлым настоем, бархатистой текстурой, цветочным ароматом и природным богатством антиоксидантов. Purple Tea использует тот же сбор, но, в отличие от White Tea, проходит полный процесс чёрного чая — вяление, скручивание и ферментацию — для вкуса, близкого к улуну: легче чёрного чая, но менее травянистого, чем зелёный, сравнительно небольшое содержание кофеина и естественная насыщенность антиоксидантами.",
    ...
    "pahatharata-manufacturing": {
      ...
      sectionBodies: [
        "Низинные («Пахатарата») плантации, как эта, обрабатывают чай иначе, чем высокогорные плантации дальше вглубь острова, — и собственный производственный процесс поместья, показанный этап за этапом ранее в этом туре, подтверждает это: скручивание здесь превращает лист в мелкие плотные частицы, а не скручивает его в цельный ортодоксальный лист — отличительная черта CTC-обработки (Crush-Tear-Curl). Эта остановка — краткое резюме того, что означает такой низинный подход для сбора листа, обработки и сортировки.",
        "CTC (Crush-Tear-Curl — «дробление-разрыв-скручивание») механически превращает лист в мелкие плотные гранулы, придавая низинному цейлонскому чаю характерную крепость и резкость — те же самые частицы листа, что были видны ранее на остановках скручивания и сортировки в этом туре.",
      ],
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "Помимо механизированного производства, часть чая на каждом этапе обрабатывается полностью вручную, без машин. Большинство особых ремесленных сортов поместья — Golden Tip, Silver Tip, White Tea, Purple Tea, Pink Tea, Vita Glow, связанный вручную Blooming Tea и смеси с цветами, такие как чай с лотосом, — дорабатываются здесь, а не на основной фабрике чёрного чая. (Vita Glow делают из почки зелёного побега, в отличие от фиолетового побега Golden и Silver Tip.)",
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "Время до первого урожая сильно варьируется в зависимости от культуры — от всего 25–35 дней для редиса до 90–120 дней для лука-порея, так что в тоннеле почти всегда должно найтись что собрать в любой момент сезона. Выращивание такого широкого набора быстро- и медленно созревающих овощей бок о бок — само по себе осознанный выбор: оно естественным образом растягивает урожай во времени, вместо того чтобы всё созревало — или заканчивалось — одновременно.",
  ...
  de: {
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "Im Verpackungsbereich stehen mehrere fertige Sorten nebeneinander — Dust (hauptsächlich für Teebeutel), OP1, Pekoe, BOP (Broken Orange Pekoe) und OP (Orange Pekoe), wobei OP1 und OP besonders in arabischsprachigen Märkten beliebt sind und Pekoe in Russland und im Iran gut bekannt ist. Die seltenste und wertvollste hier hergestellte Sorte ist SFOPE1, eine 'Flowery Tippy'-Sorte, benannt nach den blassen, silbrigen Spitzenstücken, die sie von ganz oben im Trieb enthält — geschätzt eher für ihren feinen Charakter als für ihre Stärke.",
    ...
    "pahatharata-manufacturing": {
      ...
      sectionBodies: [
        "Tiefland-Plantagen ('Pahatharata') wie diese verarbeiten Tee anders als Hochlandplantagen weiter im Landesinneren — und der eigene Herstellungsprozess des Anwesens, der zuvor auf dieser Tour Schritt für Schritt gezeigt wurde, bestätigt das: Das Rollen zerkleinert das Blatt hier zu kleinen, dichten Partikeln, statt es zu einem ganzen orthodoxen Blatt zu rollen — das Kennzeichen der CTC-Verarbeitung (Crush-Tear-Curl). Diese Station fasst kurz zusammen, was dieser Tiefland-Ansatz für Pflücken, Verarbeitung und Sortierung bedeutet.",
        "CTC (Crush-Tear-Curl) verarbeitet das Blatt maschinell zu kleinen, dichten Granulaten und erzeugt den kräftigen, spritzigen Charakter, für den Tiefland-Ceylon-Tee bekannt ist — dieselben Blattpartikel, die zuvor an den Stationen Rollen und Sortieren auf dieser Tour zu sehen waren.",
      ],
    ...
    "tea-center": {
      ...
      sectionBodies: [
        ...
        "Solche handwerklichen Tees können bis zu dreimal mit etwa 80°C heißem statt kochendem Wasser erneut aufgegossen werden — jeweils etwa 2, 5 und 8 Minuten mit frischem heißem Wasser — anders als gewöhnlicher schwarzer Tee, der nur einmal mit sprudelnd kochendem Wasser aufgegossen wird. Die Verkostung folgt einer Methode ähnlich der Weinverkostung — zuerst riechen, dann schlürfen, um den Tee mit einem Luftzug über die Geschmacksknospen an den Zungenrändern zu ziehen. Das Team spuckt statt zu schlucken, während es bis zu 50 Tees am Tag verkostet, doch Besucher sind eingeladen, das Probierte tatsächlich zu trinken. Richtig aufgebrühter schwarzer Tee braucht etwa 2,5 bis 3 Minuten zugedeckte Ziehzeit, nicht nur ein kurzes Eintauchen.",
  ...
  es: {
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "En la zona de empaquetado hay varios grados terminados uno junto a otro — Dust (destinado sobre todo a bolsitas de té), OP1, Pekoe, BOP (Broken Orange Pekoe) y OP (Orange Pekoe) — con OP1 y OP especialmente populares en los mercados de habla árabe, y el Pekoe bien conocido en Rusia e Irán. El grado más raro y valioso que se produce aquí es el SFOPE1, un grado 'Flowery Tippy' llamado así por los pálidos fragmentos plateados de punta que contiene, procedentes de la parte más alta del brote — apreciado más por su carácter delicado que por su fuerza.",
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "Además de la producción mecanizada, parte del té se procesa por completo a mano en cada etapa, sin máquinas. La mayoría de los grados especiales artesanales de la finca — Golden Tip, Silver Tip, White Tea, Purple Tea, Pink Tea, Vita Glow, el Blooming Tea atado a mano y mezclas infusionadas con flores como el té de loto — se terminan aquí en lugar de en la fábrica principal de té negro. (El Vita Glow se hace con el brote del arbusto verde, a diferencia del brote púrpura del Golden y Silver Tip.)",
        ...
        "Una máquina dedicada al té verde — que cuece al vapor y prensa la hoja — se encarga de ese grado por separado, aunque actualmente está fuera de servicio por una reparación menor. Tras el vapor, la hoja reposa afuera para perder la humedad superficial, luego se enrolla a mano para resaltar su color, fuerza, aroma y sabor, antes de un último paso por el secador — el tiempo de secado varía de un pequeño productor a otro. El pequeño horno del edificio también sirve como panadería para bocadillos a base de té, como galletas. El secado, que se hace justo después de enrollar, se realiza aquí en dos secadores independientes — uno tradicional a leña, otro eléctrico — cada uno con capacidad para 34 bandejas, y ambos también se usan para otros productos de lotes pequeños, como cardamomo, clavo de olor y jengibre.",
        "Esta parada explica qué distingue al té hecho a mano de la producción en línea de fábrica. El enrollado y el procesamiento manuales producen lotes más pequeños con más variación entre hojas, a menudo apreciados por su carácter distintivo. Los tés hechos a mano se dividen en dos categorías amplias: los fermentados, al estilo del té negro (identificables por su color negro), que incluyen al Purple Tea pese a su inusual brote de origen; y los no fermentados como el White Tea, que se saltan la fermentación por completo y van directo al secado.",
      ],
      duration: "10 minutos",
    },
    "tea-center": {
      ...
      sectionBodies: [
        ...
        "Además del té, la finca mezcla su propio té verde y negro (alrededor del 90%) con hierbas locales (alrededor del 10%) — gotukola, heenbovitiya y moringa — y elabora tés especiados de Masala, Canela y Jengibre con sus propias especias. La receta del masala usa siete especias de Sri Lanka, entre ellas cardamomo, canela, jengibre y pimienta negra (el resto se mantiene en secreto). Para el té con leche se recomienda el masala o el BOP.",
      ],
      duration: "10-15 minutos",
    },
    "coconut-field": {
  ...
  fr: {
    ...
    "pahatharata-manufacturing": {
      ...
      sectionBodies: [
        ...
        "Le CTC (Crush-Tear-Curl) transforme mécaniquement la feuille en granulés petits et denses, produisant le caractère fort et vif pour lequel le thé de Ceylan des basses terres est connu — les mêmes particules de feuille observées plus tôt aux étapes du roulage et du triage de ce parcours.",
      ],
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        ...
        "Cette étape explique ce qui distingue le thé fait main de la production en ligne de fabrique. Le roulage et la transformation à la main produisent des lots plus petits avec plus de variation entre les feuilles, souvent appréciés pour leur caractère distinctif. Les thés faits main se répartissent en deux grandes catégories : les fermentés, façon thé noir (reconnaissables à leur couleur noire), qui incluent le Purple Tea malgré son bourgeon d'origine inhabituel ; et les non fermentés comme le White Tea, qui sautent entièrement la fermentation et passent directement au séchage.",
      ],
      duration: "10 minutes",
    },
    "tea-center": {
  ...
  zh: {
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "茶厂大多将成品茶交给科伦坡的茶叶经纪公司——提到的名字包括Forbes & Walker、Akbar Brothers和Finlays——由他们送往科伦坡茶叶拍卖会，买家在那里购入，往往在进一步加值后以自己的品牌出口。以阿图科拉拉自己的名义直接出口的情况也存在，但主要是应海外买家偶尔的特殊订单。",
    ...
    "artisanal-tea-grades": {
      ...
      sectionBodies: [
        ...
        "Golden Tip取自这种嫩芽完全成熟的芽头，Silver Tip则取自同一嫩芽颜色更浅、尚未成熟的芽头。细密的银色绒毛让Silver Tip得名，也带来一丝微光。只需称重芽头，萎凋几个小时，然后烘干——比全发酵茶更简单的工艺——便能得到一杯略带甜味、花香、口感丝滑的茶汤。",
        ...
        "Pink Tea起初几乎无色，就像White Tea一样，只有加入几滴青柠汁后才会变成粉红色——柑橘触发了同一种赋予嫩芽颜色的花青素色素发生变色。它也很适合加几滴蜂蜜，建议做成冰茶饮用，同样天然富含抗氧化物质。而Vita Glow则不是用紫色嫩芽，而是用普通绿色嫩芽的芽头制成。",
    ...
    "pahatharata-manufacturing": {
      ...
      sectionBodies: [
        ...
        "CTC（压碎-撕裂-揉卷）通过机械方式将茶叶加工成细小紧实的颗粒，造就了低地锡兰红茶浓烈爽口的特点——正是本次游览此前在揉捻和分级站点所见到的那种茶叶颗粒。",
      ],
      duration: "10-15分钟",
    },
    "organic-cultivation": {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "除了机械化生产之外，部分茶叶在每个环节都完全依靠人工处理，不使用机器。庄园大多数手工特色茶品——Golden Tip、Silver Tip、White Tea、Purple Tea、Pink Tea、Vita Glow、手工绑扎的Blooming Tea，以及莲花茶等花香混合茶——都是在这里而非主要红茶厂完成的。（Vita Glow取自绿色嫩芽的芽头，与Golden Tip、Silver Tip所用的紫色嫩芽不同。）",
    ...
    "tea-center": {
      ...
      sectionBodies: [
        "行程的终点是茶叶中心，一支品茶小组会检查每一批茶——不仅在这里，此前也是如此，每当茶叶离开主厂运往本地市场，或送来包装时都会检查——查找过度发酵、发酵不足或烘焦等缺陷。任何在出售前未通过检验的茶叶都会被剔除，即使是细微的问题也会被记录下来，以指导未来的生产。这里还展出了手工茶厂的另外两款小批量特色产品——Flower Chakra和Tea Coin。",
        "这类手工茶可以用约80°C的热水（而非沸水）冲泡多达三次——每次用新鲜热水，分别约2、5、8分钟——不同于标准红茶只用滚沸的水冲泡一次。品茶遵循一种与品酒类似的方法——先闻香，再吸气啜饮，让茶汤掠过舌头两侧的味蕾。品茶小组一天最多品鉴50款茶，会吐出而不是咽下，不过访客倒是可以真正喝下自己品尝的茶。正确冲泡的红茶需要加盖浸泡约2.5到3分钟，而不只是快速一蘸。",
        ...
        "最上乘的等级——FF Extra Special、FF Special、FBOP——仅取自约1%的收成，是嫩芽中最不成熟的部分，每100克售价约25美元；而OPA、OP等更粗大的等级每200克售价约5到6美元。最上乘等级中可见的白色芽尖颗粒增添了额外的甜味，大多销往欧洲买家，而阿拉伯市场则更偏好口感更浓的茶。",
        "除了茶叶，庄园还将自家的绿茶和红茶（约90%）与本地草本——积雪草、灰莉叶和辣木叶（约10%）——混合，并用自家香料制作Masala、肉桂和姜味香料茶。Masala配方使用七种斯里兰卡香料，其中包括豆蔻、肉桂、姜和黑胡椒（其余成分保密）。奶茶推荐使用Masala茶或BOP茶。",
      ],
      duration: "10-15分钟",
    },
    "coconut-field": {
  ...
  ja: {
    ...
    sorting: {
      ...
      sectionBodies: [
        ...
        "乾燥した葉が選別機を通る際、元の新芽のどの部分から来たかによって一度の通過で分けられます——柔らかく折れやすい先端と一番上の葉——それぞれの新芽のわずか約2%——はFBOPF Extra Specialになります。これは最上級で最も高価な等級です。その下にある葉はBOPやPekoeのような力強い等級になります。最も成熟した一番下の葉はDustになり、使えない茎やくずはRefuseとして取り除かれます。",
        "その選別機には、葉や花のような粒子を見分けられるカメラシステムを備えた色選別機が組み込まれており、該当しないものはすべてろ過されます——スリランカの生産は紅茶中心であるため、この工程によって発酵が不十分な茶色の粒子や残った茎の破片が取り除かれます。異なる網目の篩——1インチあたりの正方形の穴の数で測られ、最も粗いもので1インチあたり3穴、最も細かいもので60穴まで幅があります——が、複数回の工程でさらに粒子の大きさ別に葉を約21種類の等級に分けます。静電分離機はローラー上で残った茶色の茎の破片に静電気を帯びさせ、それらを取り除けるようにし、専用の機械がロット全体から廃棄茶をすべて取り除きます。ここでの色や個性はいずれも染料や添加物によるものではなく、天然の加工工程によるものだけです。",
    ...
    packing: {
      ...
      sectionBodies: [
        ...
        "梱包エリアには複数の完成した等級が並んでいます——Dust（主にティーバッグ用）、OP1、Pekoe、BOP（Broken Orange Pekoe）、OP（Orange Pekoe）——OP1とOPは特にアラビア語圏の市場で人気があり、Pekoeはロシアとイランでよく知られています。ここで作られる最も希少で価値の高い等級はSFOPE1で、「Flowery Tippy」等級と呼ばれています。新芽の最上部から得られる淡く銀色のチップの断片を含んでいることからこの名がつき、力強さよりもその繊細な個性のために評価されています。",
        "袋の重量も等級によって異なります——決まった大きさの袋には、Dustのような薄く密度の高い等級（約58キロ）の方が、OPEのようなよりかさばる葉の多い等級（約30キロ）よりもはるかに多く入ります。",
        "工場は主に完成した茶をコロンボの茶商——Forbes & Walker、Akbar Brothers、Finlaysといった名前が挙がりました——に引き渡し、彼らがそれをコロンボ茶オークションに持ち込みます。そこで買い手がそれを購入し、多くの場合さらに付加価値を加えた後、自社ブランドで輸出します。アトゥコララという名前自体での直接輸出も行われますが、それは主に海外の買い手からの臨時の特別注文向けです。",
    ...
    "artisanal-tea-grades": {
      ...
      sectionBodies: [
        ...
        "ここで作られる最も手間のかかる品は二つの少量生産の特産品です——Flower Chakraは、それぞれ約二本の新芽を使う手巻きの紅茶リングで、もう一つはTea Coinです。一人が一日に手で巻けるのはどちらか一方につきわずか約25グラムほどで、これが高価な理由であり、日常的に飲むためというより、裕福な茶愛好家によって記念品として購入されることがほとんどです。Purple Teaを含め、手作り生産の多くは継続的に大量生産されるのではなく、注文に応じて少量ずつ作られます。",
      ],
      duration: "5分",
    },
    "pahatharata-manufacturing": {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "機械化された生産に加えて、一部の茶はすべての工程を機械を使わず完全に手作業で加工します。農園の職人技による特選等級の多くは——Golden Tip、Silver Tip、White Tea、Purple Tea、Pink Tea、Vita Glow、手で結んだBlooming Tea、そして蓮茶のような花をブレンドした茶——主力の紅茶工場ではなく、ここで仕上げられます。（Vita Glowは、Golden TipやSilver Tipの紫色の新芽とは異なり、緑色の新芽の芽から作られます。）",
        ...
        "専用の緑茶機械——葉を蒸して圧搾するもの——がその等級を別途扱っていますが、現在は軽微な修理のため停止しています。蒸した後、葉は屋外に置かれて表面の水分を飛ばし、その後、色、力強さ、香り、味を引き出すために引き伸ばしながら手で揉まれ、最後に乾燥機を通ります——乾燥時間は小規模生産者ごとに異なります。この建物の小さなオーブンは、ビスケットのような茶を使った軽食を焼くパン焼き場としても使われています。揉捻の直後に行う乾燥は、ここでは二台の別々の乾燥機で行われます——一台は伝統的な薪式、もう一台は電気式——それぞれ34枚のトレイを収容でき、両方ともカルダモン、クローブ、生姜といった他の少量生産品にも使われています。",
        "このストップでは、手作り茶が工場のライン生産とどう違うかを紹介しています。手揉みと手作業による加工は、葉ごとのばらつきが大きい、より小さなロットを生み出し、その独特な個性がしばしば高く評価されます。手作り茶は大きく二つのカテゴリーに分かれます——紅茶タイプの発酵茶（黒い色で見分けられます）で、これには珍しい元となる新芽を持つPurple Teaも含まれます。もう一つは、White Teaのように発酵を完全に省いて直接乾燥に進む非発酵茶です。",
      ],
      duration: "10分",
    },
    "tea-center": {
      ...
      sectionBodies: [
        ...
        "こうした職人技の茶は、沸騰したお湯ではなく約80°Cのお湯を使って最大三回まで淹れ直すことができます——毎回新しいお湯を使い、それぞれ約2分、5分、8分——完全な沸騰状態で一度だけ淹れる標準的な紅茶とは異なります。試飲はワインのテイスティングに似た方法で行われます——まず香りを嗅ぎ、次に空気を吸い込みながら音を立ててすすり、舌の両側にある味蕾に茶を通します。チームは一日に最大50種類の茶を試飲する間、飲み込まずに吐き出しますが、訪問者は実際に試飲したものを飲むことを歓迎されています。正しく淹れた紅茶には、覆いをして約2.5分から3分の抽出時間が必要で、単なる素早い浸漬では足りません。",
    ...
    polytunnel: {
      name: "ビニールハウスと温室",
      heroTagline: "農園自前のビニールハウス——すでに最初の作物が育っています。",
