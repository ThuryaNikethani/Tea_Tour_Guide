...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "අතින් රෝල් කිරීම සහ අතින් සැකසීම, කුඩා තොග, කොළ අතර වැඩි විචලනයක් සමඟ නිපදවන අතර, ඒවායේ සුවිශේෂී ලක්ෂණය නිසා බොහෝ විට අගය කරනු ලැබේ. අත්කම් තේ පුළුල් කාණ්ඩ දෙකකට වැටේ — කළු තේ ආකාරයේ පැසුණු ඒවා (කළු වර්ණය මගින් හඳුනාගත හැකි) සහ සුදු තේ සහ දම් තේ වැනි නොපැසුණු ඒවා, ඒවා සම්පූර්ණයෙන්ම පැසවීම මඟහැර කෙලින්ම වියලීමට යයි. මෙහි නිපදවන වඩාත්ම ශ්‍රම-දැඩි අයිතමය අංකුර දෙකක් පමණ භාවිතා කරන අතින් රෝල් කළ කළු තේ මුදුවකි — එක් පුද්ගලයෙකුට දිනකට ග්‍රෑම් 25ක් පමණක් අතින් රෝල් කළ හැක, එබැවින් එය මෙතරම් මිල අධික වන අතර, එදිනෙදා පානය සඳහා වඩා පොහොසත් තේ රසිකයන් විසින් සමරු භාණ්ඩයක් ලෙස මිලදී ගනු ලැබේ. දම් තේ ඇතුළුව, බොහෝ අත්කම් නිෂ්පාදන අඛණ්ඩ තොග නිෂ්පාදනයක් වෙනුවට කුඩා තොග වශයෙන් ඇණවුම් අනුව සාදනු ලැබේ.",
  ...
  ta: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "கை சுருட்டல் மற்றும் கை செயலாக்கம் சிறிய தொகுதிகளை உருவாக்குகின்றன, இலைகளுக்கு இடையே அதிக மாறுபாட்டுடன், அவற்றின் தனித்துவமான தன்மைக்காக பெரும்பாலும் மதிக்கப்படுகின்றன. கைவினை தேயிலைகள் இரண்டு பரந்த வகைகளாகப் பிரிக்கப்படுகின்றன — கருப்பு தேயிலை பாணியில் நொதிக்கப்பட்டவை (கருப்பு நிறத்தால் அடையாளம் காணக்கூடியவை) மற்றும் வெள்ளை தேயிலை மற்றும் ஊதா தேயிலை போன்ற நொதிக்கப்படாதவை, அவை நொதித்தலை முழுவதுமாகத் தவிர்த்து நேரடியாக உலர்த்தலுக்குச் செல்கின்றன. இங்கு தயாரிக்கப்படும் மிகவும் உழைப்பு மிக்க பொருள் ஒரு கையால் உருட்டப்பட்ட கருப்பு தேயிலை வளையமாகும், இதற்கு சுமார் இரண்டு தளிர்கள் பயன்படுத்தப்படுகின்றன — ஒரு நபர் ஒரு நாளைக்கு சுமார் 25 கிராம் மட்டுமே கையால் உருட்ட முடியும், அதனால்தான் இது மிகவும் விலை உயர்ந்தது, மேலும் அன்றாட குடிப்பதற்குப் பதிலாக பணக்கார தேயிலை ஆர்வலர்களால் நினைவுப்பொருளாக பெரும்பாலும் வாங்கப்படுகிறது. ஊதா தேயிலை உட்பட, பெரும்பாலான கைவினை உற்பத்தி தொடர்ச்சியான மொத்த உற்பத்திக்குப் பதிலாக ஆர்டர்களுக்கு ஏற்ப சிறிய தொகுதிகளாகவே தயாரிக்கப்படுகிறது.",
  ...
  it: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "L'arrotolamento e la lavorazione a mano producono lotti più piccoli con maggiore variazione tra le foglie, spesso apprezzati per il loro carattere distintivo. I tè artigianali rientrano in due grandi categorie — quelli fermentati in stile tè nero (riconoscibili dal colore nero) e quelli non fermentati come il tè bianco e il tè viola, che saltano completamente la fermentazione e passano direttamente all'essiccazione. L'articolo più laborioso prodotto qui è un anello di tè nero arrotolato a mano che utilizza circa due germogli ciascuno — una sola persona può arrotolare a mano solo circa 25 grammi al giorno, motivo per cui è così costoso ed è per lo più acquistato come souvenir da facoltosi appassionati di tè piuttosto che consumato quotidianamente. La maggior parte della produzione artigianale, tè viola incluso, viene realizzata su ordinazione in piccoli lotti anziché come produzione continua di massa.",
      duration: "10 minuti",
    },
    "tea-center": {
      name: "Centro del Tè",
  ...
  ar: {
    ...
    "artisanal-tea-grades": {
      ...
      description: "بالإضافة إلى الشاي الأسود القياسي، تنتج المزرعة أيضًا أنواعًا نادرة من الشاي الحرفي المصنوع يدويًا — يُصنَّع معظمها يدويًا في مصنع الشاي اليدوي المنفصل بدلاً من خط الشاي الأسود الرئيسي، ولهذا تُسمى هذه الدرجات أيضًا 'درجات الشاي الحرفي': فهي أقرب إلى حرفة يدوية منها إلى إنتاج جماعي. يأتي الكثير منها من برعم مميز بلون أرجواني، يكتسب لونه من مادة الأنثوسيانين. يُستخدم لصنع القمة الذهبية البرعم الناضج تمامًا من ذلك النبات نفسه، بينما يُستخدم لصنع القمة الفضية البرعم الأفتح لونًا وغير الناضج بعد من النبات نفسه. يُؤخذ للشاي الأبيض ورقتان ونصف من البرعم مع تخطي مرحلة الذبول تمامًا — إذ تُبخَّر وتُجفَّف بدلاً من التخمير واللف كما في الشاي الأسود — لتُنتج مذاقًا معالجًا بخفة شديدة وحلوًا بشكل طبيعي. يتخطى الشاي الأرجواني التخمير تمامًا وينتقل مباشرة إلى التجفيف، تمامًا مثل الشاي الأبيض؛ والشاي الوردي صنف متخصص فريد آخر، وكلاهما غني بمضادات الأكسدة الطبيعية. أما فيتا جلو فيُصنع من برعم النبتة ذات اللون الأخضر العادي بدلاً من الأرجواني. كما تُعِدّ المزرعة مزيجات ذات قيمة مضافة — مثل الشاي المنقوع بزهور اللوتس — وشاي Blooming Tea المربوط يدويًا من نفس البراعم.",
    ...
    "handmade-factory": {
      ...
      keyPoints: "ينتج اللف والمعالجة اليدويان دفعات أصغر بتباين أكبر بين الأوراق، وغالبًا ما تُقدَّر لطابعها المميز. تنقسم أنواع الشاي الحرفي إلى فئتين رئيسيتين — أنواع مخمّرة على طراز الشاي الأسود (يمكن تمييزها بلونها الأسود)، وأنواع غير مخمّرة مثل الشاي الأبيض والشاي الأرجواني، التي تتخطى التخمير تمامًا وتنتقل مباشرة إلى التجفيف. أكثر منتج يتطلب عملاً هنا هو حلقة شاي أسود ملفوفة يدويًا تستخدم نحو برعمين لكل حلقة — يمكن لشخص واحد لف حوالي 25 غرامًا فقط يدويًا في اليوم، ولهذا السبب يكون باهظ الثمن، ويُشترى غالبًا كتذكار من قِبل هواة الشاي الأثرياء بدلاً من استخدامه للشرب اليومي. ومعظم الإنتاج اليدوي، بما في ذلك الشاي الأرجواني، يُصنع حسب الطلب وبكميات صغيرة بدلاً من الإنتاج الجماعي المستمر.",
      duration: "10 دقائق",
    },
    "tea-center": {
      name: "مركز الشاي",
  ...
  ru: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "Ручное скручивание и ручная обработка дают меньшие партии с большей вариативностью между листьями, что часто ценится за их особый характер. Ремесленный чай делится на две широкие категории — ферментированные, в стиле чёрного чая (их можно узнать по чёрному цвету), и неферментированные, такие как белый и фиолетовый чай, которые полностью пропускают ферментацию и отправляются прямо на сушку. Самое трудоёмкое изделие, которое здесь делают, — скрученное вручную кольцо из чёрного чая, на которое уходит около двух побегов; один человек может вручную скрутить лишь около 25 граммов в день, поэтому оно такое дорогое и его чаще покупают как сувенир состоятельные любители чая, а не для повседневного питья. Большая часть ремесленной продукции, включая фиолетовый чай, изготавливается на заказ небольшими партиями, а не в непрерывном массовом производстве.",
      duration: "10 минут",
    },
    "tea-center": {
      name: "Чайный центр",
  ...
  de: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "Handrollen und Handverarbeitung ergeben kleinere Chargen mit mehr Variation zwischen den Blättern, die oft für ihren unverwechselbaren Charakter geschätzt werden. Handwerklicher Tee lässt sich in zwei große Kategorien einteilen — fermentierte, schwarzteeartige Sorten (erkennbar an ihrer schwarzen Farbe) und unfermentierte wie Weißer und violetter Tee, die die Fermentation vollständig auslassen und direkt zum Trocknen übergehen. Das arbeitsintensivste hier hergestellte Stück ist ein von Hand gerollter Schwarztee-Ring aus jeweils etwa zwei Trieben — eine Person kann von Hand nur etwa 25 Gramm pro Tag rollen, weshalb er so teuer ist und meist von wohlhabenden Teeliebhabern als Souvenir gekauft wird statt für den täglichen Genuss. Die meiste handwerkliche Produktion, einschließlich violetter Tee, entsteht auf Bestellung in kleinen Chargen statt in fortlaufender Massenproduktion.",
      duration: "10 Minuten",
    },
    "tea-center": {
      name: "Teezentrum",
  ...
  es: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "El enrollado y procesamiento a mano producen lotes más pequeños con más variación entre hojas, a menudo apreciados por su carácter distintivo. Los tés artesanales se dividen en dos grandes categorías — los fermentados al estilo del té negro (identificables por su color negro) y los no fermentados, como el té blanco y el té morado, que se saltan la fermentación por completo y van directamente al secado. El artículo que más mano de obra requiere aquí es un anillo de té negro enrollado a mano que usa unos dos brotes cada uno — una sola persona puede enrollar a mano solo unos 25 gramos al día, por lo que es tan caro y suele comprarse como souvenir por adinerados aficionados al té en lugar de consumirse a diario. La mayor parte de la producción artesanal, incluido el té morado, se elabora por encargo en pequeños lotes en lugar de en producción continua a gran escala.",
      duration: "10 minutos",
    },
    "tea-center": {
      name: "Centro del Té",
  ...
  fr: {
    ...
    "handmade-factory": {
      ...
      keyPoints: "Le roulage et le traitement à la main produisent des lots plus petits avec plus de variation entre les feuilles, souvent appréciés pour leur caractère distinctif. Les thés artisanaux se répartissent en deux grandes catégories — les fermentés, façon thé noir (reconnaissables à leur couleur noire), et les non fermentés comme le thé blanc et le thé violet, qui évitent entièrement la fermentation et passent directement au séchage. L'article le plus exigeant en main-d'œuvre fabriqué ici est un anneau de thé noir roulé à la main utilisant environ deux pousses chacun — une seule personne ne peut rouler à la main qu'environ 25 grammes par jour, ce qui explique son prix élevé ; il est surtout acheté comme souvenir par de riches amateurs de thé plutôt que consommé au quotidien. La majeure partie de la production artisanale, y compris le thé violet, est réalisée sur commande en petits lots plutôt qu'en production continue en masse.",
      duration: "10 minutes",
    },
    "tea-center": {
      name: "Centre du Thé",
  ...
  zh: {
    ...
    "artisanal-tea-grades": {
      name: "手工精品茶",
      description: "除了标准红茶外，庄园还出产稀有的手工精品茶——这些茶大多在独立的手工制茶厂而非主要的红茶生产线上手工完成，因此这些等级也被称为「手工精品茶」：它更接近一门手艺，而非批量生产。其中许多都取自一种独特的紫色新梢，其颜色来自花青素。金针取自该新梢完全成熟的芽头，银针则取自同一新梢颜色更浅、尚未成熟的芽头。白茶取新梢上的两叶半，完全跳过萎凋——经蒸制、烘干而成，不像红茶那样经过发酵和揉捻——因此口感极轻微加工、带有天然甜味。紫茶完全跳过发酵，直接进入干燥工序，做法与白茶相同；粉茶是另一种独特的特色品种，两者都富含天然抗氧化物。Vita Glow则不同，它取自普通绿色新梢的芽头，而非紫色新梢。庄园还会制作增值调配茶——例如加入莲花的茶——以及用同样的新梢手工扎制而成的开花茶（Blooming Tea）。",
    ...
    "handmade-factory": {
      ...
      keyPoints: "手工揉捻与手工加工产量较小，叶片间差异更大，因其独特风味而备受珍视。手工茶大致分为两大类——经过发酵、类似红茶的品种（可通过其黑色辨认），以及像白茶、紫茶这样完全不经发酵、直接进入干燥工序的品种。这里制作最费工的产品是一种手工卷制的红茶「环」，每个约用两根新梢——一人每天只能手工卷制约25克，因此价格昂贵，多被富裕的茶叶爱好者当作纪念品购买，而非用于日常饮用。包括紫茶在内的大多数手工产品都是按订单小批量制作，而非持续的批量生产。",
      duration: "10分钟",
    },
    "tea-center": {
      name: "茶叶中心",
  ...
  ja: {
    ...
    "artisanal-tea-grades": {
      name: "職人技の高級茶",
      description: "標準的な紅茶に加えて、この農園では希少な手作りの高級茶も生産しています——その多くは紅茶の主生産ラインではなく、別棟の手工茶工場で手作業により仕上げられます。これが「職人技の高級茶」とも呼ばれる理由で、大量生産というより工芸に近いものです。これらの多くは特徴的な紫がかった新芽から作られ、その色はアントシアニンによるものです。ゴールデンティップスにはその新芽の完全に成熟した芽を、シルバーティップスには同じ新芽のまだ未熟で色の薄い芽を使用します。白茶は新芽から葉2枚半を摘み取り、萎凋の工程を完全に省いて——紅茶のように発酵・揉捻するのではなく、蒸してから乾燥させることで——非常に軽く加工された自然な甘みのある味わいに仕上げます。パープルティーは白茶と同様、発酵の工程を完全に省いて直接乾燥工程に進みます。ピンクティーはもう一つの独特な特別品種で、どちらも天然の抗酸化物質が豊富です。一方ヴィータグローは、紫がかった新芽ではなく、通常の緑がかった新芽の芽から作られます。この農園では、蓮の花を使ったお茶などの付加価値ブレンドや、同じ新芽から手作業で結び上げるブルーミングティーも作られています。",
    ...
    "handmade-factory": {
      ...
      keyPoints: "手揉みと手作業による加工は、少量生産で葉ごとの個性が出やすく、その独特な風味がしばしば珍重されます。手作りの茶は大きく二つに分けられます——紅茶のように発酵させたもの（黒い色で見分けられます）と、白茶やパープルティーのように発酵を完全に省いて直接乾燥工程に進むものです。ここで作られる中で最も手間のかかる品は、新芽約2本を使って手で巻き上げる紅茶の「リング」で、一人が一日に手で巻けるのはわずか約25グラムほどです。そのため非常に高価で、日常的に飲まれるというより、裕福な紅茶愛好家によってお土産として購入されることがほとんどです。パープルティーを含め、手作りの製品のほとんどは継続的な大量生産ではなく、注文に応じて少量ずつ作られています。",
      duration: "10分",
    },
    "tea-center": {
      name: "ティーセンター",
