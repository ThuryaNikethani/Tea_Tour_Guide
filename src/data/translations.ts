 ...
 * (tea-tourism-guide.netlify.app) on 2026-08-18 by switching its language
 ...
 * 2026-08-18) — not reviewed by a native speaker or the factory.
 *
 ...
 * copy, same caveat as the English original (`verified: false`).
 *
...
const NURSERY_REAL: Record<Exclude<LanguageCode, "en">, { name: string; heroTagline: string; sectionHeadings: string[] }> = {
  zh: {
    ...
    sectionHeadings: ["场地选择", "苗圃准备", "苗圃土壤", "填充套管", "扦插准备", "扦插种植", "扦插种植后的护理", "移植的土地准备", "移植", "茶树品种"],
  },
  ja: {
    name: "茶の苗床",
    heroTagline: "健康な茶の木を植える方法を段階的に見ていきましょう。",
    sectionHeadings: ["敷地の選定", "苗床の準備", "苗床土", "スリーブの充填", "挿し木の準備", "挿し木を植える", "挿し木後の手入れ", "移植のための土地の準備", "移植", "茶の品種"],
  },
  es: {
    name: "Vivero de Té",
    heroTagline: "Echemos un vistazo paso a paso a cómo plantar una planta de té saludable.",
    sectionHeadings: ["Selección del Sitio", "Preparación del Vivero", "Suelo del Vivero", "Llenado de mangas", "Preparación de Esquejes", "Plantación de los Esquejes", "Cuidado después de plantar esquejes", "Preparación del Terreno para el Trasplante", "Trasplante", "Cultivares de Té"],
  },
  fr: {
    name: "Pépinière de Thé",
    heroTagline: "Examinons étape par étape comment planter un théier sain.",
    sectionHeadings: ["Sélection du Site", "Préparation de la Pépinière", "Sol de Pépinière", "Remplissage des manchons", "Préparation des Boutures", "Plantation des Boutures", "Soins après la plantation des boutures", "Préparation du Terrain pour le Repiquage", "Repiquage", "Cultivars de Thé"],
  },
  ru: {
    name: "Чайный питомник",
    heroTagline: "Давайте пошагово рассмотрим, как посадить здоровый чайный куст.",
    sectionHeadings: ["Выбор Места", "Подготовка Питомника", "Почва для Питомника", "Заполнение рукавов", "Подготовка Черенков", "Посадка Черенков", "Уход после посадки черенков", "Подготовка Земли для Пересадки", "Пересадка", "Культивары Чая"],
  },
  si: {
    name: "තේ තවාන",
    heroTagline: "නිරෝගී තේ පැළයක් සිටුවන ආකාරය පියවරෙන් පියවර බලමු.",
    sectionHeadings: ["ස්ථානය තෝරා ගැනීම", "තවාන සකස් කිරීම", "තවාන් පස", "පොලිතීන් බෑග් පිරවීම", "දඬු කැබලි සකස් කිරීම", "දඬු කැබලි සිටුවීම", "සිටුවීමෙන් පසු රැකවරණය", "සිටුවීම සඳහා ඉඩම් සකස් කිරීම", "ක්ෂේත්‍රයේ සිටුවීම", "තේ ප්‍රභේද"],
  },
  ar: {
    name: "مشتل الشاي",
    heroTagline: "دعونا نلقي نظرة خطوة بخطوة على كيفية زراعة نبات شاي صحي.",
    sectionHeadings: ["اختيار الموقع", "إعداد المشتل", "تربة المشتل", "تعبئة أكياس البوليثين", "إعداد العقل", "زراعة العقل", "العناية بعد الزراعة", "إعداد الأرض للزراعة", "الزراعة في الحقل", "أصناف الشاي"],
  },
  it: {
    name: "Vivaio del Tè",
    heroTagline: "Vediamo passo dopo passo come piantare una pianta di tè sana.",
    sectionHeadings: ["Scelta del Sito", "Preparazione del Vivaio", "Terreno del Vivaio", "Riempimento sacchetti", "Preparazione Talee", "Piantagione delle Talee", "Cura post-piantagione", "Preparazione Terreno", "Trapianto", "Cultivar di Tè"],
  },
  de: {
    name: "Tee-Baumschule",
    heroTagline: "Lassen Sie uns Schritt für Schritt anschauen, wie man eine gesunde Teepflanze pflanzt.",
    sectionHeadings: ["Standortwahl", "Vorbereitung der Baumschule", "Boden der Baumschule", "Füllen der Polyethylenbeutel", "Vorbereitung der Stecklinge", "Pflanzen von Stecklingen", "Pflege nach dem Pflanzen", "Landvorbereitung", "Umpflanzen ins Feld", "Teekultursorten"],
  },
  ta: {
    name: "தேயிலை நாற்றுமேடை",
    heroTagline: "ஆரோக்கியமான தேயிலை செடியை எவ்வாறு நடுவது என்பதை படிப்படியாகப் பார்ப்போம்.",
    sectionHeadings: ["இடத்தைத் தேர்ந்தெடுத்தல்", "நாற்றுமேடை தயாரித்தல்", "நாற்றுமேடை மண்", "பொலிதீன் பைகளை நிரப்புதல்", "தண்டு துண்டுகளைத் தயாரித்தல்", "தண்டு துண்டுகளை நடுதல்", "நடவுக்குப் பிந்தைய பராமரிப்பு", "நிலத்தைத் தயாரித்தல்", "வயல் நடவு", "தேயிலை வகைகள்"],
  },
};
