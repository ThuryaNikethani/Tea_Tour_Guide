 ...
 * then completed for "mushroom-hut" (all 10 languages) and for
 * "polytunnel" (all 15 sections, all 10 languages, including the crop
 * sections added on 2026-09-07 with their "[Local name] — literal
 * meaning — species" dash chains). Remaining not-yet-naturalized
 * stations (the nursery's own sectionBodies, clonal-tea,
