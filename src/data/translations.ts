...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    "mushroom-hut": {
      name: "බිම්මල් කුටිය",
      description: "වතුයාය එහි තේ, කුළුබඩු, සහ පළතුරු බෝග අතරින්, විශේෂිත බිම්මල් කුටියක් පවත්වා ගෙන යයි — එය කුඩා, සෙවන සහිත ගොඩනැගිල්ලක් වන අතර, උයන්හි අනෙකුත් කොටස් වගා කරන සූර්යාලෝකය හා වායු සංචලනයට වඩා, බිම්මල් වර්ධනය වීමට අවශ්‍ය අඳුරු, සිසිල්, තෙත් තත්ත්වයන් පවත්වා ගැනීම සඳහා තැනිණි. මෙම කුටිය ඔයිස්ටර් බිම්මල් වර්ග කිහිපයක් වගා කිරීම සඳහා සකසා ඇත — ඇමරිකානු ඔයිස්ටර් (Pleurotus pulmonarius), භූතාන් ඔයිස්ටර්, කළු ඔයිස්ටර්, සහ රෝස ඔයිස්ටර් (Pleurotus djamor) — ඇබලෝන් බිම්මල් (Pleurotus cystidiosus) සමඟින්, සියල්ලම පසට වඩා පිදුරු හෝ මට්ටි කුඩු මාධ්‍යයක් මත වගා කරනු ලැබේ.",
      keyPoints: "මෙලෙස බිම්මල් වගා කිරීම ගොවිපලකට එහි ප්‍රධාන බෝගයෙන් ඔබ්බට විවිධාංගීකරණය වීමට අඩු වියදම්, තිරසාර ක්‍රමයකි, බොහෝ විට පිදුරු වැනි කෘෂිකාර්මික අපද්‍රව්‍ය වගා මාධ්‍යයක් ලෙස යොදාගනිමින්, එක් මාධ්‍ය කාණ්ඩයකින් සති කිහිපයක් තුළ අස්වනු කිහිපයක් ලබා ගනිමින්. වතුයායේම සංඥා පුවරු මගින් එක් එක් වර්ගයේ පෝෂණ අගය පෙන්වා දෙයි: ඇමරිකානු ඔයිස්ටර්, රෝස ඔයිස්ටර්, සහ ඇබලෝන් බිම්මල් යන සියල්ලම ප්‍රෝටීන්, විටමින්, සහ ප්‍රතිඔක්සිකාරක වලින් පොහොසත් බවත්, ප්‍රතිශක්තිකරණ පද්ධතියට, හෘද හා ආහාර ජීර්ණ සෞඛ්‍යයට උපකාරී වන අතර, දැවිල්ල අඩු කිරීමට හා කොලෙස්ටරෝල් පාලනයට දායක වන බවත් විස්තර කරයි.",
      duration: "මිනිත්තු 5",
    },
  },
  ta: {
    ...
    "mushroom-hut": {
      ...
      keyPoints: "இப்படி காளான்கள் வளர்ப்பது ஒரு பண்ணை தனது முதன்மை பயிரைத் தாண்டி பல்வகைப்படுத்த குறைந்த செலவில், நிலைத்தன்மையான வழியாகும், பெரும்பாலும் வைக்கோல் போன்ற விவசாய கழிவுகளை வளர்ப்பு ஊடகமாகப் பயன்படுத்துகிறது, ஒரே ஒரு தொகுதி ஊடகம் பல வாரங்களில் பல அறுவடைகளை தருகிறது. தோட்டத்தின் சொந்த அறிவிப்புப் பலகைகள் ஒவ்வொரு வகையின் ஊட்டச்சத்து அம்சத்தையும் எடுத்துக்காட்டுகின்றன: அமெரிக்கன் ஆய்ஸ்டர், பிங்க் ஆய்ஸ்டர், மற்றும் அபலோன் காளான்கள் ஒவ்வொன்றும் புரதம், வைட்டமின்கள், மற்றும் ஆன்டிஆக்ஸிடன்ட்களால் நிறைந்தவை என விவரிக்கப்படுகின்றன, நோய் எதிர்ப்பு சக்தி, இதயம் மற்றும் செரிமான ஆரோக்கியத்திற்கு உதவுதல், அழற்சியைக் குறைத்தல், மற்றும் கொலஸ்ட்ரால் அளவைக் குறைக்க உதவுதல் ஆகியவற்றை மையமாகக் கொண்டு.",
      duration: "5 நிமிடங்கள்",
    },
  },
  it: {
  ...
  ar: {
    ...
    "mushroom-hut": {
      name: "كوخ الفطر",
      description: "إلى جانب محاصيلها من الشاي والتوابل والفواكه، تحتفظ المزرعة بكوخ مخصص لزراعة الفطر — وهو مبنى صغير مظلل بُني للحفاظ على الظروف المظلمة والباردة والرطبة التي يحتاجها الفطر لينمو ثماره، بدلاً من أشعة الشمس وتدفق الهواء الذي تُزرع من أجله بقية الحدائق. أُعد الكوخ لزراعة عدة أصناف من فطر المحار — المحار الأمريكي (Pleurotus pulmonarius)، ومحار بوتان، والمحار الأسود، والمحار الوردي (Pleurotus djamor) — إلى جانب فطر الأذن البحرية (Pleurotus cystidiosus)، وتُزرع جميعها على وسط من القش أو نشارة الخشب بدلاً من التربة.",
      keyPoints: "تُعد زراعة الفطر بهذه الطريقة وسيلة منخفضة التكلفة ومستدامة للمزرعة لتنويع إنتاجها إلى جانب محصولها الرئيسي، وغالبًا ما تستخدم مخلفات زراعية مثل القش كوسط للزراعة، حيث تنتج دفعة واحدة من الوسط عدة حصادات على مدى عدة أسابيع. وتُبرز لافتات المزرعة الخاصة الجانب الغذائي لكل صنف: يُوصف كل من المحار الأمريكي والمحار الوردي وفطر الأذن البحرية بأنه غني بالبروتين والفيتامينات ومضادات الأكسدة، مع فوائد تتمحور حول دعم المناعة وصحة القلب والجهاز الهضمي، والحد من الالتهاب، والمساعدة في خفض الكوليسترول.",
      duration: "5 دقائق",
    },
  },
  ru: {
    ...
    "mushroom-hut": {
      name: "Грибной домик",
      description: "Наряду с чаем, специями и фруктами поместье содержит отдельный грибной домик — небольшое затенённое строение, построенное для поддержания тёмных, прохладных и влажных условий, необходимых грибам для плодоношения, в отличие от солнца и циркуляции воздуха, для которых выращивается остальная часть садов. В домике выращивают несколько сортов вёшенки — американскую вёшенку (Pleurotus pulmonarius), бутанскую, чёрную и розовую вёшенку (Pleurotus djamor), — а также гриб абалон (Pleurotus cystidiosus), и все они растут на субстрате из соломы или опилок, а не в почве.",
      keyPoints: "Выращивание грибов таким образом — недорогой и устойчивый способ для хозяйства диверсифицироваться за пределы основной культуры, часто с использованием сельскохозяйственных отходов, таких как солома, в качестве субстрата для выращивания, при этом одна партия субстрата даёт несколько урожаев в течение нескольких недель. На собственных табличках поместья отмечена питательная ценность каждого сорта: американская вёшенка, розовая вёшенка и гриб абалон описаны как богатые белком, витаминами и антиоксидантами, с пользой для иммунитета, здоровья сердца и пищеварения, снижения воспаления и уровня холестерина.",
      duration: "5 минут",
    },
  },
  de: {
    ...
    "mushroom-hut": {
      name: "Pilzhütte",
      description: "Neben Tee-, Gewürz- und Obstkulturen unterhält das Anwesen eine eigene Pilzhütte — ein kleines, schattiges Gebäude, das gebaut wurde, um die dunklen, kühlen, feuchten Bedingungen zu halten, die Pilze zum Fruchten brauchen, statt der Sonne und Luftzirkulation, für die der Rest der Gärten angebaut wird. Die Hütte ist darauf ausgelegt, mehrere Austernpilzsorten anzubauen — Amerikanischer Austernpilz (Pleurotus pulmonarius), Bhutan-Austernpilz, Schwarzer Austernpilz und Rosa Austernpilz (Pleurotus djamor) — zusammen mit dem Abalonepilz (Pleurotus cystidiosus), alle kultiviert auf einem Stroh- oder Sägemehlsubstrat statt in Erde.",
  ...
  es: {
    ...
    "mushroom-hut": {
      ...
      description: "Junto con sus cultivos de té, especias y frutas, la finca mantiene una cabaña dedicada a las setas — una pequeña estructura sombreada construida para mantener las condiciones oscuras, frescas y húmedas que las setas necesitan para fructificar, en lugar del sol y la circulación de aire para los que se cultiva el resto de los jardines. La cabaña está preparada para cultivar varias variedades de setas ostra — Ostra Americana (Pleurotus pulmonarius), Ostra de Bután, Ostra Negra y Ostra Rosa (Pleurotus djamor) — junto con la Seta Abalón (Pleurotus cystidiosus), todas cultivadas en un sustrato de paja o serrín en lugar de tierra.",
      keyPoints: "Cultivar setas de esta manera es una forma económica y sostenible de que una finca se diversifique más allá de su cultivo principal, a menudo usando residuos agrícolas como la paja como medio de cultivo, con un solo lote de sustrato que produce varias cosechas a lo largo de varias semanas. Los propios carteles de la finca destacan el valor nutricional de cada variedad: la Ostra Americana, la Ostra Rosa y la Seta Abalón se describen como ricas en proteínas, vitaminas y antioxidantes, con beneficios centrados en el apoyo inmunológico, la salud cardíaca y digestiva, la reducción de la inflamación y la disminución del colesterol.",
      duration: "5 minutos",
    },
  },
  fr: {
    ...
    "mushroom-hut": {
      ...
      description: "Aux côtés de ses cultures de thé, d'épices et de fruits, le domaine entretient une cabane dédiée aux champignons — une petite structure ombragée construite pour maintenir les conditions sombres, fraîches et humides dont les champignons ont besoin pour fructifier, plutôt que le soleil et la circulation d'air pour lesquels le reste des jardins est cultivé. La cabane est aménagée pour cultiver plusieurs variétés de pleurotes — le Pleurote Américain (Pleurotus pulmonarius), le Pleurote du Bhoutan, le Pleurote Noir et le Pleurote Rose (Pleurotus djamor) — ainsi que le Champignon Abalone (Pleurotus cystidiosus), tous cultivés sur un substrat de paille ou de sciure plutôt que dans la terre.",
      keyPoints: "Cultiver des champignons de cette manière est un moyen économique et durable pour une exploitation de se diversifier au-delà de sa culture principale, utilisant souvent des déchets agricoles comme la paille comme milieu de culture, un seul lot de substrat produisant plusieurs récoltes sur plusieurs semaines. La signalétique du domaine met en avant l'aspect nutritionnel de chaque variété : le Pleurote Américain, le Pleurote Rose et le Champignon Abalone sont chacun décrits comme riches en protéines, vitamines et antioxydants, avec des bienfaits axés sur le soutien immunitaire, la santé cardiaque et digestive, la réduction de l'inflammation et la baisse du cholestérol.",
      duration: "5 minutes",
    },
  },
  zh: {
    ...
    "mushroom-hut": {
      name: "蘑菇棚",
      description: "除了茶叶、香料和水果作物外，庄园还设有一间专用的蘑菇棚——这是一座小型遮荫建筑，专为维持蘑菇长菇所需的阴暗、凉爽、潮湿环境而建，而不像庄园其他地方那样为了日照和通风而种植。这间蘑菇棚专门种植多个平菇品种——美国平菇（Pleurotus pulmonarius）、不丹平菇、黑平菇和粉红平菇（Pleurotus djamor）——以及鲍鱼菇（Pleurotus cystidiosus），全部种植在稻草或木屑基质上，而非土壤中。",
      keyPoints: "以这种方式种植蘑菇，是农场在主要作物之外实现多元化经营的一种低成本、可持续方式，常利用稻草等农业废弃物作为栽培基质，一批基质可在数周内产出多次收成。庄园自己的标牌上标明了每个品种的营养特点：美国平菇、粉红平菇和鲍鱼菇均富含蛋白质、维生素和抗氧化剂，有助于增强免疫力、促进心脏和消化系统健康、减轻炎症并帮助降低胆固醇。",
      duration: "5分钟",
    },
  },
  ja: {
    ...
    "mushroom-hut": {
      name: "きのこ小屋",
      description: "茶、スパイス、果物の作物に加えて、農園にはきのこ専用の小屋があります——これは小さな日陰の建物で、庭の他の部分が日光と通気のために育てられているのとは異なり、きのこが実をつけるために必要な暗く涼しく湿った環境を保つために建てられています。この小屋では、アメリカンヒラタケ（Pleurotus pulmonarius）、ブータンヒラタケ、ブラックヒラタケ、ピンクヒラタケ（Pleurotus djamor）といった複数のヒラタケ品種に加えて、アワビタケ（Pleurotus cystidiosus）が栽培されており、いずれも土ではなく藁やおがくずを基質として育てられています。",
      keyPoints: "このようにきのこを育てることは、農園が主要作物以外に多角化するための低コストで持続可能な方法であり、藁のような農業廃棄物を栽培基質として利用することが多く、一つの基質のバッチから数週間かけて何度も収穫できます。農園自身の看板には、それぞれの品種の栄養面についての説明があります。アメリカンヒラタケ、ピンクヒラタケ、アワビタケはいずれもタンパク質、ビタミン、抗酸化物質が豊富とされ、免疫力のサポート、心臓や消化器系の健康、炎症の軽減、コレステロールの低下といった効果が挙げられています。",
      duration: "5分",
    },
  },
};
