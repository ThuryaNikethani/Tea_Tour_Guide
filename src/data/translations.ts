 ...
 * term preserved exactly, nothing added or removed. Remaining
 * not-yet-naturalized stations (mushroom-hut, polytunnel, the nursery's
 * own sectionBodies, clonal-tea, organic-cultivation, shade-management,
 * pruning, plucking, tea-factory, unique-fruits' fruit-gallery fields,
 * bee, turmeric, and the untouched remainder of cinnamon/ginger-turmeric/
 * coconut-field/jaggery-palm beyond their one already-rewritten "About
 * the X" paragraph) are still to be done in a future pass.
 */
...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "මෙම පාලක ඒකකය සෑම වගා බෑගයකටම යන බින්දු නල සපයයි — අවසාදිතය ඉවත් කිරීමට පෙරහනක්, පීඩන මාපකයක්, පයිප්ප කොටස් වෙන් කිරීම සඳහා වැසුම් කපාට, සහ වාරිමාර්ග ජලය ගමන් කරන අතරතුර ද්‍රව පොහොර කෙලින්ම එයට එකතු කරන වෙන්ටියුරි එන්නත්කරණයකින් යුත් පොහොර ටැංකි දෙකක් ඇතුළත් වේ — එමගින් සෑම ශාකයකටම එකවර ජලය හා පෝෂණය ලැබේ.",
        "යුගල වශයෙන් වැඩෙන දිගටි, තුඩ තියුණු, දිලිසෙන පත්‍ර සහිත මෙම පැළය මාලු මිරිස්, කැප්සිකම් (Capsicum annuum) වර්ගයකි — පොල් නාරටි පිරවූ වගා බෑගයක වගා කරන අතර, එහි මුල වෙත බින්දු නලයක් දැනටමත් සම්බන්ධ කර ඇත.",
        ...
        "නයි මිරිස් — 'නයි' යනු සිංහලෙන් කෝබ්‍රා යන අර්ථය දෙයි — එය Capsicum chinense විශේෂයට අයත් වන අතර, එය හබනේරෝ හා ස්කොච් බොනට් වැනි වර්ග හා සමීප ඤාතිත්වයක් ඇති, වතුයායේ අනෙකුත් මිරිස් වර්ගවලට වඩා සාමාන්‍යයෙන් තියුණු විශේෂයකි.",
        "මෙම පැළයේ වඩාත් වටකුරු, තරමක් ඉටි ස්වභාවයක් සහිත පත්‍ර අයත් වන්නේ ගෙඩි ගෝවාට ය — වචනාර්ථයෙන් 'බෝල ගෝවා' — හිස සාදන සාමාන්‍ය ගෝවා වර්ගය (Brassica oleracea var. capitata) වන අතර, එහි හිස හටගැනීමට බොහෝ කලකට පෙර මෙහි සිටුවනු ලැබේ.",
        "මෙම පැළයේ රතු-දම් පැහැති පත්‍ර අයත් වන්නේ අතු ගෝවාට ය — වචනාර්ථයෙන් 'අතු ගෝවා' — හිස නොසාදන, බෝල හැඩැති වර්ගයට වඩා ලිහිල් ගෝවා වර්ගයකි (Brassica oleracea var. acephala).",
        "මෙම පළල්, හෘද හැඩැති පත්‍ර අයත් වන්නේ බෝංචිටය, බෝංචි (Phaseolus vulgaris) — වර්ධනය වීමට පටන් ගත් පසු, අවට වැඩෙන එළවළු වලට වඩා බෙහෙවින් වෙනස් වැඩුම් රටාවක් ඇති පදික බෝගයකි.",
        "තවමත් බීජාවරණ පත්‍ර අවධියේ පවතින මෙම කුඩා පැළය රාබු, රාබු (Raphanus sativus) වේ — පොලිටනලයේ අස්වැන්නට වැඩිම වේගයෙන් එළඹෙන බෝගවලින් එකකි, දින 25-35ක් තරම් ඉක්මනින් නෙළා ගැනීමට හැකි වේ.",
        ...
        "ලීක්ස් (Allium ampeloprasum) තනි තුනී තලයක් ලෙස මතු වන අතර, පොලිටනලයේ අස්වැන්නට වඩාත්ම සෙමින් එළඹෙන බෝගවලින් එකකි — සිටුවීමේ සිට දින 90-120ක් තරම් කාලයක් ගත විය හැක.",
  ...
  ta: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "ஜோடி ஜோடியாக வளரும் நீளமான, கூர்மையான, மெருகூட்டப்பட்ட இலைகளைக் கொண்ட இந்த நாற்று மாலு மிரிஸ், ஒரு கேப்சிகம் (Capsicum annuum) வகையாகும் — தேங்காய் நார் நிரப்பப்பட்ட வளர்ப்பு பையில் வளர்க்கப்படுகிறது, அதன் வேர் பகுதிக்கு ஏற்கனவே ஒரு சொட்டு நீர்ப்பாசனக் குழாய் இணைக்கப்பட்டுள்ளது.",
        ...
        "நை மிரிஸ் — சிங்களத்தில் 'நாக மிளகாய்' என்று பொருள்படும் — இது Capsicum chinense இனத்தைச் சேர்ந்தது, தோட்டத்தின் மற்ற மிளகாய் வகைகளை விட வேறுபட்டதும் பொதுவாக காரமானதுமான ஒரு இனம், ஹபனேரோ மற்றும் ஸ்காட்ச் பொனட் போன்ற வகைகளுடன் நெருங்கிய தொடர்புடையது.",
        "இந்த நாற்றின் மேலும் வட்டமான, சற்று மெழுகு தன்மை கொண்ட இலைகள் கெடி கோவாவைச் சேர்ந்தவை — சொல் நேர் பொருளில் 'உருண்டை முட்டைக்கோஸ்' — தலை உருவாகும் பொதுவான முட்டைக்கோஸ் வகை (Brassica oleracea var. capitata), இதன் தலை உருவாகத் தொடங்குவதற்கு நீண்ட காலத்திற்கு முன்பே இங்கே நடப்பட்டுள்ளது.",
        "இந்த நாற்றின் சிவப்பு-ஊதா நிற இலைகள் அது கோவாவைச் சேர்ந்தவை — சொல் நேர் பொருளில் 'கிளை முட்டைக்கோஸ்' — உருண்டை தலை உருவாகும் வகையை விட தளர்வான, தலை உருவாகாத முட்டைக்கோஸ் வகை (Brassica oleracea var. acephala).",
        "இந்த அகன்ற, இதய வடிவ இலைகள் பொஞ்சியைச் சேர்ந்தவை, பீன்ஸ் (Phaseolus vulgaris) — வளரத் தொடங்கியதும், சுற்றி வளரும் காய்கறிகளிலிருந்து முற்றிலும் வேறுபட்ட ஏறும் தன்மை கொண்ட பயிர்.",
        "இன்னும் விதையிலை நிலையில் மட்டுமே உள்ள இந்த சிறிய நாற்று ராபு, முள்ளங்கி (Raphanus sativus) ஆகும் — பாலிடன்னலில் அறுவடைக்கு வேகமாக வரும் பயிர்களில் ஒன்று, வெறும் 25-35 நாட்களில் அறுவடை செய்யக்கூடியது.",
        ...
        "லீக்ஸ் (Allium ampeloprasum) ஒரு மெல்லிய இலையாக மட்டும் தோன்றும், பாலிடன்னலில் அறுவடைக்கு மிக மெதுவாக வரும் பயிர்களில் ஒன்று — நடவு செய்ததிலிருந்து 90-120 நாட்கள் வரை ஆகலாம்.",
  ...
  it: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "Questa testa di controllo alimenta le linee a goccia che arrivano a ogni sacco di coltivazione — un filtro per trattenere i sedimenti, un manometro, valvole di intercettazione per isolare le sezioni di tubo, e due serbatoi di fertilizzante dotati di un iniettore venturi che dosa il fertilizzante liquido direttamente nell'acqua di irrigazione mentre la attraversa, così ogni pianta viene irrigata e nutrita nello stesso passaggio.",
        "Con le sue foglie ovali lucide e appuntite disposte in coppie opposte, questa piantina è Malu Miris, un peperone (Capsicum annuum) — coltivato qui in un sacco di coltivazione riempito di fibra di cocco, con un tubicino a goccia già portato alla sua base.",
        ...
        "Nai Miris — in singalese 'peperoncino cobra' — è Capsicum chinense, una specie diversa e generalmente più piccante degli altri peperoncini della tenuta, imparentata con varietà come l'habanero e lo Scotch Bonnet.",
        "Le foglie più tonde e dall'aspetto leggermente ceroso di questa piantina appartengono a Gedi Gowa — letteralmente 'cavolo a palla' — il comune cavolo a testa (Brassica oleracea var. capitata), messo a dimora qui molto prima che inizi a formarsi la testa.",
        "Le foglie rosso-violacee di questa piantina appartengono ad Athu Gowa — letteralmente 'cavolo a ramo' — una varietà di cavolo più sciolta e priva di testa (Brassica oleracea var. acephala), anziché del tipo a palla.",
        "Queste foglie larghe, a forma di cuore, appartengono a Bonchi, fagiolini (Phaseolus vulgaris) — una coltura rampicante una volta avviata, con un portamento ben diverso dagli ortaggi bassi che la circondano.",
        "Questa piccola piantina, ancora allo stadio di cotiledone, è Raabu, ravanello (Raphanus sativus) — una delle colture più rapide del tunnel a raggiungere il raccolto, pronta in appena 25-35 giorni.",
        ...
        "I porri (Allium ampeloprasum) emergono come una singola lama sottile, tra le colture più lente del tunnel a raggiungere il raccolto — fino a 90-120 giorni dalla semina.",
  ...
  ar: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        "إلى جانب دفيئة قائمة بالفعل، تعمل المزرعة على بناء نفق بلاستيكي لزراعة مجموعة متنوعة من الخضروات الخاصة بها — منها فلفل السكوتش بونيت والفلفل الأخضر الحار، والفلفل الحلو، والخيار المخلل، والطماطم، والفلفل الرومي، والملفوف، والفجل، والفاصولياء الخضراء، والكراث، والبصل الأخضر، والجزر. وبمجرد اكتماله، سيتمكن ضيوف الفيلا أو الكابانا من قطف الخضروات المزروعة هنا بأنفسهم طازجة. يعمل الغطاء شبه الشفاف للنفق البلاستيكي بطريقة مشابهة لزجاج البيت الزجاجي، إذ يحتفظ بالدفء ويسمح بمرور الضوء، بينما يمنع دخول أمطار الرياح الموسمية الغزيرة والعديد من الآفات الشائعة — وهي ظروف تتيح للمزرعة زراعة خضروات لم تكن لتنجح بشكل موثوق في الحقل المفتوح، وتطيل موسم الزراعة إلى ما هو أبعد مما تسمح به الأحواض المكشوفة.",
        "يتبع كل محصول نظام ري خاصًا به، يتناوب بين الري بالتنقيط عند مستوى الجذور والرش العلوي حسب مرحلة النمو — إذ يساعد الرش بشكل أساسي على الإنبات المبكر والتبريد لمحاصيل مثل الجزر والفجل، بينما يصبح الري بالتنقيط هو الطريقة الرئيسية بمجرد بدء الإثمار في محاصيل مثل الطماطم. تخدم الطريقتان أغراضًا مختلفة: يحافظ الرش على رطوبة الهواء وسطح التربة بما يكفي لتثبيت البذور والشتلات الصغيرة، بينما يوصل الري بالتنقيط الماء مباشرة إلى منطقة الجذور بعد أن تكبر النباتات، مستخدمًا كمية أقل من المياه إجمالاً ومبقيًا الأوراق جافة لتقليل خطر الإصابة بالأمراض الفطرية.",
        ...
        "يغذي رأس التحكم هذا أنابيب التنقيط الواصلة إلى كل كيس زراعة — مرشح لإزالة الرواسب، ومقياس ضغط، وصمامات إغلاق لعزل أقسام الأنابيب، وخزانا سماد مزودان بحاقن فنتوري يضخ السماد السائل مباشرة في مياه الري أثناء مرورها، بحيث يحصل كل نبات على الماء والتغذية في المرور نفسه.",
        ...
        "هذه الشتلة هي أمو ميريس، نوع من الفلفل الحار (Capsicum annuum) — في هذه المرحلة المبكرة تكاد أوراقها لا تُميَّز عن أوراق الفلفل الرومي، إذ ينتمي كلاهما إلى النوع نفسه، ويُزرعان لاستخدامات مختلفة.",
        "ناي ميريس — وتعني بالسينهالية 'فلفل الكوبرا' — هو Capsicum chinense، نوع مختلف وأكثر حرارة عادة من أنواع الفلفل الأخرى في المزرعة، وهو قريب لأصناف مثل الهابانيرو والسكوتش بونيت.",
        "الأوراق الأكثر استدارة وذات المظهر الشمعي الخفيف في هذه الشتلة تعود إلى غيدي غوا — وتعني حرفيًا 'الملفوف الكروي' — وهو الملفوف الشائع المكوِّن للرأس (Brassica oleracea var. capitata)، يُزرع هنا قبل وقت طويل من بدء تكوّن رأسه.",
        "الأوراق ذات اللون الأحمر البنفسجي في هذه الشتلة تعود إلى أثو غوا — وتعني حرفيًا 'الملفوف المتفرع' — وهو صنف ملفوف أكثر انفتاحًا ولا يُكوّن رأسًا (Brassica oleracea var. acephala)، بخلاف النوع الكروي.",
        "هذه الأوراق العريضة على شكل قلب تعود إلى بونتشي، الفاصولياء الخضراء (Phaseolus vulgaris) — محصول متسلق بمجرد أن يبدأ نموه، بعادة نمو مختلفة تمامًا عن الخضروات المنخفضة المحيطة به.",
        "هذه الشتلة الصغيرة، التي لا تزال في مرحلة الفلقة، هي رابو، الفجل (Raphanus sativus) — أحد أسرع المحاصيل في النفق البلاستيكي وصولاً إلى الحصاد، إذ يكون جاهزًا للقطف في 25 إلى 35 يومًا فقط.",
        ...
        "يظهر الكراث (Allium ampeloprasum) على شكل شفرة رفيعة واحدة، وهو من أبطأ المحاصيل في النفق البلاستيكي وصولاً إلى الحصاد — إذ قد يستغرق من 90 إلى 120 يومًا من الزراعة.",
  ...
  ru: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "Этот блок управления подаёт воду в капельные линии, идущие к каждому мешку для выращивания, — фильтр для задержки осадка, манометр, запорные клапаны для отключения отдельных участков трубопровода и два бака с удобрением, оснащённые эжектором Вентури, который дозирует жидкое удобрение прямо в поливную воду по мере её прохождения, так что каждое растение получает воду и питание за один проход.",
        "С глянцевыми заострёнными овальными листьями, растущими супротивными парами, этот сеянец — Малу Мирис, сорт болгарского перца (Capsicum annuum), — выращивается здесь в мешке, заполненном кокосовым волокном, с капельной трубкой, уже подведённой к его основанию.",
        ...
        "Наи Мирис — на сингальском языке означает «кобра-перец» — это Capsicum chinense, отдельный и обычно более острый вид, чем другие перцы поместья, близкий к таким сортам, как хабанеро и Scotch Bonnet.",
        "Более округлые, слегка восковатые на вид листья этого сеянца принадлежат Геди Гова — буквально «шаровидная капуста» — обычной кочанной капусте (Brassica oleracea var. capitata), высаженной здесь задолго до того, как начнёт формироваться кочан.",
        "Красновато-фиолетовые листья этого сеянца принадлежат Атху Гова — буквально «ветвистая капуста» — более рыхлому, некочанному сорту капусты (Brassica oleracea var. acephala), в отличие от шаровидного типа.",
        "Эти широкие, сердцевидные листья принадлежат Бончи, стручковой фасоли (Phaseolus vulgaris) — вьющейся культуре, как только она начинает расти, с совсем иной формой роста по сравнению с низкорослыми овощами вокруг неё.",
        "Этот крошечный сеянец, всё ещё на стадии семядолей, — Раабу, редис (Raphanus sativus) — одна из самых быстрых культур в тоннеле, готовая к сбору всего за 25–35 дней.",
        ...
        "Лук-порей (Allium ampeloprasum) появляется в виде одного тонкого листа-стрелки и относится к самым медленным культурам тоннеля по времени созревания — до 90–120 дней с момента посадки.",
  ...
  de: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "Dieser Steuerkopf versorgt die Tropfleitungen, die zu jedem Anzuchtsack führen — ein Filter zum Zurückhalten von Sediment, ein Manometer, Absperrventile zum Isolieren einzelner Leitungsabschnitte und zwei Düngertanks mit einem Venturi-Injektor, der flüssigen Dünger direkt in das durchfließende Bewässerungswasser dosiert, sodass jede Pflanze in einem Arbeitsgang gegossen und gedüngt wird.",
        "Mit seinen glänzenden, spitz zulaufenden, gegenständig wachsenden ovalen Blättern ist dieser Sämling Malu Miris, eine Paprikasorte (Capsicum annuum) — angebaut hier in einem mit Kokosfaser gefüllten Anzuchtsack, mit einem Tropfschlauch, der bereits bis zu seiner Basis verlegt ist.",
        ...
        "Nai Miris — singhalesisch für 'Kobra-Chili' — ist Capsicum chinense, eine andere und in der Regel schärfere Art als die übrigen Paprika- und Chilisorten des Anwesens, verwandt mit Sorten wie Habanero und Scotch Bonnet.",
        "Die runderen, leicht wachsig wirkenden Blätter dieses Sämlings gehören zu Gedi Gowa — wörtlich 'Kugelkohl' — dem gewöhnlichen kopfbildenden Kohl (Brassica oleracea var. capitata), der hier lange gepflanzt wird, bevor sich überhaupt ein Kopf bildet.",
        "Die rötlich-violetten Blätter dieses Sämlings gehören zu Athu Gowa — wörtlich 'Astkohl' — einer lockereren, kopflosen Kohlsorte (Brassica oleracea var. acephala) statt der kugelförmigen Art.",
        "Diese breiten, herzförmigen Blätter gehören zu Bonchi, grünen Bohnen (Phaseolus vulgaris) — einer Kletterkultur, sobald sie erst einmal in Fahrt kommt, mit einem ganz anderen Wuchsverhalten als das niedrig wachsende Gemüse ringsum.",
        "Dieser winzige Sämling, noch im Keimblattstadium, ist Raabu, Radieschen (Raphanus sativus) — eine der schnellsten Kulturen im Folientunnel bis zur Ernte, bereits nach nur 25-35 Tagen erntereif.",
        ...
        "Lauch (Allium ampeloprasum) erscheint als einzelne dünne Klinge und zählt zu den langsamsten Kulturen im Folientunnel bis zur Ernte — bis zu 90-120 Tage ab der Pflanzung.",
  ...
  es: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "Este cabezal de control alimenta las líneas de goteo que llegan a cada bolsa de cultivo — un filtro para retener sedimentos, un manómetro, válvulas de cierre para aislar tramos de tubería, y dos tanques de fertilizante equipados con un inyector venturi que dosifica fertilizante líquido directamente en el agua de riego a su paso, de modo que cada planta recibe agua y nutrientes en el mismo momento.",
        "Con sus hojas ovaladas brillantes y puntiagudas que crecen en pares opuestos, esta plántula es Malu Miris, una variedad de pimiento (Capsicum annuum) — cultivada aquí en una bolsa de cultivo rellena de fibra de coco, con una línea de goteo ya instalada hasta su base.",
        ...
        "Nai Miris — en cingalés, 'chile cobra' — es Capsicum chinense, una especie distinta y generalmente más picante que los otros pimientos de la finca, emparentada con variedades como el habanero y el Scotch Bonnet.",
        "Las hojas más redondeadas y de aspecto ligeramente ceroso de esta plántula pertenecen a Gedi Gowa — literalmente 'repollo bola' — el repollo común que forma cabeza (Brassica oleracea var. capitata), plantado aquí mucho antes de que empiece a formarse su cabeza.",
        "Las hojas de tono rojo-violáceo de esta plántula pertenecen a Athu Gowa — literalmente 'repollo de rama' — una variedad de repollo más suelta y sin cabeza (Brassica oleracea var. acephala), a diferencia del tipo que forma bola.",
        "Estas hojas anchas en forma de corazón pertenecen a Bonchi, judías verdes (Phaseolus vulgaris) — un cultivo trepador una vez que arranca, con un hábito de crecimiento muy distinto al de las hortalizas bajas que la rodean.",
        "Esta pequeña plántula, todavía en fase de cotiledón, es Raabu, rábano (Raphanus sativus) — uno de los cultivos más rápidos del túnel en llegar a la cosecha, listo para recoger en apenas 25-35 días.",
        ...
        "El puerro (Allium ampeloprasum) emerge como una sola hoja fina, uno de los cultivos más lentos del túnel en llegar a la cosecha — hasta 90-120 días desde la siembra.",
  ...
  fr: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        ...
        "Cette tête de contrôle alimente les lignes goutte-à-goutte qui desservent chaque sac de culture — un filtre pour retenir les sédiments, un manomètre, des vannes d'arrêt pour isoler des sections de tuyauterie, et deux réservoirs d'engrais équipés d'un injecteur venturi qui dose l'engrais liquide directement dans l'eau d'irrigation à son passage, de sorte que chaque plante reçoit eau et nutriments en un seul passage.",
        "Avec ses feuilles ovales luisantes et pointues poussant en paires opposées, ce plant est Malu Miris, une variété de poivron (Capsicum annuum) — cultivé ici dans un sac de culture rempli de fibre de coco, avec un tuyau goutte-à-goutte déjà amené jusqu'à sa base.",
        ...
        "Nai Miris — en cingalais, 'piment cobra' — est Capsicum chinense, une espèce différente et généralement plus piquante que les autres piments du domaine, apparentée à des variétés comme l'habanero et le Scotch Bonnet.",
        "Les feuilles plus rondes, à l'aspect légèrement cireux, de ce plant appartiennent à Gedi Gowa — littéralement 'chou boule' — le chou pommé commun (Brassica oleracea var. capitata), mis en terre ici bien avant que sa pomme ne commence à se former.",
        "Les feuilles rouge-violacé de ce plant appartiennent à Athu Gowa — littéralement 'chou branchu' — une variété de chou plus lâche, sans pomme (Brassica oleracea var. acephala), contrairement au type pommé.",
        "Ces larges feuilles en forme de cœur appartiennent à Bonchi, des haricots verts (Phaseolus vulgaris) — une culture grimpante une fois lancée, avec un port de croissance bien différent des légumes bas qui l'entourent.",
        "Ce minuscule plant, encore au stade cotylédon, est Raabu, un radis (Raphanus sativus) — l'une des cultures les plus rapides du tunnel à atteindre la récolte, prête en à peine 25 à 35 jours.",
        ...
        "Le poireau (Allium ampeloprasum) émerge sous la forme d'une seule feuille fine, parmi les cultures les plus lentes du tunnel à atteindre la récolte — jusqu'à 90 à 120 jours après la plantation.",
  ...
  zh: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        "在现有温室之外，庄园正在搭建一座塑料大棚，用于种植自家的各种蔬菜——包括苏格兰帽椒和青辣椒、灯笼椒、小黄瓜、番茄、彩椒、卷心菜、萝卜、四季豆、韭葱、香葱以及胡萝卜等。建成后，入住别墅或小木屋的客人将能够亲手采摘这里新鲜种植的蔬菜。塑料大棚半透明的覆盖层的作用很像温室的玻璃——既能锁住温度、透进阳光，又能挡住强劲的季风雨水和许多常见害虫。正是这样的环境，让庄园得以种植那些在露天地里难以稳定生长的蔬菜，并比露天栽培延长了种植季节。",
        "每种作物都遵循自己的浇水方式，根据生长阶段在根部滴灌和上方喷雾之间交替进行——喷雾主要有助于胡萝卜、萝卜等作物的早期发芽和降温，而一旦番茄等作物开始结果，滴灌就会成为主要的浇水方式。这两种浇水方式各有用途：喷雾能让空气和土壤表面保持足够的湿度，帮助幼小的种子和秧苗扎根；而滴灌则在植株长大后将水直接送到根部，既能整体节约用水，又能让叶片保持干燥，从而降低真菌病害的风险。",
        ...
        "这株幼苗叶片呈光滑的尖椭圆形，成对生长，是马鲁米里斯，一种灯笼椒（辣椒属，Capsicum annuum）——种植在装满椰糠的种植袋中，根部已经接上了滴灌管。",
        "这株幼苗是阿姆米里斯，一种辣椒（Capsicum annuum）——在这个早期阶段，它的叶片与灯笼椒的叶片几乎无法区分，因为两者属于同一物种，只是种植用途不同。",
        "奈米里斯——僧伽罗语意为'眼镜蛇辣椒'——是Capsicum chinense，与庄园其他辣椒不同的一个物种，通常更为辛辣，与哈瓦那辣椒、苏格兰帽椒等品种关系密切。",
        "这株幼苗更圆、略带蜡质光泽的叶片属于格迪高瓦——字面意思是'球形卷心菜'——即常见的结球卷心菜（Brassica oleracea var. capitata），早在叶球开始形成之前很久就已经种下。",
        "这株幼苗红紫色的叶片属于阿图高瓦——字面意思是'分枝卷心菜'——一种更为松散、不结球的卷心菜品种（Brassica oleracea var. acephala），有别于结球型。",
        "这些宽大的心形叶片属于邦奇，即四季豆（Phaseolus vulgaris）——一旦开始生长便会攀爬，生长习性与周围低矮的蔬菜截然不同。",
        "这株仍处于子叶阶段的小幼苗是拉布，即萝卜（Raphanus sativus）——大棚里生长最快、最早能采收的作物之一，最快只需25至35天就能采收。",
  ...
  ja: {
    ...
    polytunnel: {
      ...
      sectionBodies: [
        "既存の温室に加えて、農園では自家製のさまざまな野菜を栽培するためのビニールハウスを建設中です——スコッチボネットや青唐辛子、ピーマン、ガーキン、トマト、パプリカ、キャベツ、ラディッシュ、さやいんげん、リーキ、青ネギ、ニンジンなどです。完成すれば、ヴィラやキャビンに宿泊するゲストは、ここで栽培された新鮮な野菜を自分の手で収穫できるようになります。ビニールハウスの半透明の覆いは温室のガラスとよく似た働きをし、暖かさを保ちながら光を通す一方で、激しいモンスーンの雨や一般的な害虫の多くを遮ります。こうした環境のおかげで、農園は露地では安定して育てられない野菜も栽培でき、屋外の畑よりも栽培期間を延ばすことができます。",
        "それぞれの作物は生育段階に応じて、根元への点滴灌漑と上からのミスト散布を切り替える独自の水やりスケジュールに従います——ミストは主にニンジンやラディッシュなどの作物の発芽初期と冷却に役立ち、トマトなどの作物では結実が始まると点滴灌漑が主な方法になります。この2つの方法にはそれぞれ異なる役割があります。ミスト散布は、若い種や苗が根付くのに十分な湿度を空気と土の表面に保ちます。一方、点滴灌漑は植物が大きくなった後、水を根の部分に直接届け、全体の使用水量を抑えるとともに葉を乾いた状態に保ち、カビによる病気のリスクを減らします。",
        ...
        "ナイ・ミリス——シンハラ語で「コブラ唐辛子」を意味する——はCapsicum chinenseで、農園の他の唐辛子とは異なる、一般的により辛味の強い種であり、ハバネロやスコッチボネットなどの品種と近縁です。",
