...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    "artisanal-tea-grades": {
      ...
      description: "සාමාන්‍ය කළු තේවලට අමතරව, වතුයාය දුර්ලභ, අතින් සකසන ලද අත්කම් තේ ද නිපදවයි — මේවා බොහෝ දුරට ප්‍රධාන කළු තේ නිෂ්පාදන මාර්ගයේ නොව, වෙනම 'අතින් සකසන තේ කර්මාන්තශාලාවේදී' අතින් නිම කරනු ලබයි; එබැවින්ම මෙම ශ්‍රේණි 'අත්කම් තේ ශ්‍රේණි' ලෙසද හඳුන්වනු ලබන්නේ — එය කර්මාන්ත නිෂ්පාදනයකට වඩා අත්කම් කලාවකට ආසන්නය. මේවායින් බොහොමයක් හටගන්නේ සුවිශේෂී දම් පැහැති අංකුරයකින් — TRI 2043, තේ පර්යේෂණ ආයතනයේ ක්ලෝනයකි — එහි වර්ණය ලැබෙන්නේ ඇන්තොසයනින් නිසාය. රන් තුඩුව (Golden Tip) සඳහා එම අංකුරයේම මුහුකුරා ගිය අංකුරය භාවිතා කරන අතර, රිදී තුඩුව (Silver Tip) සඳහා එම අංකුරයේම තවත් නොමුහුකුරා, ලා පැහැති අංකුරය භාවිතා කරයි. සුදු තේ (White Tea) අංකුරයෙන් කොළ දෙක හමාරක් ගෙන, මැලවීම සම්පූර්ණයෙන්ම මඟහැර — කළු තේ මෙන් පැසවා රෝල් කිරීම වෙනුවට වාෂ්ප කර වියලනු ලැබේ — එමගින් ඉතා සැහැල්ලුවෙන් සකසන ලද, ස්වාභාවිකව මිහිරි රසයක් ලැබේ. දම් තේ (Purple Tea) එකම නෙළීම භාවිතා කරයි, නමුත් සුදු තේට වෙනස්ව, සම්පූර්ණ කළු තේ ක්‍රියාවලියටම — මැලවීම, රෝල් කිරීම, සහ පැසවීම — ලක් වේ. රෝස තේ (Pink Tea) ආරම්භයේදී සුදු තේ මෙන්ම වර්ණ රහිතව පවතින අතර, දෙහි යුෂ බින්දු කිහිපයක් එකතු කළ පසුව පමණක් රෝස පැහැයට හැරේ — එම ඇඹුල් යුෂ, අංකුරයට එහි වර්ණය ලබා දෙන එම ඇන්තොසයනින් වර්ණකයේම වර්ණ වෙනසක් ඇති කරයි; බින්දු කිහිපයක් මී පැණි එකතු කිරීමද එයට හොඳින් ගැලපෙන අතර, අයිස් තේ ලෙස පිළිගැන්වීම නිර්දේශ කෙරේ. විටා ග්ලෝ (Vita Glow) වෙනුවට සාදනු ලබන්නේ දම් පැහැති අංකුරය නොව සාමාන්‍ය කොළ පැහැති අංකුරයේ අංකුරයෙනි. වතුයාය නෙළුම් මල් වැනි ද්‍රව්‍ය එකතු කර අගය එකතු කළ මිශ්‍රණ ද, එම අංකුරවලින්ම අතින් බැඳි බ්ලූමින් තේ (Blooming Tea) ද නිපදවයි.",
  ...
  zh: {
    ...
    "artisanal-tea-grades": {
      name: "手工精品茶",
      description: "除了标准红茶外，庄园还出产稀有的手工精品茶——这些茶大多在独立的手工制茶厂而非主要的红茶生产线上手工完成，因此这些等级也被称为「手工精品茶」：它更接近一门手艺，而非批量生产。其中许多都取自一种独特的紫色新梢——TRI 2043，茶叶研究所培育的一个克隆品种——其颜色来自花青素。金针取自该新梢完全成熟的芽头，银针则取自同一新梢颜色更浅、尚未成熟的芽头。白茶取新梢上的两叶半，完全跳过萎凋——经蒸制、烘干而成，不像红茶那样经过发酵和揉捻——因此口感极轻微加工、带有天然甜味。紫茶采摘方式相同，但与白茶不同，它要经过完整的红茶工序——萎凋、揉捻、发酵。粉茶起初几乎无色，与白茶相似，只有在加入几滴青柠汁后才会变成粉红色——柑橘类的酸汁会使新梢呈色的同一种花青素色素发生变色反应；粉茶也很适合加几滴蜂蜜，建议做成冰茶饮用。Vita Glow则不同，它取自普通绿色新梢的芽头，而非紫色新梢。庄园还会制作增值调配茶——例如加入莲花的茶——以及用同样的新梢手工扎制而成的开花茶（Blooming Tea）。",
  ...
  ja: {
    ...
    "artisanal-tea-grades": {
      name: "職人技の高級茶",
      description: "標準的な紅茶に加えて、この農園では希少な手作りの高級茶も生産しています——その多くは紅茶の主生産ラインではなく、別棟の手工茶工場で手作業により仕上げられます。これが「職人技の高級茶」とも呼ばれる理由で、大量生産というより工芸に近いものです。これらの多くは特徴的な紫がかった新芽——茶業研究所のクローン品種であるTRI 2043——から作られ、その色はアントシアニンによるものです。ゴールデンティップスにはその新芽の完全に成熟した芽を、シルバーティップスには同じ新芽のまだ未熟で色の薄い芽を使用します。白茶は新芽から葉2枚半を摘み取り、萎凋の工程を完全に省いて——紅茶のように発酵・揉捻するのではなく、蒸してから乾燥させることで——非常に軽く加工された自然な甘みのある味わいに仕上げます。パープルティーは同じ摘み方をしますが、白茶とは異なり、萎凋・揉捻・発酵という紅茶の全工程を経ます。ピンクティーは最初、白茶と同じようにほぼ無色で、ライムを数滴加えて初めてピンク色に変わります——この柑橘の酸が、新芽に色を与えているのと同じアントシアニン色素に変色反応を起こすのです。蜂蜜を数滴加えるのにも合い、アイスティーとして提供するのがお勧めです。一方ヴィータグローは、紫がかった新芽ではなく、通常の緑がかった新芽の芽から作られます。この農園では、蓮の花を使ったお茶などの付加価値ブレンドや、同じ新芽から手作業で結び上げるブルーミングティーも作られています。",
