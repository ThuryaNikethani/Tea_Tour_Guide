...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  ...
  zh: {
    ...
    "handmade-factory": {
      name: "手工制茶坊",
      description: "除了机械化生产，部分茶叶从头到尾完全以手工方式加工。庄园的大多数手工精品茶——金针、银针、白茶、紫茶、粉茶、Vita Glow（用绿色新梢的芽头制成，不同于金针银针所用的紫色新梢）、手工扎制的开花茶，以及莲花茶等加花调配茶——都是在这里而非主红茶厂完成的。这里的萎凋以自然方式进行，在一个用湿度计监测的小型萎凋槽中完成，而不是像主厂那样使用强制送风的风扇，将湿度降至约50%后再揉捻。之后茶叶会在托盘上手工揉捻，凭手感而非计时来判断是否到位；遇到大批量订单时，小型机械揉捻机会代替手工揉捻发挥同样作用，因为仅靠手工无法跟上产量需求。本站介绍手工茶与流水线生产茶的区别。",
      keyPoints: "手工揉捻与手工加工产量较小，叶片间差异更大，因其独特风味而备受珍视。手工茶大致分为两大类——经过发酵、类似红茶的品种（可通过其黑色辨认），以及像白茶、紫茶这样完全不经发酵、直接进入干燥工序的品种。这里制作最费工的产品是一种手工卷制的红茶「环」，每个约用两根新梢——一人每天只能手工卷制约25克，因此价格昂贵，多被富裕的茶叶爱好者当作纪念品购买，而非用于日常饮用。",
      duration: "10分钟",
    },
    "tea-center": {
      name: "茶叶中心",
  ...
  ja: {
    ...
    "handmade-factory": {
      name: "手作り紅茶工房",
      description: "機械化された生産と並行して、一部の茶はすべての工程が機械を使わず完全に手作業で加工されます。農園の職人技高級茶のほとんど——ゴールデンティップス、シルバーティップス、白茶、パープルティー、ピンクティー、ヴィータグロー（ゴールデンティップスやシルバーティップスに使う紫がかった新芽とは異なり、緑がかった新芽の芽から作られます）、手作業で結ぶブルーミングティー、蓮茶のような花を使ったブレンド——は、紅茶の主工場ではなくここで仕上げられます。ここでの萎凋は、主工場の強制送風ファンではなく、湿度計で管理された小さな萎凋槽で自然に行われ、揉捻の前に水分を約50％まで下げます。その後、茶葉はトレイの上で手作業により、時間ではなく感触で判断しながら揉まれます。大口注文の場合は、手揉みだけでは量に追いつかないため、小型の機械式ローラーが同じ役割を代わりに果たします。このストップでは、手作りの茶が工場ラインでの生産とどう違うかを紹介します。",
      keyPoints: "手揉みと手作業による加工は、少量生産で葉ごとの個性が出やすく、その独特な風味がしばしば珍重されます。手作りの茶は大きく二つに分けられます——紅茶のように発酵させたもの（黒い色で見分けられます）と、白茶やパープルティーのように発酵を完全に省いて直接乾燥工程に進むものです。ここで作られる中で最も手間のかかる品は、新芽約2本を使って手で巻き上げる紅茶の「リング」で、一人が一日に手で巻けるのはわずか約25グラムほどです。そのため非常に高価で、日常的に飲まれるというより、裕福な紅茶愛好家によってお土産として購入されることがほとんどです。",
      duration: "10分",
    },
    "tea-center": {
      name: "ティーセンター",
