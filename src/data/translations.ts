...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  ...
  ar: {
    ...
    "artisanal-tea-grades": {
      ...
      description: "بالإضافة إلى الشاي الأسود القياسي، تنتج المزرعة أيضًا أنواعًا نادرة من الشاي الحرفي المصنوع يدويًا — يُصنَّع معظمها يدويًا في مصنع الشاي اليدوي المنفصل بدلاً من خط الشاي الأسود الرئيسي، ولهذا تُسمى هذه الدرجات أيضًا 'درجات الشاي الحرفي': فهي أقرب إلى حرفة يدوية منها إلى إنتاج جماعي. يأتي الكثير منها من برعم مميز بلون أرجواني — TRI 2043، وهو صنف مستنسخ من معهد أبحاث الشاي — يكتسب لونه من مادة الأنثوسيانين؛ وهو صنف منخفض الإنتاجية، ولهذا لا تزرعه كل مزرعة سريلانكية. يُستخدم لصنع القمة الذهبية البرعم الناضج تمامًا من ذلك النبات نفسه، بينما يُستخدم لصنع القمة الفضية البرعم الأفتح لونًا وغير الناضج بعد من النبات نفسه. يُؤخذ للشاي الأبيض ورقتان ونصف من البرعم مع تخطي مرحلة الذبول تمامًا — إذ تُبخَّر وتُجفَّف بدلاً من التخمير واللف كما في الشاي الأسود — لتُنتج مذاقًا معالجًا بخفة شديدة وحلوًا بشكل طبيعي، بلون فاتح ونسيج مخملي ونكهة زهرية. يستخدم الشاي الأرجواني القطفة نفسها، لكنه خلافًا للشاي الأبيض يمر بعملية الشاي الأسود الكاملة — الذبول واللف والتخمير — لينتج مذاقًا أقرب إلى الأولونغ: أخف من الشاي الأسود لكن أقل نكهة نباتية من الشاي الأخضر، ومنخفض الكافيين نسبيًا، وغني طبيعيًا بمضادات الأكسدة. أما الشاي الوردي فيبدأ عديم اللون تقريبًا مثل الشاي الأبيض تمامًا، ولا يتحول إلى اللون الوردي إلا بعد إضافة بضع قطرات من عصير الليمون الحامض — إذ يُحدِث الحمض تغيّرًا لونيًا في نفس صبغة الأنثوسيانين التي تمنح البرعم لونه؛ كما يتقبل جيدًا إضافة بضع قطرات من العسل، ويُنصح بتقديمه كشاي مثلج. أما فيتا جلو فيُصنع من برعم النبتة ذات اللون الأخضر العادي بدلاً من الأرجواني. كما تُعِدّ المزرعة مزيجات ذات قيمة مضافة — مثل الشاي المنقوع بزهور اللوتس — وشاي Blooming Tea المربوط يدويًا من نفس البراعم.",
  ...
  ru: {
    ...
    "tea-center": {
      name: "Чайный центр",
      description: "Экскурсия завершается в чайном центре, где дегустационная комиссия проверяет каждую партию — не только здесь, но и раньше, всякий раз, когда чай уходит с главной фабрики на местный рынок или поступает на упаковку, — на дефекты вроде переферментации, недоферментации или подгорания, отбраковывая всё, что не проходит проверку, прежде чем оно попадёт в продажу. Здесь же выставлены ещё два мелкосерийных фирменных продукта Фабрики ручного чая — Flower Chakra и Tea Coin. Такой ремесленный чай можно заваривать повторно до трёх раз, используя воду с температурой около 80°C, а не кипяток, — примерно по 2, 5 и 8 минут на заварку, каждый раз со свежей горячей водой, — в отличие от стандартного чёрного чая, который заваривают один раз крутым кипятком.",
  ...
  fr: {
    ...
    "artisanal-tea-grades": {
      ...
      description: "Outre le thé noir standard, le domaine produit également de rares thés artisanaux façonnés à la main — la plupart finis à la main à la Manufacture de Thé Artisanal, distincte de la ligne principale de thé noir, ce qui explique pourquoi ces qualités sont aussi appelées « Thés Artisanaux d'Exception » : c'est plus proche de l'artisanat que de la production de masse. Beaucoup d'entre eux proviennent d'une pousse à la teinte violette caractéristique — TRI 2043, un clone du Tea Research Institute —, dont la couleur vient de l'anthocyane ; c'est un cultivar à faible rendement, ce qui explique pourquoi tous les domaines sri-lankais ne le cultivent pas. Le Golden Tip utilise le bourgeon pleinement mûri de cette même pousse, tandis que le Silver Tip utilise le bourgeon plus pâle, encore immature, de la même pousse. Le thé blanc prend deux feuilles et demie de la pousse et évite entièrement le flétrissage — cuites à la vapeur puis séchées plutôt que fermentées et roulées comme le thé noir — pour une saveur très légèrement transformée et naturellement sucrée, avec une liqueur pâle, une texture veloutée et un arôme floral. Le thé violet utilise la même cueillette mais, contrairement au thé blanc, suit le procédé complet du thé noir — flétrissage, roulage et fermentation — pour une saveur proche de l'oolong : plus légère que le thé noir mais moins végétale que le thé vert, relativement faible en caféine et naturellement riche en antioxydants. Le thé rose est au départ pratiquement incolore, tout comme le thé blanc, et ne devient rose qu'après l'ajout de quelques gouttes de citron vert — l'agrume déclenche un changement de couleur dans le même pigment d'anthocyane qui donne sa teinte à la pousse ; il se marie aussi bien avec quelques gouttes de miel et il est recommandé de le servir en thé glacé. Le Vita Glow est quant à lui élaboré à partir du bourgeon de la pousse verte ordinaire plutôt que violette. Le domaine élabore aussi des mélanges à valeur ajoutée — comme un thé infusé aux fleurs de lotus — ainsi qu'un Blooming Tea noué à la main à partir des mêmes pousses.",
  ...
  zh: {
    ...
    "artisanal-tea-grades": {
      name: "手工精品茶",
      description: "除了标准红茶外，庄园还出产稀有的手工精品茶——这些茶大多在独立的手工制茶厂而非主要的红茶生产线上手工完成，因此这些等级也被称为「手工精品茶」：它更接近一门手艺，而非批量生产。其中许多都取自一种独特的紫色新梢——TRI 2043，茶叶研究所培育的一个克隆品种——其颜色来自花青素；这是一个低产品种，因此并非每个斯里兰卡庄园都种植它。金针取自该新梢完全成熟的芽头，银针则取自同一新梢颜色更浅、尚未成熟的芽头。白茶取新梢上的两叶半，完全跳过萎凋——经蒸制、烘干而成，不像红茶那样经过发酵和揉捻——因此口感极轻微加工、带有天然甜味，茶汤色浅、口感丝滑，并带有花香。紫茶采摘方式相同，但与白茶不同，它要经过完整的红茶工序——萎凋、揉捻、发酵——风味更接近乌龙茶：比红茶清淡，但比绿茶少些青草味，咖啡因含量相对较低，且天然富含抗氧化物质。粉茶起初几乎无色，与白茶相似，只有在加入几滴青柠汁后才会变成粉红色——柑橘类的酸汁会使新梢呈色的同一种花青素色素发生变色反应；粉茶也很适合加几滴蜂蜜，建议做成冰茶饮用。Vita Glow则不同，它取自普通绿色新梢的芽头，而非紫色新梢。庄园还会制作增值调配茶——例如加入莲花的茶——以及用同样的新梢手工扎制而成的开花茶（Blooming Tea）。",
    ...
    "tea-center": {
      name: "茶叶中心",
      description: "行程的最后一站是茶叶中心，这里有一支品鉴小组会检验每一批茶叶——不仅在这里，此前每当茶叶从主厂运往本地市场或送来包装时也会检验——查找过度发酵、发酵不足或烘焦等瑕疵，凡不合格者都会在出售前被剔除。手工制茶坊出品的另外两款小批量特色茶——「Flower Chakra」与「Tea Coin」——也陈列在这里展示。这类手工茶不像标准红茶那样只用沸水冲泡一次，而是可以用约80°C的热水（而非沸水）反复冲泡最多三次——每次用新鲜热水，约分别冲泡2分钟、5分钟和8分钟。",
  ...
  ja: {
    ...
    "artisanal-tea-grades": {
      name: "職人技の高級茶",
      description: "標準的な紅茶に加えて、この農園では希少な手作りの高級茶も生産しています——その多くは紅茶の主生産ラインではなく、別棟の手工茶工場で手作業により仕上げられます。これが「職人技の高級茶」とも呼ばれる理由で、大量生産というより工芸に近いものです。これらの多くは特徴的な紫がかった新芽——茶業研究所のクローン品種であるTRI 2043——から作られ、その色はアントシアニンによるものです。この品種は収量が少なく、そのためスリランカのすべての農園がこれを栽培しているわけではありません。ゴールデンティップスにはその新芽の完全に成熟した芽を、シルバーティップスには同じ新芽のまだ未熟で色の薄い芽を使用します。白茶は新芽から葉2枚半を摘み取り、萎凋の工程を完全に省いて——紅茶のように発酵・揉捻するのではなく、蒸してから乾燥させることで——非常に軽く加工された自然な甘みのある味わいに仕上げます。水色は淡く、口当たりはビロードのようになめらかで、花のような香りがあります。パープルティーは同じ摘み方をしますが、白茶とは異なり、萎凋・揉捻・発酵という紅茶の全工程を経て、ウーロン茶に近い風味に仕上がります——紅茶より軽く、緑茶ほど青くささがなく、カフェインは比較的少なく、天然の抗酸化物質を豊富に含みます。ピンクティーは最初、白茶と同じようにほぼ無色で、ライムを数滴加えて初めてピンク色に変わります——この柑橘の酸が、新芽に色を与えているのと同じアントシアニン色素に変色反応を起こすのです。蜂蜜を数滴加えるのにも合い、アイスティーとして提供するのがお勧めです。一方ヴィータグローは、紫がかった新芽ではなく、通常の緑がかった新芽の芽から作られます。この農園では、蓮の花を使ったお茶などの付加価値ブレンドや、同じ新芽から手作業で結び上げるブルーミングティーも作られています。",
    ...
    "tea-center": {
      name: "ティーセンター",
      description: "ツアーの最後はティーセンターです。ここでは試飲チームがすべてのロットを検査します——ここだけでなく、茶が主工場から地元市場に向かう時や梱包のために届いた時にも同様に——過発酵、発酵不足、焦げなどの欠陥がないかを確認し、基準に満たないものは販売前にすべて取り除かれます。ここには手工茶工場のもう2つの少量生産の特選品、「Flower Chakra」と「Tea Coin」が展示されています。こうした職人技の茶は、沸騰したお湯で一度だけ淹れる標準的な紅茶とは異なり、沸騰させずに約80℃に温めたお湯を使って最大3回まで再抽出することができます——毎回新しいお湯を使い、それぞれ約2分、5分、8分ほど抽出します。",
