...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  ...
  es: {
    ...
    "handmade-factory": {
      ...
      sectionHeadings: ["Fábrica de Té Artesanal"],
      sectionBodies: ["Además de la producción mecanizada, parte del té se procesa por completo a mano en cada etapa, sin máquinas. La mayoría de los grados especiales artesanales de la finca — Golden Tip, Silver Tip, White Tea, Purple Tea, Pink Tea, Vita Glow, el Blooming Tea atado a mano y mezclas infusionadas con flores como el té de loto — se terminan aquí en lugar de en la fábrica principal de té negro. (El Vita Glow se hace con el brote del arbusto verde, a diferencia del brote púrpura del Golden y Silver Tip.) Aquí el marchitado ocurre de forma natural, en una pequeña artesa controlada con un higrómetro, sin los ventiladores de aire forzado de la fábrica principal, reduciendo la humedad a alrededor del 50% antes de enrollar. Luego la hoja se enrolla a mano sobre una bandeja, juzgando al tacto más que por el reloj. Para pedidos al por mayor más grandes, pequeños rodillos mecánicos cumplen la misma función, ya que el enrollado manual por sí solo no puede seguir el ritmo del volumen. Una máquina dedicada al té verde — que cuece al vapor y prensa la hoja — se encarga de ese grado por separado, aunque actualmente está fuera de servicio por una reparación menor. Tras el vapor, la hoja reposa afuera para perder la humedad superficial, luego se enrolla a mano para resaltar su color, fuerza, aroma y sabor, antes de un último paso por el secador — el tiempo de secado varía de un pequeño productor a otro. El pequeño horno del edificio también sirve como panadería para bocadillos a base de té, como galletas. El secado, que se hace justo después de enrollar, se realiza aquí en dos secadores independientes — uno tradicional a leña, otro eléctrico — cada uno con capacidad para 34 bandejas, y ambos también se usan para otros productos de lotes pequeños, como cardamomo, clavo de olor y jengibre. Esta parada explica qué distingue al té hecho a mano de la producción en línea de fábrica. El enrollado y el procesamiento manuales producen lotes más pequeños con más variación entre hojas, a menudo apreciados por su carácter distintivo. Los tés hechos a mano se dividen en dos categorías amplias: los fermentados, al estilo del té negro (identificables por su color negro), que incluyen al té púrpura pese a su inusual brote de origen; y los no fermentados como el White Tea, que se saltan la fermentación por completo y van directo al secado. Los artículos que más trabajo requieren aquí son dos especialidades de lote pequeño: el Flower Chakra, un anillo de té negro enrollado a mano que usa unos dos brotes cada uno, y el Tea Coin. Una sola persona puede enrollar a mano solo unos 25 gramos de cualquiera de los dos al día, por lo que son tan caros, y se compran sobre todo como recuerdo por parte de entusiastas del té adinerados, más que para el consumo diario. La mayor parte de la producción hecha a mano, incluido el té púrpura, se elabora por encargo en lotes pequeños en lugar de producirse continuamente en grandes cantidades."],
      duration: "10 minutos",
    },
    "tea-center": {
      name: "Centro del Té",
  ...
  zh: {
    ...
    "handmade-factory": {
      ...
      sectionHeadings: ["手工制茶坊"],
      sectionBodies: ["除了机械化生产之外，部分茶叶在每个环节都完全依靠人工处理，不使用机器。庄园大多数手工特色茶品——金毫、银毫、白茶、紫茶、粉茶、多元活力茶、手工绑扎的绽放茶，以及莲花茶等花香混合茶——都是在这里而非主要红茶厂完成的。（多元活力茶取自绿色嫩芽的芽头，与金毫、银毫所用的紫色嫩芽不同。）这里的萎凋是自然进行的，在一个小槽中用湿度计监测，不使用主厂那种强制通风的风扇，在揉捻前把水分降到约50%。之后茶叶在托盘上手工揉捻，凭手感判断，而不是靠时钟。对于较大的批量订单，会由小型机械揉捻机来完成同样的工作，因为单靠手工揉捻跟不上产量需求。一台专用的绿茶机——负责蒸青和压制茶叶——单独处理这个品类，不过目前因小故障暂停使用。蒸青之后，茶叶被放在室外散去表面水分，再经拉伸手工揉捻以激发其色泽、力度、香气和滋味，最后送入烘干机完成最后一道工序——烘干时间因小生产者而异。这座建筑里的小烤炉还兼作烘焙房，用来制作以茶为原料的小吃，比如饼干。揉捻后立即进行的烘干，在这里由两台独立的烘干机完成——一台传统柴火烘干机，一台电力烘干机——每台可容纳34个托盘，两台也都用于豆蔻、丁香、生姜等其他小批量产品。这一站介绍了手工茶与流水线生产茶的区别所在。手工揉捻和手工处理产出的批次更小，叶片之间差异更大，也因这种独特个性而常受青睐。手工茶大致分为两大类：一类是像红茶一样经过发酵的（可通过其黑色辨认），紫茶尽管原料嫩芽特殊，也属于这一类；另一类是不发酵的，例如白茶，完全跳过发酵直接进入烘干。这里制作最费工的两款产品是小批量特色茶——花朵茶轮（Flower Chakra），一种手工卷制的红茶环，每个约用两根嫩芽制成，以及茶币（Tea Coin）。一个人一天只能手工卷制约25克其中一种，这也是它们如此昂贵的原因，它们大多被富裕的茶叶爱好者当作纪念品购买，而非日常饮用。包括紫茶在内，大部分手工产品都是按订单小批量制作，而非持续大批量生产。"],
      duration: "10分钟",
    },
    "tea-center": {
      name: "茶叶中心",
