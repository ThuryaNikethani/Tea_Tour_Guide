 ...
 * appositive dash chains, all 10 languages) and "shade-management" (its
 * single sectionBody, all 10 languages). Remaining not-yet-naturalized
 * stations (organic-cultivation, pruning, plucking, tea-factory,
