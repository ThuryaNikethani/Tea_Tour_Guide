...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  ...
  zh: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "除了机械化生产之外，部分茶叶在每个环节都完全依靠人工处理，不使用机器。庄园大多数手工特色茶品——金毫、银毫、白茶、紫茶、粉茶、多元活力茶、手工绑扎的绽放茶，以及莲花茶等花香混合茶——都是在这里而非主要红茶厂完成的。（多元活力茶取自绿色嫩芽的芽头，与金毫、银毫所用的紫色嫩芽不同。）",
  ...
  ja: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "機械化された生産に加えて、一部の茶はすべての工程を機械を使わず完全に手作業で加工します。農園の職人技による特選等級の多くは——ゴールデンティップス、シルバーティップス、ホワイトティー、パープルティー、ピンクティー、ビタグロウ、手で結んだブルーミングティー、そして蓮茶のような花をブレンドした茶——主力の紅茶工場ではなく、ここで仕上げられます。（ビタグロウは、ゴールデンティップスやシルバーティップスの紫色の新芽とは異なり、緑色の新芽の芽から作られます。）",
