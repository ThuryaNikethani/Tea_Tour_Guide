...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["පොලිටනලය හා හරිතාගාරය පිළිබඳ", "ජලය දීම හා වාරිමාර්ගය", "අස්වනු නෙළීමේ කාලසටහන", "ගර්කින් පැළ", "රාබු පැළය", "ගෝවා පැළය", "මිරිස් පැළ", "තක්කාලි පැළය"],
      sectionBodies: [
        ...
        "තවම පත්‍ර එකක් හෝ දෙකක් පමණක් ඇති මෙම පැළ දෙක ගර්කින් වේ — පිපිඤ්ඤා පවුලට පොදු වූ හෘද හැඩැති සැබෑ පත්‍ර මගින් හඳුනාගත හැකිය. මේවා පොල් නාරටි පිරවූ වගා බෑග් තුළ වගා කරන අතර, එක් එක් පැළයේ මුල වෙත බින්දු නලයක් දැනටමත් සම්බන්ධ කර ඇත.",
        "මෙම පැළයේ රෝස පැහැ ගැන්වුණු කඳ හා පත්‍ර රාබුවේ ලක්ෂණයකි — පොලිටනලයේ අස්වැන්නට වැඩිම වේගයෙන් එළඹෙන බෝගවලින් එකකි, දින 25-35ක් තරම් ඉක්මනින් නෙළා ගැනීමට හැකි වේ.",
        "වඩාත් වටකුරු, තරමක් ඉටි ස්වභාවයක් සහිත පත්‍ර සහ (රෝස පැහැයට වඩා) කොළ පැහැති කඳක් සහිත මෙම පැළය ගෝවා වේ — රාබුවට වඩා බෙහෙවින් සෙමින් වැඩෙන බෝගයක් වන අතර, එහි හිස හටගැනීමට බොහෝ කලකට පෙර මෙහි සිටුවනු ලැබේ.",
        "යුගල වශයෙන් වැඩෙන දිගටි, තුඩ තියුණු, දිලිසෙන පත්‍ර සහිත මෙම තරුණ පැළ මිරිස් හෝ බෙල් පෙපර් වේ. පොලිටනලය ස්කොච් බොනට්, කොළ මිරිස්, කැප්සිකම්, සහ බෙල් පෙපර් ඇතුළු මිරිස් වර්ග කිහිපයක්ම එකට වගා කරන අතර, මෙම මුල් පැළ අවධියේදී ඒවා එකිනෙකට පාහේ සමානව පෙනේ.",
  ...
  ta: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["பாலிடன்னல் மற்றும் பசுமை இல்லம் பற்றி", "நீர்ப்பாசனமும் நீர் மேலாண்மையும்", "அறுவடை காலவரிசை", "வெள்ளரி (கெர்கின்) நாற்றுகள்", "முள்ளங்கி நாற்று", "முட்டைக்கோஸ் நாற்று", "மிளகாய் நாற்றுகள்", "தக்காளி நாற்று"],
      sectionBodies: [
        ...
        "இன்னும் ஒன்று அல்லது இரண்டு இலைகளே கொண்ட இந்த இரண்டு நாற்றுகளும் கெர்கின் ஆகும் — வெள்ளரி குடும்பத்திற்கு பொதுவான இதய வடிவ உண்மையான இலைகளால் இவற்றை அடையாளம் காணலாம். இவை தேங்காய் நார் நிரப்பப்பட்ட வளர்ப்பு பைகளில் வளர்க்கப்படுகின்றன, ஒவ்வொரு செடியின் வேர் பகுதிக்கும் ஏற்கனவே ஒரு சொட்டு நீர்ப்பாசனக் குழாய் இணைக்கப்பட்டுள்ளது.",
        "இந்த நாற்றின் இளஞ்சிவப்பு தொனி கொண்ட தண்டும் இலைகளும் முள்ளங்கியின் சிறப்பியல்பு — பாலிடன்னலில் அறுவடைக்கு வேகமாக வரும் பயிர்களில் ஒன்று, வெறும் 25-35 நாட்களில் அறுவடை செய்யக்கூடியது.",
        "மேலும் வட்டமான, சற்று மெழுகு தன்மை கொண்ட இலைகளும் (இளஞ்சிவப்புக்குப் பதிலாக) பச்சை தண்டும் கொண்ட இந்த நாற்று முட்டைக்கோஸ் ஆகும் — முள்ளங்கியை விட மிகவும் மெதுவாக வளரும் பயிர், அதன் தலை உருவாகத் தொடங்குவதற்கு நீண்ட காலத்திற்கு முன்பே இங்கே நடப்பட்டுள்ளது.",
        "ஜோடி ஜோடியாக வளரும் நீளமான, கூர்மையான, மெருகூட்டப்பட்ட இலைகளைக் கொண்ட இந்த இளம் செடிகள் மிளகாய் அல்லது மணி மிளகாய் ஆகும். பாலிடன்னல் ஸ்காட்ச் பொனட், பச்சை மிளகாய், கேப்சிகம், மற்றும் மணி மிளகாய் உள்ளிட்ட பல மிளகாய் வகைகளை பக்கத்துக்குப் பக்கம் வளர்க்கிறது — இந்த ஆரம்ப நாற்று நிலையில் இவை ஏறத்தாழ ஒரே மாதிரியாகவே தெரிகின்றன.",
  ...
  it: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["Informazioni sulla Serra e sul Tunnel di Coltivazione", "Irrigazione", "Tempi di Raccolta", "Piantine di Cetriolino", "Piantina di Ravanello", "Piantina di Cavolo", "Piantine di Peperoncino", "Piantina di Pomodoro"],
      sectionBodies: [
        ...
        "Queste due piantine, ancora a una o due foglie, sono cetriolini — riconoscibili dalle foglie vere a forma di cuore tipiche della famiglia del cetriolo, che crescono qui in sacchi di coltivazione riempiti di fibra di cocco, con un tubicino a goccia già portato alla base di ciascuna pianta.",
        "Il gambo e le foglie dalle sfumature rosate di questa piantina sono caratteristici del ravanello — una delle colture più rapide del tunnel a raggiungere il raccolto, pronta in appena 25-35 giorni.",
        "Con foglie più tonde, dall'aspetto leggermente cereo, e uno stelo verde (anziché rosato), questa piantina è cavolo — una coltura molto più lenta del ravanello, messa a dimora qui molto prima che inizi a formarsi la testa.",
        "Queste giovani piante, con le foglie ovali lucide e appuntite disposte in coppie opposte, sono peperoncini o peperoni. Il tunnel coltiva fianco a fianco diverse varietà di peperoncino — tra cui Scotch Bonnet, peperoncino verde, peperone e peperone dolce — praticamente indistinguibili tra loro in questa fase iniziale di piantina.",
  ...
  ar: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["عن النفق البلاستيكي والبيت الزجاجي", "الري وإدارة المياه", "توقيت الحصاد", "شتلات الخيار المخلل", "شتلة الفجل", "شتلة الملفوف", "شتلات الفلفل الحار", "شتلة الطماطم"],
      sectionBodies: [
        ...
        "هاتان الشتلتان، اللتان ما زالتا بورقة أو ورقتين فقط، هما خيار مخلل — يمكن التعرف عليهما من خلال الأوراق الحقيقية على شكل قلب المميزة لعائلة الخيار. تُزرعان هنا في أكياس زراعة مملوءة بألياف جوز الهند، مع أنبوب تنقيط موصول بالفعل إلى قاعدة كل نبتة.",
        "الساق والأوراق ذات اللون الوردي الخفيف في هذه الشتلة من سمات الفجل — أحد أسرع المحاصيل في النفق البلاستيكي وصولاً إلى الحصاد، إذ يكون جاهزًا للقطف في 25 إلى 35 يومًا فقط.",
        "بأوراقها الأكثر استدارة ذات المظهر الشمعي الخفيف، وساقها الأخضر (بدلاً من الوردي)، هذه الشتلة هي الملفوف — محصول أبطأ بكثير من الفجل، يُزرع هنا قبل وقت طويل من بدء تكوّن رأسه.",
        "هذه النباتات الصغيرة، بأوراقها البيضاوية اللامعة المدببة التي تنمو في أزواج متقابلة، هي فلفل حار أو فلفل حلو. يزرع النفق البلاستيكي عدة أصناف من الفلفل جنبًا إلى جنب — منها فلفل السكوتش بونيت والفلفل الأخضر الحار والفلفل الرومي والفلفل الحلو — وهي متشابهة تقريبًا فيما بينها في هذه المرحلة المبكرة من النمو.",
  ...
  ru: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["О тоннеле и теплице", "Полив и орошение", "Сроки сбора урожая", "Рассада корнишонов", "Рассада редиса", "Рассада капусты", "Рассада перца чили", "Рассада помидора"],
      sectionBodies: [
        ...
        "Эти два сеянца, у которых пока всего один-два листа, — корнишоны: их можно узнать по сердцевидным настоящим листьям, типичным для семейства тыквенных. Они растут здесь в мешках для выращивания, заполненных кокосовым волокном, с капельной трубкой, уже подведённой к основанию каждого растения.",
        "Розоватый оттенок стебля и листьев этого сеянца характерен для редиса — одной из самых быстрых культур в тоннеле, готовой к сбору всего за 25–35 дней.",
        "У этого сеянца более округлые, слегка восковатые на вид листья и зелёный (а не розоватый) стебель — это капуста, культура намного более медленная, чем редис, высаженная здесь задолго до того, как начнёт формироваться кочан.",
        "Эти молодые растения с глянцевыми заострёнными овальными листьями, растущими супротивными парами, — чили или сладкий перец. В тоннеле бок о бок выращивают несколько сортов перца — Scotch Bonnet, зелёный чили, болгарский перец и сладкий перец, — которые на этой ранней стадии рассады выглядят практически одинаково.",
  ...
  de: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["Über den Folientunnel & das Gewächshaus", "Bewässerung", "Erntezeiten", "Gewürzgurken-Sämlinge", "Radieschen-Sämling", "Kohl-Sämling", "Chili-Sämlinge", "Tomaten-Sämling"],
      sectionBodies: [
        ...
        "Diese beiden Sämlinge, noch mit erst ein oder zwei Blättern, sind Gewürzgurken — erkennbar an den herzförmigen echten Blättern, die für die Kürbisgewächse typisch sind. Sie wachsen hier in mit Kokosfaser gefüllten Anzuchtsäcken, wobei bereits ein Tropfschlauch bis zur Basis jeder Pflanze verlegt ist.",
        "Der rosa getönte Stängel und die Blätter dieses Sämlings sind typisch für Radieschen — eine der schnellsten Kulturen im Folientunnel bis zur Ernte, bereits nach nur 25-35 Tagen erntereif.",
        "Mit runderen, leicht wachsig wirkenden Blättern und einem grünen (statt rosa getönten) Stängel ist dieser Sämling Kohl — eine deutlich langsamere Kultur als Radieschen, die hier lange gepflanzt wird, bevor sich überhaupt ein Kopf bildet.",
        "Diese jungen Pflanzen mit ihren glänzenden, spitz zulaufenden, gegenständig wachsenden ovalen Blättern sind Chili- oder Paprikapflanzen. Der Folientunnel zieht mehrere Paprikasorten nebeneinander — darunter Scotch Bonnet, grüne Chili, Gemüsepaprika und Paprika —, die sich in diesem frühen Sämlingsstadium kaum voneinander unterscheiden lassen.",
  ...
  es: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["Sobre el Túnel de Cultivo y el Invernadero", "Riego", "Tiempos de Cosecha", "Plántulas de Pepinillo", "Plántula de Rábano", "Plántula de Repollo", "Plántulas de Chile", "Plántula de Tomate"],
      sectionBodies: [
        ...
        "Estas dos plántulas, todavía con una o dos hojas, son pepinillos — identificables por sus hojas verdaderas en forma de corazón, típicas de la familia del pepino. Crecen aquí en bolsas de cultivo rellenas de fibra de coco, con una línea de goteo ya instalada hasta la base de cada planta.",
        "El tallo y las hojas de tono rosado de esta plántula son características del rábano — uno de los cultivos más rápidos del túnel en llegar a la cosecha, listo para recoger en apenas 25-35 días.",
        "Con hojas más redondeadas y de aspecto ligeramente ceroso, y un tallo verde (en lugar de rosado), esta plántula es repollo — un cultivo mucho más lento que el rábano, plantado aquí mucho antes de que empiece a formarse su cabeza.",
        "Estas plantas jóvenes, con hojas ovaladas brillantes y puntiagudas que crecen en pares opuestos, son chiles o pimientos. El túnel cultiva varias variedades de chile una junto a otra — entre ellas Scotch Bonnet, chile verde, pimiento y pimiento morrón — que resultan prácticamente indistinguibles entre sí en esta etapa temprana de plántula.",
  ...
  fr: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["À propos du Tunnel de Culture et de la Serre", "Arrosage et Irrigation", "Calendrier des Récoltes", "Plants de Cornichon", "Plant de Radis", "Plant de Chou", "Plants de Piment", "Plant de Tomate"],
      sectionBodies: [
        ...
        "Ces deux plants, encore à une ou deux feuilles, sont des cornichons — reconnaissables à leurs vraies feuilles en forme de cœur, typiques de la famille du concombre. Ils poussent ici dans des sacs de culture remplis de fibre de coco, avec un tuyau goutte-à-goutte déjà amené jusqu'à la base de chaque plant.",
        "La tige et les feuilles teintées de rose de ce plant sont caractéristiques du radis — l'une des cultures les plus rapides du tunnel à atteindre la récolte, prête en à peine 25 à 35 jours.",
        "Avec des feuilles plus rondes, à l'aspect légèrement cireux, et une tige verte (plutôt que teintée de rose), ce plant est un chou — une culture bien plus lente que le radis, mis en terre ici bien avant que sa pomme ne commence à se former.",
        "Ces jeunes plants, aux feuilles ovales luisantes et pointues poussant en paires opposées, sont des piments ou des poivrons. Le tunnel cultive côte à côte plusieurs variétés de piment — dont Scotch Bonnet, piment vert, poivron et poivron doux — pratiquement impossibles à distinguer les unes des autres à ce stade précoce de plant.",
  ...
  zh: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["关于塑料大棚与温室", "浇水与灌溉", "采收时间", "小黄瓜幼苗", "萝卜幼苗", "卷心菜幼苗", "辣椒幼苗", "番茄幼苗"],
      sectionBodies: [
        ...
        "这两株幼苗目前只长出一两片叶子，是小黄瓜——可以通过黄瓜科植物典型的心形真叶来识别。它们种植在装满椰糠的种植袋中，每株植物的根部都已经接上了滴灌管。",
        "这株幼苗带粉红色调的茎和叶是萝卜的特征——它是大棚里生长最快、最早能采收的作物之一，最快只需25至35天就能采收。",
        "这株幼苗叶片更圆、略带蜡质光泽，茎是绿色的（而不是粉红色），是卷心菜——比萝卜生长慢得多的作物，早在叶球开始形成之前很久就已经种下。",
        "这些成对生长的年幼植株，叶片呈光滑的尖椭圆形，是辣椒或甜椒。大棚里同时种植着好几种辣椒——包括苏格兰帽椒、青辣椒、灯笼椒和彩椒——在幼苗这个早期阶段，它们彼此几乎无法区分。",
  ...
  ja: {
    ...
    polytunnel: {
      ...
      sectionHeadings: ["ビニールハウスと温室について", "水やりと灌漑", "収穫までの期間", "ガーキンの苗", "ラディッシュの苗", "キャベツの苗", "唐辛子の苗", "トマトの苗"],
      sectionBodies: [
        ...
        "まだ葉が1〜2枚しかないこの2つの苗はガーキンです——キュウリの仲間に特徴的なハート形の本葉で見分けられます。ここではヤシガラ繊維を詰めた栽培袋で育てられており、それぞれの株の根元にはすでに点滴チューブが取り付けられています。",
        "この苗のピンクがかった茎と葉はラディッシュの特徴です——ビニールハウスの中でも収穫までが最も早い作物の一つで、わずか25〜35日で収穫できます。",
        "より丸みを帯びた、やや蝋質のような葉と、（ピンクがかっているのではなく）緑色の茎を持つこの苗はキャベツです——ラディッシュよりもずっと成長の遅い作物で、結球が始まるずっと前からここに植えられています。",
        "対になって生える光沢のある先の尖った楕円形の葉を持つこれらの若い株は、唐辛子またはピーマンです。ビニールハウスではスコッチボネット、青唐辛子、パプリカ、ピーマンなど複数の唐辛子の品種を並べて栽培していますが、この初期の苗の段階ではほとんど見分けがつきません。",
