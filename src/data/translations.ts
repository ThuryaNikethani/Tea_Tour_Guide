...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    "handmade-factory": {
      ...
      sectionBodies: [
        "යාන්ත්‍රික නිෂ්පාදනයට අමතරව, සමහර තේ සෑම අදියරකදීම යන්ත්‍රයක් නොව සම්පූර්ණයෙන් අතින් සකසනු ලැබේ. වතුයායේ අත්කම් විශේෂ ශ්‍රේණි බොහොමයක් — රන් තුඩුව, රිදී තුඩුව, සුදු තේ, දම් තේ, රෝස තේ, විටා ග්ලෝ, අතින් බැඳි බ්ලූමින් තේ, සහ නෙළුම් තේ වැනි මල් එකතු කළ මිශ්‍රණ — ප්‍රධාන කළු තේ කර්මාන්තශාලාව වෙනුවට මෙහිදී නිම කරනු ලැබේ. (විටා ග්ලෝ සාදනු ලබන්නේ රන් හා රිදී තුඩුවේ දම් පැහැති අංකුරයට වඩා වෙනස්ව, කොළ පැහැති අංකුරයේ තුඩුවෙනි.)",
