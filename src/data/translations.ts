...
const PLACEHOLDER_TRANSLATIONS: Partial<Record<Exclude<LanguageCode, "en">, Record<string, StationTranslation>>> = {
  si: {
    ...
    withering: {
      ...
      sectionBodies: [
        "කෙතින් පැමිණෙන කොළ මුලින්ම දිනපතා අස්වැන්න වාර්තා කිරීම සඳහා බර කරනු ලබන අතර, පසුව අඩි 85ක් දිග අඩි 6ක් පළල දිගු තට්ටු ඔස්සේ තුනී ලෙස පතුරුවා තබනු ලැබේ — එක් එක් තට්ටුවක අඟල් 46ක ප්‍රමාණයේ පංකාවක් ආර්පීඑම් 960ක වේගයෙන් ක්‍රියාත්මක වන අතර, එමගින් වාතය බලෙන් කොළ හරහා යවා තෙතමනය ක්‍රමයෙන් ඉවත් කරයි — වතුයාය 'නවීන' මැලවීමේ ක්‍රියාවලිය ලෙස හඳුන්වන්නේ මෙයයි. වර්ග අඩියකට කිලෝග්‍රෑම් 2.5ක් පමණ පැටවීමේ අනුපාතයකදී, එක් තට්ටුවක් කොළ කිලෝග්‍රෑම් 1,250ක් පමණ දරයි.",
        "කොළ තට්ටුවේ පැය 12ක් රැඳී සිටින අතර, පැය 4කට වරක් අතින් යටිකුරු කරනු ලැබේ; එම චක්‍රය තුළ පැය 3ත් 4ත් අතර කාලයක් තට්ටුව යටින් තාපය යොදනු ලැබේ. උදෑසන ඉවත් කිරීමට පෙර කොළ අවසන් වරට ලිහිල් කරනු ලැබේ. මැළවුණු කොළ රෝල් කිරීමට යැවීමට පෙර නැවත බර කරනු ලැබේ.",
        "සෑම කොළ කිලෝග්‍රෑම් 100කින්ම ජලය කිලෝග්‍රෑම් 43ක් පමණ ඉවත් විය යුතුය — වර්ග අඩියක පෙට්ටියක කොළ කිලෝග්‍රෑම් 2.5ක් පරීක්ෂා කිරීමෙන් තහවුරු කරගනී — එමගින් කොළය මෘදු හා නම්‍යශීලී වී, පොඩි නොවී රෝල් කිරීමට සූදානම් වන විට තෙතමනය 57% සිට 58% දක්වා පවතී.",
        "මැලවීම කොළය පුරා තෙතමනය සමාන කරන අතර, ස්වාභාවික එන්සයිම වලට පසුව තේවල සුවඳ හා වර්ණය නිර්මාණය කරන රසායනික වෙනස්කම් ආරම්භ කිරීමට ඉඩ සලසයි.",
      ],
    ...
    rolling: {
      ...
      sectionBodies: [
        "මැලවුණු කොළ රෝල් යන්ත්‍ර හරහා ගමන් කරන අතර, එය කොළයේ සෛල බිත්ති ඇඹරී බිඳ දමා, එහි ගැබ්ව ඇති යුෂ හා තෙල් නිදහස් කර, කොළය කුඩා අංශු බවට කඩා දමයි. මෙහිදී කොළයේ හැඩය සහ තේවල ශක්තිය සකස් වේ.",
        "ආරෝපණ රෝලර් දෙකකින් එකක් වාර්ගික ලෙස මැලවුණු කොළ කිලෝග්‍රෑම් 280ක් ගනී. පළමු රෝල් කිරීම මිනිත්තු 20ක් තුළ ආර්පීඑම් 30ත් 32ත් අතර වේගයෙන් සිදු වේ; ලැබෙන ඩූලි (රෝල් කළ කොළ අංශු) කන්වෙයර් එකක් ඔස්සේ කම්බි දැලකින් සමන්විත රෝල් බ්‍රේකරයකට ගමන් කරන අතර, එහිදී කුඩාම අංශු 'පළමු ඩූල්' ලෙස පහළට වැටී පැසවීමට යැවේ.",
        "පසුකර නොයන කොළ කන්වෙයර් එක ඔස්සේ ද්විතීයික රෝලර් දෙකකට ගමන් කරයි — මුල් කිලෝග්‍රෑම් 280ට වඩා 12% සිට 14% දක්වා ප්‍රමාණය අඩු කරමින් — දෙවන රෝල් කිරීම ආර්පීඑම් 32දී තවත් මිනිත්තු 20ක් සිදු කරන අතර, ඉන් පසු එම 'දෙවන ඩූල්' පෙරීමකින් තොරව කෙලින්ම පැසවීමට යැවේ.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "රෝල් කරන ලද කොළ — පළමු හා දෙවන ඩූල් යන දෙකම — අංශක සෙල්සියස් 25ත් 30ත් අතර උෂ්ණත්වයක් පවත්වන සිසිල්, තෙත් කාමරයක පතුරුවා පැය 2.5ක් ඔක්සිකරණය වීමට තබනු ලැබේ, ප්‍රතික්‍රියාව සිදුවීමට ප්‍රමාණවත් ආර්ද්‍රතාවයක් පවත්වා ගැනීමට හියුමිඩියෆයර් එකක් භාවිතා කරමින්.",
        ...
        "එම පැය 2.5 තුළ කොළ පැහැ කොළ ක්‍රමයෙන් තඹ පැහැති දුඹුරු පැහැයට හැරී, කළු තේ හා සම්බන්ධ වර්ණය, ශරීරය සහ සුවඳ සම්පූර්ණයෙන්ම වර්ධනය කරයි — මුළුමනින්ම ස්වාභාවික ඔක්සිකරණයෙන්, කිසිදු පාට හෝ රසායනික ද්‍රව්‍ය එකතු නොකර.",
    ...
    drying: {
      ...
      sectionBodies: [
        "වියලනයට යැවීමට පෙර, පැසුණු කොළ ලිහිල් කරනු ලැබේ. පසුව එය උණුසුම් වාතාශ්‍රය සහිත වියලනවලින් ගමන් කරයි — දර ගින්නෙන් ජනනය කරන තාපය ප්‍රධාන පංකාවක් මගින් ඇද ගනු ලබන්නේ සෙල්සියස් 120ත් 130ත් අතර පිවිසුම් උෂ්ණත්වයකින්.",
        "ඇතුළත, වියලනය කොටස් 6කට බෙදා ඇත; කොළ ඉහළ තැටියේ සිට මෙම කොටස් හරහා පහළ තැටි වෙත වැටෙන අතර, ඉදිරියට හා පසුපසට කරකැවෙමින් ගමන් කර, හරියටම මිනිත්තු 21කින් පිටවේ, ඒ වන විටත් පිටවන උෂ්ණත්වය සෙල්සියස් 80ක් පමණ (ෆැරන්හයිට් 140ත් 150ත් අතර) විය යුතුය.",
        "පිවිසුම් උෂ්ණත්වය 120-130°C, පිටවන උෂ්ණත්වය 80°C, හා මිනිත්තු 21 — මෙම එකතුවම වියලනය නිර්මාණය කර ඇත්තේ පවත්වා ගැනීමට වන අතර, කොළ නිසි ලෙස කළු පාට වීමට හේතු වන්නේ එයයි. පිවිසුම් උෂ්ණත්වය සෙල්සියස් 120ට වඩා අඩු වුවහොත්, කොළ තට්ටුව තුනී කිරීමෙන් පිටවන උෂ්ණත්වය 100°C දක්වා ළඟා වුවද, කොළ නිසි ලෙස වියළී නොයා දුඹුරු පැහැයට හැරේ; පිවිසුම් උෂ්ණත්වය 150°C දක්වා වැඩි කර පිටවන උෂ්ණත්වය 75°C දක්වා පහත වැටුණහොත්, කොළ වියළී යනවා වෙනුවට තෙතමනයෙන් තෙතබරිත වේ.",
        ...
        "පිලුස්සීම නිවැරදි මොහොතේදීම රසායනික වෙනස්කම් නවත්වන අතර තෙතමනය 45-50% පමණ සිට 2-3% පමණට අඩු කරයි, එය ගබඩා කිරීම හා ප්‍රවාහනය අතරතුර තේ නැවුම්ව තබා ගැනීමට අත්‍යවශ්‍ය වේ.",
  ...
  ta: {
    ...
    withering: {
      ...
      sectionBodies: [
        ...
        "ஒவ்வொரு 100 கிலோகிராம் பச்சை இலையிலிருந்தும் சுமார் 43 கிலோகிராம் நீர் அகற்றப்பட வேண்டும் — ஒரு சதுர அடி பெட்டியில் 2.5 கிலோகிராம் இலையை சோதிப்பதன் மூலம் இது உறுதிப்படுத்தப்படுகிறது — இதன் விளைவாக இலை மென்மையாகவும் நெகிழக்கூடியதாகவும் மாறி, உடையாமல் உருட்டுவதற்குத் தயாரான நிலையில் ஈரப்பதம் 57% முதல் 58% வரை இருக்கும்.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "உருட்டப்பட்ட இலை — முதல் மற்றும் இரண்டாம் டூல் இரண்டும் — 25 முதல் 30°C வரை வெப்பநிலையில் வைக்கப்பட்ட குளிர்ந்த, ஈரப்பதமான அறையில் பரப்பப்பட்டு 2.5 மணி நேரம் ஆக்சிஜனேற்றமடைய விடப்படுகிறது, வினை நடைபெற போதுமான ஈரப்பதத்தை பராமரிக்க ஈரப்பதமூட்டி பயன்படுத்தப்படுகிறது.",
        ...
        "அந்த 2.5 மணி நேரத்தில் பச்சை இலை படிப்படியாக செம்பு நிற பழுப்பு நிறமாக மாறி, கருப்பு தேயிலையுடன் தொடர்புடைய நிறம், வலிமை மற்றும் நறுமணத்தை முழுமையாக வளர்த்துக்கொள்கிறது — முற்றிலும் இயற்கையான ஆக்சிஜனேற்றத்தால் மட்டுமே, எந்த சாயமும் சேர்க்கப்படுவதில்லை.",
    ...
    drying: {
      ...
      sectionBodies: [
        ...
        "உள்ளே, உலர்த்தி 6 பிரிவுகளாகப் பிரிக்கப்பட்டுள்ளது; இலை மேல் தட்டிலிருந்து இந்தப் பிரிவுகள் வழியாக கீழ் தட்டுகளுக்கு விழுந்து, முன்னும் பின்னுமாக உருண்டு நகர்ந்து, சரியாக 21 நிமிடங்களில் வெளியேறுகிறது; அந்த நேரத்தில் வெளியேறும் வெப்பநிலை சுமார் 80°C (சுமார் 140°F முதல் 150°F வரை) இருக்க வேண்டும்.",
        ...
        "சுடுதல் சரியான நேரத்தில் வேதியியல் மாற்றங்களை நிறுத்தி, ஈரப்பதத்தை சுமார் 45-50% இலிருந்து 2-3% ஆகக் குறைக்கிறது, இது சேமிப்பு மற்றும் ஏற்றுமதியின் போது தேயிலை புத்துணர்ச்சியாக இருக்க அவசியமானது.",
  ...
  it: {
    ...
    withering: {
      ...
      sectionBodies: [
        "La foglia appena arrivata dal campo viene prima pesata per registrare il raccolto del giorno, poi stesa in strati sottili su lunghe vasche larghe 85 piedi e profonde 6 piedi, ciascuna dotata di una ventola da 46 pollici che gira a 960 giri al minuto per spingere l'aria attraverso la foglia ed eliminare gradualmente l'umidità — ciò che la tenuta chiama il processo di appassimento 'moderno'. Con un carico di circa 2,5 kg per piede quadrato, una vasca contiene circa 1.250 kg di foglia verde.",
        "La foglia resta nella vasca per 12 ore, girata a mano ogni 4 ore, con calore applicato dal basso per 3-4 ore durante quel ciclo; viene smossa un'ultima volta prima di essere scaricata al mattino presto. La foglia appassita viene pesata di nuovo prima di passare all'arrotolamento.",
        "Da ogni 100 kg di foglia verde vengono eliminati circa 43 kg di acqua — verificato testando 2,5 kg di foglia in una scatola di un piede quadrato — lasciando la foglia con un'umidità del 57-58% quando diventa flessibile e malleabile, pronta per l'arrotolamento senza rompersi.",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "Due rulli di carico ricevono ciascuno 280 kg di foglia appassita. Il primo arrotolamento dura 20 minuti a 30-32 giri al minuto; le 'doolie' risultanti (particelle di foglia arrotolata) passano su un nastro trasportatore fino a un separatore dotato di rete metallica, che lascia cadere le particelle più piccole come 'primo dool', inviato alla fermentazione.",
        "La foglia che non passa risale il nastro fino a due rulli secondari — con il carico ridotto del 12-14% rispetto ai 280 kg originali — per un secondo arrotolamento di altri 20 minuti a 32 giri al minuto, dopo il quale il 'secondo dool' va direttamente alla fermentazione senza essere setacciato.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        ...
        "Nel corso di quelle 2,5 ore la foglia verde diventa gradualmente di un colore bruno ramato mentre sviluppa pienamente il colore, il corpo e l'aroma associati al tè nero — interamente grazie all'ossidazione naturale, senza coloranti o additivi.",
    ...
    drying: {
      ...
      sectionBodies: [
        "Prima di entrare nell'essiccatore, la foglia fermentata viene smossa. Passa poi attraverso essiccatori ad aria calda — con calore generato da legna da ardere e aspirato da una ventola principale, mantenendo una temperatura di ingresso tra 120°C e 130°C — che arrestano istantaneamente l'ossidazione e fissano il carattere del tè.",
        "All'interno, l'essiccatore è diviso in 6 sezioni; la foglia cade dal vassoio superiore attraverso queste sezioni fino ai vassoi inferiori, rigirandosi avanti e indietro mentre avanza, ed esce dopo esattamente 21 minuti, momento in cui la temperatura in uscita dovrebbe essere di circa 80°C (all'incirca 140-150°F).",
        "È questa combinazione — 120-130°C in ingresso, 80°C in uscita, 21 minuti — che l'essiccatore è progettato per mantenere, ed è ciò che fa diventare la foglia correttamente nera. Se la temperatura di ingresso scende sotto i 120°C, la foglia esce poco essiccata e brunastra anche se quella di uscita raggiunge i 100°C assottigliando lo strato di foglia; se la temperatura di ingresso sale a 150°C mentre quella di uscita scende a 75°C, la foglia risulta invece molliccia e stufata.",
  ...
  ar: {
    ...
    withering: {
      ...
      sectionBodies: [
        "تُوزن الأوراق القادمة من الحقل أولاً لتسجيل محصول اليوم، ثم تُفرش بطبقة رقيقة على أحواض طويلة يبلغ طولها 85 قدمًا وعرضها 6 أقدام، ومزودة كل منها بمروحة قطرها 46 بوصة تعمل بسرعة 960 دورة في الدقيقة لدفع الهواء عبر الأوراق وإزالة الرطوبة تدريجيًا — وهو ما تسميه المزرعة عملية الذبول 'الحديثة'. وبمعدل تحميل يبلغ نحو 2.5 كجم لكل قدم مربع، يستوعب الحوض الواحد نحو 1,250 كجم من الأوراق الخضراء.",
        "تبقى الأوراق في الحوض لمدة 12 ساعة، تُقلَب يدويًا كل 4 ساعات، مع تسخين من الأسفل لمدة 3 إلى 4 ساعات خلال تلك الدورة؛ وتُرخى مرة أخيرة قبل تفريغها في الصباح الباكر. تُوزن الأوراق الذابلة مرة أخرى قبل الانتقال إلى مرحلة اللف.",
        "من كل 100 كجم من الأوراق الخضراء، تُزال نحو 43 كجم من الماء — يُتحقق من ذلك باختبار 2.5 كجم من الأوراق في صندوق مساحته قدم مربع واحد — لتبقى الأوراق برطوبة تتراوح بين 57% و58% عندما تصبح مرنة وطيّعة، جاهزة للف دون أن تتكسر.",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "تستقبل كل من أسطوانتي التغذية 280 كجم من الأوراق الذابلة. تستغرق اللفة الأولى 20 دقيقة بسرعة 30 إلى 32 دورة في الدقيقة؛ وتنتقل جزيئات الأوراق الملفوفة (الدوليات) الناتجة عبر ناقل إلى كاسر ملفوف بشبكة سلكية، يُسقط أصغر الجزيئات كـ'الدول الأول' الذي يُرسل إلى التخمير.",
        "أما الأوراق التي لا تمر فتصعد عبر الناقل إلى أسطوانتين ثانويتين — بتغذية مخفّضة بنسبة 12% إلى 14% من الـ280 كجم الأصلية — للفة ثانية تستغرق 20 دقيقة أخرى بسرعة 32 دورة في الدقيقة، وبعدها يذهب 'الدول الثاني' مباشرة إلى التخمير دون غربلة.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "تُفرش الأوراق الملفوفة — الدول الأول والثاني معًا — في غرفة باردة ورطبة تُحفظ عند درجة حرارة تتراوح بين 25 و30 درجة مئوية وتُترك لتتأكسد لمدة 2.5 ساعة، مع استخدام جهاز ترطيب للحفاظ على رطوبة الهواء الكافية لحدوث التفاعل.",
        ...
        "وخلال تلك الساعات الـ2.5 تتحول الورقة الخضراء تدريجيًا إلى لون بني نحاسي مع تطور كامل للون والقوام والنكهة المرتبطة بالشاي الأسود — وذلك كله من الأكسدة الطبيعية فقط، دون أي أصباغ أو إضافات.",
    ...
    drying: {
      ...
      sectionBodies: [
        "قبل الدخول إلى المجفف، تُرخى الأوراق المخمّرة. ثم تمر عبر مجففات الهواء الساخن — بحرارة ناتجة عن حرق الحطب تُسحب بواسطة مروحة رئيسية، مع الحفاظ على درجة حرارة دخول تتراوح بين 120 و130 درجة مئوية — والتي توقف الأكسدة فورًا وتحافظ على طابع الشاي.",
  ...
  ru: {
    ...
    withering: {
      ...
      sectionBodies: [
        "Лист, поступающий с плантации, сначала взвешивают, чтобы зафиксировать дневной сбор, затем тонким слоем раскладывают на длинных желобах длиной 85 футов и шириной 6 футов, каждый из которых оснащён вентилятором диаметром 46 дюймов, работающим со скоростью 960 об/мин и прогоняющим воздух через лист, постепенно удаляя влагу — это то, что на плантации называют «современным» способом завяливания. При норме загрузки около 2,5 кг на квадратный фут один желоб вмещает около 1250 кг свежесобранного листа.",
        "Лист остаётся в желобе 12 часов, его вручную переворачивают каждые 4 часа, а в течение 3–4 часов этого цикла снизу подаётся тепло; в последний раз лист рыхлят перед выгрузкой ранним утром. Увядший лист снова взвешивают перед тем, как отправить его на скручивание.",
        "Из каждых 100 кг зелёного листа удаляется около 43 кг воды — это проверяют, взвешивая 2,5 кг листа в коробке площадью один квадратный фут — в результате влажность листа составляет 57–58%, когда он становится мягким и податливым, готовым к скручиванию без повреждений.",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "Лист, не прошедший через сетку, поднимается по конвейеру к двум вторичным роллерам — с загрузкой, уменьшенной на 12–14% от первоначальных 280 кг, — для второго скручивания ещё в течение 20 минут при 32 об/мин, после чего «вторая доль» направляется прямо на ферментацию без просеивания.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        ...
        "За эти 2,5 часа зелёный лист постепенно приобретает медно-коричневый оттенок, полностью развивая цвет, насыщенность и аромат, характерные для чёрного чая — исключительно за счёт естественного окисления, без красителей и добавок.",
    ...
    drying: {
      ...
      sectionBodies: [
        "Перед подачей в сушилку ферментированный лист рыхлят. Затем он проходит через сушилки горячего воздуха — тепло от сжигания дров, нагнетаемое главным вентилятором, при этом температура на входе поддерживается в диапазоне 120–130°C, — которые мгновенно останавливают окисление и закрепляют характер чая.",
        "Внутри сушилка разделена на 6 секций; лист падает с верхнего лотка через эти секции на нижние лотки, кувыркаясь вперёд и назад по мере продвижения, и выходит ровно через 21 минуту, когда температура на выходе должна составлять около 80°C (примерно 140–150°F).",
        "Именно это сочетание — 120–130°C на входе, 80°C на выходе, 21 минута — сушилка рассчитана поддерживать, и именно оно превращает лист в правильно почерневший. Если температура на входе опускается ниже 120°C, лист выходит недосушенным и буроватым, даже если температура на выходе достигает 100°C за счёт утончения слоя листа; если температуру на входе поднять до 150°C, а на выходе она упадёт до 75°C, лист получится сырым и как бы тушёным, а не правильно высушенным.",
  ...
  de: {
    ...
    withering: {
      ...
      sectionBodies: [
        "Das vom Feld ankommende Blatt wird zunächst gewogen, um die Tagesernte zu erfassen, dann dünn auf langen Trögen ausgebreitet, die 85 Fuß lang und 6 Fuß breit sind und jeweils mit einem 46-Zoll-Ventilator mit 960 U/min ausgestattet sind, der Luft durch das Blatt presst, um stetig Feuchtigkeit zu entziehen — was das Anwesen den 'modernen' Welkeprozess nennt. Bei einer Beladungsrate von etwa 2,5 kg pro Quadratfuß fasst ein Trog etwa 1.250 kg frisches Blatt.",
        "Das Blatt bleibt 12 Stunden im Trog, wird alle 4 Stunden von Hand gewendet, wobei während dieses Zyklus 3 bis 4 Stunden lang von unten Wärme zugeführt wird; es wird ein letztes Mal aufgelockert, bevor es am frühen Morgen ausgeladen wird. Das gewelkte Blatt wird erneut gewogen, bevor es zum Rollen weitergeht.",
        "Aus je 100 kg frischem Blatt werden etwa 43 kg Wasser entfernt — überprüft, indem 2,5 kg Blatt in einer ein Quadratfuß großen Kiste getestet werden — sodass das Blatt bei etwa 57 bis 58 % Feuchtigkeit welk und geschmeidig wird und bereit zum Rollen ist, ohne zu zerbrechen.",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "Blatt, das nicht durchfällt, wandert über das Förderband zu zwei sekundären Walzen — mit einer um 12 bis 14 % reduzierten Zuführung gegenüber den ursprünglichen 280 kg — für einen zweiten, weitere 20 Minuten dauernden Rollgang bei 32 U/min, wonach der 'zweite Dool' ohne Siebung direkt zur Fermentation geht.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "Gerolltes Blatt — sowohl der erste als auch der zweite Dool — wird in einem kühlen, feuchten Raum ausgebreitet, der bei etwa 25 bis 30 °C gehalten wird, und 2,5 Stunden lang zur Oxidation stehen gelassen; ein Luftbefeuchter hält die Luft feucht genug, damit die Reaktion ablaufen kann.",
        ...
        "Innerhalb dieser 2,5 Stunden verfärbt sich das grüne Blatt allmählich kupferbraun und entwickelt vollständig Farbe, Körper und Aroma des Schwarztees — ausschließlich durch natürliche Oxidation, ohne Farbstoffe oder Zusätze.",
    ...
    drying: {
      ...
      sectionBodies: [
        "Bevor es in den Trockner gelangt, wird das fermentierte Blatt aufgelockert. Danach durchläuft es Heißlufttrockner — mit durch Brennholz erzeugter Wärme, die von einem Hauptventilator angesaugt wird, wobei die Eintrittstemperatur bei 120 bis 130 °C gehalten wird —, die die Oxidation sofort stoppen und den Charakter des Tees festhalten.",
        "Im Inneren ist der Trockner in 6 Abschnitte unterteilt; das Blatt fällt vom obersten Tablett durch diese Abschnitte auf die unteren Tabletts, wobei es sich beim Vorwärts- und Rückwärtsbewegen umwälzt, und verlässt den Trockner nach genau 21 Minuten, wenn die Austrittstemperatur etwa 80 °C (rund 140 bis 150 °F) betragen sollte.",
        "Genau diese Kombination — 120–130 °C Eintritt, 80 °C Austritt, 21 Minuten — ist es, worauf der Trockner ausgelegt ist, und sie sorgt dafür, dass das Blatt richtig schwarz wird. Sinkt die Eintrittstemperatur unter 120 °C, kommt das Blatt unzureichend getrocknet und bräunlich heraus, selbst wenn die Austrittstemperatur durch eine dünnere Blattschicht 100 °C erreicht; steigt die Eintrittstemperatur auf 150 °C, während die Austrittstemperatur auf 75 °C fällt, wird das Blatt stattdessen matschig und wie gedünstet.",
  ...
  es: {
    ...
    withering: {
      ...
      sectionBodies: [
        "La hoja recién llegada del campo se pesa primero para registrar la cosecha del día, y luego se extiende en capas finas sobre largos canales de 85 pies de largo y 6 pies de ancho, cada uno equipado con un ventilador de 46 pulgadas que gira a 960 RPM para forzar el paso del aire y eliminar gradualmente la humedad — lo que la finca llama el proceso de marchitado 'moderno'. Con una carga de aproximadamente 2,5 kg por pie cuadrado, un canal contiene alrededor de 1.250 kg de hoja verde.",
        "La hoja permanece en el canal durante 12 horas, se voltea a mano cada 4 horas, con calor aplicado desde abajo durante 3 a 4 horas dentro de ese ciclo; se afloja una última vez antes de descargarse a primera hora de la mañana. La hoja marchitada se pesa de nuevo antes de pasar al enrollado.",
        "Por cada 100 kg de hoja verde se eliminan cerca de 43 kg de agua — comprobado probando 2,5 kg de hoja en una caja de un pie cuadrado — dejando la hoja con una humedad de entre el 57% y el 58% cuando se vuelve flexible y maleable, lista para el enrollado sin quebrarse.",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "La hoja que no pasa sube por la cinta hasta dos rodillos secundarios —con la carga reducida entre un 12% y un 14% respecto a los 280 kg originales— para un segundo enrollado de otros 20 minutos a 32 RPM, tras el cual el 'segundo dool' va directo a fermentación sin cribar.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "La hoja enrollada —tanto el primer como el segundo dool— se extiende en una sala fresca y húmeda, mantenida a unos 25-30°C, y se deja oxidar durante 2,5 horas, con un humidificador que mantiene el aire lo bastante húmedo para que ocurra la reacción.",
        ...
        "En esas 2,5 horas, la hoja verde se va tornando de un color cobrizo a medida que desarrolla plenamente el color, cuerpo y aroma propios del té negro — todo ello por oxidación natural, sin tintes ni aditivos.",
    ...
    drying: {
      ...
      sectionBodies: [
        "Antes de entrar en el secador, la hoja fermentada se afloja. Luego pasa por secadoras de aire caliente —con calor generado por leña, aspirado por un ventilador principal, manteniendo una temperatura de entrada de entre 120 y 130 °C— que detienen la oxidación al instante y fijan el carácter del té.",
        "En su interior, el secador está dividido en 6 secciones; la hoja cae de la bandeja superior a través de estas secciones hasta las bandejas inferiores, dando vueltas hacia adelante y hacia atrás a medida que avanza, y sale exactamente a los 21 minutos, momento en el que la temperatura de salida debería rondar los 80 °C (aproximadamente 140-150 °F).",
  ...
  fr: {
    ...
    withering: {
      ...
      sectionBodies: [
        "La feuille arrivant des champs est d'abord pesée pour consigner la récolte du jour, puis étalée en fine couche sur de longs bacs de 85 pieds de long et 6 pieds de large, chacun équipé d'un ventilateur de 46 pouces tournant à 960 tr/min pour forcer l'air à travers elle et éliminer progressivement l'humidité — ce que le domaine appelle le flétrissage 'moderne'. À un taux de chargement d'environ 2,5 kg par pied carré, un bac contient environ 1 250 kg de feuille verte.",
        "La feuille reste dans le bac pendant 12 heures, retournée à la main toutes les 4 heures, avec de la chaleur appliquée par le dessous pendant 3 à 4 heures durant ce cycle ; elle est ameublie une dernière fois avant d'être déchargée tôt le matin. La feuille flétrie est pesée à nouveau avant de passer au roulage.",
        "Sur chaque 100 kg de feuille verte, environ 43 kg d'eau sont éliminés — vérifié en testant 2,5 kg de feuille dans une boîte d'un pied carré — laissant la feuille à environ 57 à 58 % d'humidité lorsqu'elle devient souple et malléable, prête pour le roulage sans se briser.",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "Deux rouleaux de chargement reçoivent chacun 280 kg de feuille flétrie. Le premier roulage dure 20 minutes à 30-32 tr/min ; les 'doolies' obtenues (particules de feuille roulée) passent sur un convoyeur jusqu'à un brise-rouleau équipé d'un tamis métallique, qui laisse tomber les plus petites particules comme 'premier dool', envoyé à la fermentation.",
        "La feuille qui ne passe pas remonte le convoyeur jusqu'à deux rouleaux secondaires — avec un chargement réduit de 12 à 14 % par rapport aux 280 kg d'origine — pour un second roulage de 20 minutes supplémentaires à 32 tr/min, après quoi le 'second dool' va directement à la fermentation sans tamisage.",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "La feuille roulée — à la fois le premier et le second dool — est étalée dans une pièce fraîche et humide maintenue à environ 25-30°C et laissée à oxyder pendant 2,5 heures, un humidificateur maintenant l'air suffisamment humide pour que la réaction se produise.",
        ...
        "Au cours de ces 2,5 heures, la feuille verte devient progressivement brun cuivré tout en développant pleinement la couleur, le corps et l'arôme associés au thé noir — entièrement grâce à l'oxydation naturelle, sans colorant ni additif.",
    ...
    drying: {
      ...
      sectionBodies: [
        "Avant d'entrer dans le séchoir, la feuille fermentée est ameublie. Elle passe ensuite dans des séchoirs à air chaud — avec une chaleur produite par du bois de chauffage, aspirée par un ventilateur principal, la température d'entrée étant maintenue entre 120 et 130 °C — qui arrêtent instantanément l'oxydation et figent le caractère du thé.",
        "À l'intérieur, le séchoir est divisé en 6 sections ; la feuille tombe du plateau supérieur à travers ces sections jusqu'aux plateaux inférieurs, culbutant vers l'avant et l'arrière au fil de sa progression, et sort après exactement 21 minutes, moment où la température de sortie doit avoisiner les 80 °C (environ 140 à 150 °F).",
  ...
  zh: {
    ...
    withering: {
      ...
      sectionBodies: [
        "从茶园运来的茶叶会先称重以记录当日采收量，然后薄薄地摊放在长85英尺、宽6英尺的长萎凋槽中，每条萎凋槽都配有一台46英寸的风扇，以每分钟960转的速度运转，将空气强行送穿茶叶，持续带走水分——这就是庄园所称的“现代”萎凋工艺。以每平方英尺约2.5公斤的装载量计算，一条萎凋槽可容纳约1,250公斤鲜叶。",
        "茶叶在槽中停留12小时，每4小时人工翻动一次，在此周期内槽底加热3至4小时；在清晨卸出之前会再松动一次。萎凋后的茶叶在送去揉捻之前会再次称重。",
        "每100公斤鲜叶大约要去除43公斤水分——通过在一平方英尺的箱子里测试2.5公斤茶叶来验证——使茶叶在变得柔软有韧性、可进行揉捻而不会破碎时，水分含量保持在57%至58%之间。",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "两台进料揉捻机各自处理280公斤萎凋叶。第一次揉捻以每分钟30至32转的速度进行20分钟；产生的“朵利”（揉捻后的茶叶颗粒）经传送带送到装有金属网的解块机，最细小的颗粒作为“头子茶”落下并送去发酵。",
        "未能通过筛网的茶叶则沿传送带送至两台二级揉捻机——进料量比原本的280公斤减少12%至14%——再进行一次20分钟、转速为每分钟32转的揉捻，之后产生的“二子茶”不经筛分直接送去发酵。",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "揉捻后的茶叶——头子茶和二子茶均包括在内——被摊放在保持25至30°C的凉爽潮湿房间中氧化2.5小时，并用加湿器维持足够的空气湿度以使反应顺利进行。",
        "房间必须保持绝对清洁——不得有细菌、积水或陈叶——因为细菌会终止酶的活性，破坏茶汤的色泽、浓度和品质。",
        "在这2.5小时内，绿色的叶片逐渐变成古铜色，充分形成红茶特有的色泽、口感和香气——这完全来自天然氧化，不含任何染色剂或添加剂。",
    ...
    drying: {
      ...
      sectionBodies: [
        "进入干燥机之前，发酵后的茶叶会先被松动。随后茶叶通过热风干燥机——由主风扇抽入的柴火加热产生的热风，进风温度保持在120°C至130°C之间——瞬间停止氧化并锁住茶叶的特质。",
  ...
  ja: {
    ...
    withering: {
      ...
      sectionBodies: [
        "畑から届いた生葉はまずその日の収穫量を記録するために計量され、その後長さ85フィート、幅6フィートの長い萎凋槽に薄く広げられます。各槽には毎分960回転で回る46インチの送風機が備え付けられており、強制的に風を通すことで水分が徐々に取り除かれます——農園ではこれを「モダン」萎凋プロセスと呼んでいます。1平方フィートあたり約2.5kgという投入量で、1つの槽には約1,250kgの生葉が収容されます。",
        "葉は槽内に12時間置かれ、4時間ごとに手で裏返され、その周期のうち3〜4時間は槽の下から熱が加えられます。早朝に取り出される前に最後にもう一度ほぐされます。萎凋を終えた葉は揉捻に送られる前に再び計量されます。",
        "生葉100kgごとに約43kgの水分が取り除かれます——1平方フィートの箱で2.5kgの葉をテストして確認されます——これにより、葉は崩れることなく揉捻できるしなやかな状態になる頃には水分量が57〜58%になります。",
    ...
    rolling: {
      ...
      sectionBodies: [
        ...
        "2基の投入ローラーはそれぞれ280kgの萎凋葉を受け入れます。最初の揉捻は毎分30〜32回転で20分間行われます。できあがった「ドゥーリー」（揉捻された茶葉粒子）はコンベアで金網付きのロールブレーカーへ送られ、最も細かい粒子が「一番ドール」として振るい落とされ、発酵工程へ送られます。",
        "ふるいを通らなかった葉はコンベアを上って2基の二次ローラーへ送られ——投入量は元の280kgから12〜14%減らされます——毎分32回転でさらに20分間の二回目の揉捻が行われた後、その「二番ドール」はふるい分けせずそのまま発酵工程へ送られます。",
    ...
    fermentation: {
      ...
      sectionBodies: [
        "揉捻された茶葉——一番ドールと二番ドールの両方——は25〜30°Cに保たれた涼しく湿度の高い部屋に広げられ、2.5時間かけて酸化させられます。加湿器によって反応が進むのに十分な湿度が保たれます。",
        "部屋は完全に清潔でなければなりません——細菌、よどんだ水、古い茶葉があってはいけません——なぜなら細菌が酵素の働きを止め、色、濃さ、水色の品質を損なってしまうからです。",
        ...
        "これはまた、ここで作られる茶の種類を分けるものでもあります——紅茶は萎凋、揉捻、発酵、そして火入れという順序をたどりますが、緑茶は発酵を完全に省き（萎凋、揉捻、乾燥のみ）、より穏やかな味わいとなり、主にその優しく薬用的な性質のために飲まれます。白茶は萎凋と発酵の両方を省き、生葉から直接蒸し、乾燥させます。この工場ではウーロン茶は作っていません——ガイドはこれを、機械による揉捻の代わりに蒸しと手もみを繰り返して作る、紅茶に似た発酵茶として説明しています。",
      ],
    ...
    drying: {
      ...
      sectionBodies: [
        "乾燥機に入る前に、発酵を終えた茶葉はほぐされます。その後、薪を燃料とする熱源からメイン送風機で吸い込まれた熱風により、入口温度を120〜130°Cに保った熱風乾燥機を通り、酸化を瞬時に止めて紅茶の特性を閉じ込めます。",
        "内部では乾燥機は6つの区画に分かれており、茶葉は最上段のトレイからこれらの区画を通って下段のトレイへと落ち、前後にころがりながら進み、ちょうど21分後に排出されます。その時点での排気温度は約80°C（およそ140〜150°F）であるべきです。",
